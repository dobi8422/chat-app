var k_=Object.defineProperty;var Qu=Object.getOwnPropertySymbols;var N_=Object.prototype.hasOwnProperty,P_=Object.prototype.propertyIsEnumerable;var Ju=(t,e,n)=>e in t?k_(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,Xu=(t,e)=>{for(var n in e||(e={}))N_.call(e,n)&&Ju(t,n,e[n]);if(Qu)for(var n of Qu(e))P_.call(e,n)&&Ju(t,n,e[n]);return t};function xa(t,e){const n=Object.create(null),i=t.split(",");for(let r=0;r<i.length;r++)n[i[r]]=!0;return e?r=>!!n[r.toLowerCase()]:r=>!!n[r]}const O_="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",x_=xa(O_);function Zu(t){return!!t||t===""}function Ma(t){if(ne(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],r=Fe(i)?D_(i):Ma(i);if(r)for(const s in r)e[s]=r[s]}return e}else{if(Fe(t))return t;if(xe(t))return t}}const M_=/;(?![^(]*\))/g,L_=/:(.+)/;function D_(t){const e={};return t.split(M_).forEach(n=>{if(n){const i=n.split(L_);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function La(t){let e="";if(Fe(t))e=t;else if(ne(t))for(let n=0;n<t.length;n++){const i=La(t[n]);i&&(e+=i+" ")}else if(xe(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const TN=t=>t==null?"":ne(t)||xe(t)&&(t.toString===rd||!re(t.toString))?JSON.stringify(t,ed,2):String(t),ed=(t,e)=>e&&e.__v_isRef?ed(t,e.value):Di(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,r])=>(n[`${i} =>`]=r,n),{})}:nd(e)?{[`Set(${e.size})`]:[...e.values()]}:xe(e)&&!ne(e)&&!sd(e)?String(e):e,Ie={},Li=[],xt=()=>{},F_=()=>!1,U_=/^on[^a-z]/,Us=t=>U_.test(t),Da=t=>t.startsWith("onUpdate:"),Je=Object.assign,td=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},V_=Object.prototype.hasOwnProperty,ge=(t,e)=>V_.call(t,e),ne=Array.isArray,Di=t=>Vs(t)==="[object Map]",nd=t=>Vs(t)==="[object Set]",re=t=>typeof t=="function",Fe=t=>typeof t=="string",Fa=t=>typeof t=="symbol",xe=t=>t!==null&&typeof t=="object",id=t=>xe(t)&&re(t.then)&&re(t.catch),rd=Object.prototype.toString,Vs=t=>rd.call(t),W_=t=>Vs(t).slice(8,-1),sd=t=>Vs(t)==="[object Object]",Ua=t=>Fe(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Ws=xa(",key,ref,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Bs=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},B_=/-(\w)/g,Ht=Bs(t=>t.replace(B_,(e,n)=>n?n.toUpperCase():"")),j_=/\B([A-Z])/g,qn=Bs(t=>t.replace(j_,"-$1").toLowerCase()),js=Bs(t=>t.charAt(0).toUpperCase()+t.slice(1)),Va=Bs(t=>t?`on${js(t)}`:""),Ar=(t,e)=>!Object.is(t,e),$s=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Hs=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},zs=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let od;const $_=()=>od||(od=typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{});let Gn;const qs=[];class H_{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&Gn&&(this.parent=Gn,this.index=(Gn.scopes||(Gn.scopes=[])).push(this)-1)}run(e){if(this.active)try{return this.on(),e()}finally{this.off()}}on(){this.active&&(qs.push(this),Gn=this)}off(){this.active&&(qs.pop(),Gn=qs[qs.length-1])}stop(e){if(this.active){if(this.effects.forEach(n=>n.stop()),this.cleanups.forEach(n=>n()),this.scopes&&this.scopes.forEach(n=>n.stop(!0)),this.parent&&!e){const n=this.parent.scopes.pop();n&&n!==this&&(this.parent.scopes[this.index]=n,n.index=this.index)}this.active=!1}}}function z_(t,e){e=e||Gn,e&&e.active&&e.effects.push(t)}const Wa=t=>{const e=new Set(t);return e.w=0,e.n=0,e},ad=t=>(t.w&En)>0,ld=t=>(t.n&En)>0,q_=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=En},G_=t=>{const{deps:e}=t;if(e.length){let n=0;for(let i=0;i<e.length;i++){const r=e[i];ad(r)&&!ld(r)?r.delete(t):e[n++]=r,r.w&=~En,r.n&=~En}e.length=n}},Ba=new WeakMap;let kr=0,En=1;const ja=30,Nr=[];let Kn;const Yn=Symbol(""),$a=Symbol("");class Ha{constructor(e,n=null,i){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],z_(this,i)}run(){if(!this.active)return this.fn();if(!Nr.includes(this))try{return Nr.push(Kn=this),K_(),En=1<<++kr,kr<=ja?q_(this):cd(this),this.fn()}finally{kr<=ja&&G_(this),En=1<<--kr,In(),Nr.pop();const e=Nr.length;Kn=e>0?Nr[e-1]:void 0}}stop(){this.active&&(cd(this),this.onStop&&this.onStop(),this.active=!1)}}function cd(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let Fi=!0;const za=[];function Qn(){za.push(Fi),Fi=!1}function K_(){za.push(Fi),Fi=!0}function In(){const t=za.pop();Fi=t===void 0?!0:t}function gt(t,e,n){if(!ud())return;let i=Ba.get(t);i||Ba.set(t,i=new Map);let r=i.get(n);r||i.set(n,r=Wa()),dd(r)}function ud(){return Fi&&Kn!==void 0}function dd(t,e){let n=!1;kr<=ja?ld(t)||(t.n|=En,n=!ad(t)):n=!t.has(Kn),n&&(t.add(Kn),Kn.deps.push(t))}function cn(t,e,n,i,r,s){const o=Ba.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&ne(t))o.forEach((l,c)=>{(c==="length"||c>=i)&&a.push(l)});else switch(n!==void 0&&a.push(o.get(n)),e){case"add":ne(t)?Ua(n)&&a.push(o.get("length")):(a.push(o.get(Yn)),Di(t)&&a.push(o.get($a)));break;case"delete":ne(t)||(a.push(o.get(Yn)),Di(t)&&a.push(o.get($a)));break;case"set":Di(t)&&a.push(o.get(Yn));break}if(a.length===1)a[0]&&qa(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);qa(Wa(l))}}function qa(t,e){for(const n of ne(t)?t:[...t])(n!==Kn||n.allowRecurse)&&(n.scheduler?n.scheduler():n.run())}const Y_=xa("__proto__,__v_isRef,__isVue"),hd=new Set(Object.getOwnPropertyNames(Symbol).map(t=>Symbol[t]).filter(Fa)),Q_=Ga(),J_=Ga(!1,!0),X_=Ga(!0),fd=Z_();function Z_(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=pe(this);for(let s=0,o=this.length;s<o;s++)gt(i,"get",s+"");const r=i[e](...n);return r===-1||r===!1?i[e](...n.map(pe)):r}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Qn();const i=pe(this)[e].apply(this,n);return In(),i}}),t}function Ga(t=!1,e=!1){return function(i,r,s){if(r==="__v_isReactive")return!t;if(r==="__v_isReadonly")return t;if(r==="__v_raw"&&s===(t?e?mv:Id:e?Ed:wd).get(i))return i;const o=ne(i);if(!t&&o&&ge(fd,r))return Reflect.get(fd,r,s);const a=Reflect.get(i,r,s);return(Fa(r)?hd.has(r):Y_(r))||(t||gt(i,"get",r),e)?a:Me(a)?!o||!Ua(r)?a.value:a:xe(a)?t?Zs(a):Cn(a):a}}const ev=pd(),tv=pd(!0);function pd(t=!1){return function(n,i,r,s){let o=n[i];if(!t&&(r=pe(r),o=pe(o),!ne(n)&&Me(o)&&!Me(r)))return o.value=r,!0;const a=ne(n)&&Ua(i)?Number(i)<n.length:ge(n,i),l=Reflect.set(n,i,r,s);return n===pe(s)&&(a?Ar(r,o)&&cn(n,"set",i,r):cn(n,"add",i,r)),l}}function nv(t,e){const n=ge(t,e);t[e];const i=Reflect.deleteProperty(t,e);return i&&n&&cn(t,"delete",e,void 0),i}function iv(t,e){const n=Reflect.has(t,e);return(!Fa(e)||!hd.has(e))&&gt(t,"has",e),n}function rv(t){return gt(t,"iterate",ne(t)?"length":Yn),Reflect.ownKeys(t)}const md={get:Q_,set:ev,deleteProperty:nv,has:iv,ownKeys:rv},sv={get:X_,set(t,e){return!0},deleteProperty(t,e){return!0}},ov=Je({},md,{get:J_,set:tv}),Ka=t=>t,Gs=t=>Reflect.getPrototypeOf(t);function Ks(t,e,n=!1,i=!1){t=t.__v_raw;const r=pe(t),s=pe(e);e!==s&&!n&&gt(r,"get",e),!n&&gt(r,"get",s);const{has:o}=Gs(r),a=i?Ka:n?Xa:Pr;if(o.call(r,e))return a(t.get(e));if(o.call(r,s))return a(t.get(s));t!==r&&t.get(e)}function Ys(t,e=!1){const n=this.__v_raw,i=pe(n),r=pe(t);return t!==r&&!e&&gt(i,"has",t),!e&&gt(i,"has",r),t===r?n.has(t):n.has(t)||n.has(r)}function Qs(t,e=!1){return t=t.__v_raw,!e&&gt(pe(t),"iterate",Yn),Reflect.get(t,"size",t)}function gd(t){t=pe(t);const e=pe(this);return Gs(e).has.call(e,t)||(e.add(t),cn(e,"add",t,t)),this}function _d(t,e){e=pe(e);const n=pe(this),{has:i,get:r}=Gs(n);let s=i.call(n,t);s||(t=pe(t),s=i.call(n,t));const o=r.call(n,t);return n.set(t,e),s?Ar(e,o)&&cn(n,"set",t,e):cn(n,"add",t,e),this}function vd(t){const e=pe(this),{has:n,get:i}=Gs(e);let r=n.call(e,t);r||(t=pe(t),r=n.call(e,t)),i&&i.call(e,t);const s=e.delete(t);return r&&cn(e,"delete",t,void 0),s}function yd(){const t=pe(this),e=t.size!==0,n=t.clear();return e&&cn(t,"clear",void 0,void 0),n}function Js(t,e){return function(i,r){const s=this,o=s.__v_raw,a=pe(o),l=e?Ka:t?Xa:Pr;return!t&&gt(a,"iterate",Yn),o.forEach((c,u)=>i.call(r,l(c),l(u),s))}}function Xs(t,e,n){return function(...i){const r=this.__v_raw,s=pe(r),o=Di(s),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=r[t](...i),u=n?Ka:e?Xa:Pr;return!e&&gt(s,"iterate",l?$a:Yn),{next(){const{value:d,done:h}=c.next();return h?{value:d,done:h}:{value:a?[u(d[0]),u(d[1])]:u(d),done:h}},[Symbol.iterator](){return this}}}}function bn(t){return function(...e){return t==="delete"?!1:this}}function av(){const t={get(s){return Ks(this,s)},get size(){return Qs(this)},has:Ys,add:gd,set:_d,delete:vd,clear:yd,forEach:Js(!1,!1)},e={get(s){return Ks(this,s,!1,!0)},get size(){return Qs(this)},has:Ys,add:gd,set:_d,delete:vd,clear:yd,forEach:Js(!1,!0)},n={get(s){return Ks(this,s,!0)},get size(){return Qs(this,!0)},has(s){return Ys.call(this,s,!0)},add:bn("add"),set:bn("set"),delete:bn("delete"),clear:bn("clear"),forEach:Js(!0,!1)},i={get(s){return Ks(this,s,!0,!0)},get size(){return Qs(this,!0)},has(s){return Ys.call(this,s,!0)},add:bn("add"),set:bn("set"),delete:bn("delete"),clear:bn("clear"),forEach:Js(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=Xs(s,!1,!1),n[s]=Xs(s,!0,!1),e[s]=Xs(s,!1,!0),i[s]=Xs(s,!0,!0)}),[t,n,e,i]}const[lv,cv,uv,dv]=av();function Ya(t,e){const n=e?t?dv:uv:t?cv:lv;return(i,r,s)=>r==="__v_isReactive"?!t:r==="__v_isReadonly"?t:r==="__v_raw"?i:Reflect.get(ge(n,r)&&r in i?n:i,r,s)}const hv={get:Ya(!1,!1)},fv={get:Ya(!1,!0)},pv={get:Ya(!0,!1)},wd=new WeakMap,Ed=new WeakMap,Id=new WeakMap,mv=new WeakMap;function gv(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function _v(t){return t.__v_skip||!Object.isExtensible(t)?0:gv(W_(t))}function Cn(t){return t&&t.__v_isReadonly?t:Qa(t,!1,md,hv,wd)}function vv(t){return Qa(t,!1,ov,fv,Ed)}function Zs(t){return Qa(t,!0,sv,pv,Id)}function Qa(t,e,n,i,r){if(!xe(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=r.get(t);if(s)return s;const o=_v(t);if(o===0)return t;const a=new Proxy(t,o===2?i:n);return r.set(t,a),a}function Ui(t){return bd(t)?Ui(t.__v_raw):!!(t&&t.__v_isReactive)}function bd(t){return!!(t&&t.__v_isReadonly)}function Cd(t){return Ui(t)||bd(t)}function pe(t){const e=t&&t.__v_raw;return e?pe(e):t}function Ja(t){return Hs(t,"__v_skip",!0),t}const Pr=t=>xe(t)?Cn(t):t,Xa=t=>xe(t)?Zs(t):t;function Td(t){ud()&&(t=pe(t),t.dep||(t.dep=Wa()),dd(t.dep))}function Sd(t,e){t=pe(t),t.dep&&qa(t.dep)}function Me(t){return Boolean(t&&t.__v_isRef===!0)}function Mt(t){return Rd(t,!1)}function yv(t){return Rd(t,!0)}function Rd(t,e){return Me(t)?t:new wv(t,e)}class wv{constructor(e,n){this._shallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:pe(e),this._value=n?e:Pr(e)}get value(){return Td(this),this._value}set value(e){e=this._shallow?e:pe(e),Ar(e,this._rawValue)&&(this._rawValue=e,this._value=this._shallow?e:Pr(e),Sd(this))}}function z(t){return Me(t)?t.value:t}const Ev={get:(t,e,n)=>z(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const r=t[e];return Me(r)&&!Me(n)?(r.value=n,!0):Reflect.set(t,e,n,i)}};function Ad(t){return Ui(t)?t:new Proxy(t,Ev)}class Iv{constructor(e,n){this._object=e,this._key=n,this.__v_isRef=!0}get value(){return this._object[this._key]}set value(e){this._object[this._key]=e}}function Tn(t,e){const n=t[e];return Me(n)?n:new Iv(t,e)}class bv{constructor(e,n,i){this._setter=n,this.dep=void 0,this._dirty=!0,this.__v_isRef=!0,this.effect=new Ha(e,()=>{this._dirty||(this._dirty=!0,Sd(this))}),this.__v_isReadonly=i}get value(){const e=pe(this);return Td(e),e._dirty&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function ye(t,e){let n,i;const r=re(t);return r?(n=t,i=xt):(n=t.get,i=t.set),new bv(n,i,r||!i)}Promise.resolve();function Cv(t,e,...n){const i=t.vnode.props||Ie;let r=n;const s=e.startsWith("update:"),o=s&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:d,trim:h}=i[u]||Ie;h?r=n.map(p=>p.trim()):d&&(r=n.map(zs))}let a,l=i[a=Va(e)]||i[a=Va(Ht(e))];!l&&s&&(l=i[a=Va(qn(e))]),l&&Tt(l,t,6,r);const c=i[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Tt(c,t,6,r)}}function kd(t,e,n=!1){const i=e.emitsCache,r=i.get(t);if(r!==void 0)return r;const s=t.emits;let o={},a=!1;if(!re(t)){const l=c=>{const u=kd(c,e,!0);u&&(a=!0,Je(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!s&&!a?(i.set(t,null),null):(ne(s)?s.forEach(l=>o[l]=null):Je(o,s),i.set(t,o),o)}function Za(t,e){return!t||!Us(e)?!1:(e=e.slice(2).replace(/Once$/,""),ge(t,e[0].toLowerCase()+e.slice(1))||ge(t,qn(e))||ge(t,e))}let bt=null,Nd=null;function eo(t){const e=bt;return bt=t,Nd=t&&t.type.__scopeId||null,e}function Tv(t,e=bt,n){if(!e||t._n)return t;const i=(...r)=>{i._d&&nh(-1);const s=eo(e),o=t(...r);return eo(s),i._d&&nh(1),o};return i._n=!0,i._c=!0,i._d=!0,i}function el(t){const{type:e,vnode:n,proxy:i,withProxy:r,props:s,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:d,data:h,setupState:p,ctx:g,inheritAttrs:R}=t;let I,y;const T=eo(t);try{if(n.shapeFlag&4){const D=r||i;I=Yt(u.call(D,D,d,s,p,h,g)),y=l}else{const D=e;I=Yt(D.length>1?D(s,{attrs:l,slots:a,emit:c}):D(s,null)),y=e.props?l:Sv(l)}}catch(D){xr.length=0,uo(D,t,1),I=_t(Kt)}let M=I;if(y&&R!==!1){const D=Object.keys(y),{shapeFlag:B}=M;D.length&&B&(1|6)&&(o&&D.some(Da)&&(y=Rv(y,o)),M=Bi(M,y))}return n.dirs&&(M.dirs=M.dirs?M.dirs.concat(n.dirs):n.dirs),n.transition&&(M.transition=n.transition),I=M,eo(T),I}const Sv=t=>{let e;for(const n in t)(n==="class"||n==="style"||Us(n))&&((e||(e={}))[n]=t[n]);return e},Rv=(t,e)=>{const n={};for(const i in t)(!Da(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function Av(t,e,n){const{props:i,children:r,component:s}=t,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return i?Pd(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let d=0;d<u.length;d++){const h=u[d];if(o[h]!==i[h]&&!Za(c,h))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?Pd(i,o,c):!0:!!o;return!1}function Pd(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let r=0;r<i.length;r++){const s=i[r];if(e[s]!==t[s]&&!Za(n,s))return!0}return!1}function kv({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const Nv=t=>t.__isSuspense;function Pv(t,e){e&&e.pendingBranch?ne(t)?e.effects.push(...t):e.effects.push(t):Oy(t)}function Vi(t,e){if(je){let n=je.provides;const i=je.parent&&je.parent.provides;i===n&&(n=je.provides=Object.create(i)),n[t]=e}}function zt(t,e,n=!1){const i=je||bt;if(i){const r=i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides;if(r&&t in r)return r[t];if(arguments.length>1)return n&&re(e)?e.call(i.proxy):e}}function Ov(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return io(()=>{t.isMounted=!0}),Or(()=>{t.isUnmounting=!0}),t}const Ct=[Function,Array],xv={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ct,onEnter:Ct,onAfterEnter:Ct,onEnterCancelled:Ct,onBeforeLeave:Ct,onLeave:Ct,onAfterLeave:Ct,onLeaveCancelled:Ct,onBeforeAppear:Ct,onAppear:Ct,onAfterAppear:Ct,onAppearCancelled:Ct},setup(t,{slots:e}){const n=oh(),i=Ov();let r;return()=>{const s=e.default&&Ld(e.default(),!0);if(!s||!s.length)return;const o=pe(t),{mode:a}=o,l=s[0];if(i.isLeaving)return nl(l);const c=Md(l);if(!c)return nl(l);const u=tl(c,o,i,n);il(c,u);const d=n.subTree,h=d&&Md(d);let p=!1;const{getTransitionKey:g}=c.type;if(g){const R=g();r===void 0?r=R:R!==r&&(r=R,p=!0)}if(h&&h.type!==Kt&&(!ei(c,h)||p)){const R=tl(h,o,i,n);if(il(h,R),a==="out-in")return i.isLeaving=!0,R.afterLeave=()=>{i.isLeaving=!1,n.update()},nl(l);a==="in-out"&&c.type!==Kt&&(R.delayLeave=(I,y,T)=>{const M=xd(i,h);M[String(h.key)]=h,I._leaveCb=()=>{y(),I._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=T})}return l}}},Od=xv;function xd(t,e){const{leavingVNodes:n}=t;let i=n.get(e.type);return i||(i=Object.create(null),n.set(e.type,i)),i}function tl(t,e,n,i){const{appear:r,mode:s,persisted:o=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:d,onLeave:h,onAfterLeave:p,onLeaveCancelled:g,onBeforeAppear:R,onAppear:I,onAfterAppear:y,onAppearCancelled:T}=e,M=String(t.key),D=xd(n,t),B=(q,te)=>{q&&Tt(q,i,9,te)},X={mode:s,persisted:o,beforeEnter(q){let te=a;if(!n.isMounted)if(r)te=R||a;else return;q._leaveCb&&q._leaveCb(!0);const j=D[M];j&&ei(t,j)&&j.el._leaveCb&&j.el._leaveCb(),B(te,[q])},enter(q){let te=l,j=c,ie=u;if(!n.isMounted)if(r)te=I||l,j=y||c,ie=T||u;else return;let ce=!1;const W=q._enterCb=de=>{ce||(ce=!0,de?B(ie,[q]):B(j,[q]),X.delayedLeave&&X.delayedLeave(),q._enterCb=void 0)};te?(te(q,W),te.length<=1&&W()):W()},leave(q,te){const j=String(t.key);if(q._enterCb&&q._enterCb(!0),n.isUnmounting)return te();B(d,[q]);let ie=!1;const ce=q._leaveCb=W=>{ie||(ie=!0,te(),W?B(g,[q]):B(p,[q]),q._leaveCb=void 0,D[j]===t&&delete D[j])};D[j]=t,h?(h(q,ce),h.length<=1&&ce()):ce()},clone(q){return tl(q,e,n,i)}};return X}function nl(t){if(to(t))return t=Bi(t),t.children=null,t}function Md(t){return to(t)?t.children?t.children[0]:void 0:t}function il(t,e){t.shapeFlag&6&&t.component?il(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Ld(t,e=!1){let n=[],i=0;for(let r=0;r<t.length;r++){const s=t[r];s.type===Gt?(s.patchFlag&128&&i++,n=n.concat(Ld(s.children,e))):(e||s.type!==Kt)&&n.push(s)}if(i>1)for(let r=0;r<n.length;r++)n[r].patchFlag=-2;return n}function Wi(t){return re(t)?{setup:t,name:t.name}:t}const rl=t=>!!t.type.__asyncLoader,to=t=>t.type.__isKeepAlive;function Mv(t,e){Dd(t,"a",e)}function Lv(t,e){Dd(t,"da",e)}function Dd(t,e,n=je){const i=t.__wdc||(t.__wdc=()=>{let r=n;for(;r;){if(r.isDeactivated)return;r=r.parent}t()});if(no(e,i,n),n){let r=n.parent;for(;r&&r.parent;)to(r.parent.vnode)&&Dv(i,e,n,r),r=r.parent}}function Dv(t,e,n,i){const r=no(e,t,i,!0);Fd(()=>{td(i[e],r)},n)}function no(t,e,n=je,i=!1){if(n){const r=n[t]||(n[t]=[]),s=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;Qn(),ji(n);const a=Tt(e,n,t,o);return ti(),In(),a});return i?r.unshift(s):r.push(s),s}}const un=t=>(e,n=je)=>(!co||t==="sp")&&no(t,e,n),Fv=un("bm"),io=un("m"),Uv=un("bu"),Vv=un("u"),Or=un("bum"),Fd=un("um"),Wv=un("sp"),Bv=un("rtg"),jv=un("rtc");function $v(t,e=je){no("ec",t,e)}let sl=!0;function Hv(t){const e=Wd(t),n=t.proxy,i=t.ctx;sl=!1,e.beforeCreate&&Ud(e.beforeCreate,t,"bc");const{data:r,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:d,mounted:h,beforeUpdate:p,updated:g,activated:R,deactivated:I,beforeDestroy:y,beforeUnmount:T,destroyed:M,unmounted:D,render:B,renderTracked:X,renderTriggered:q,errorCaptured:te,serverPrefetch:j,expose:ie,inheritAttrs:ce,components:W,directives:de,filters:ke}=e;if(c&&zv(c,i,null,t.appContext.config.unwrapInjectedRef),o)for(const le in o){const ue=o[le];re(ue)&&(i[le]=ue.bind(n))}if(r){const le=r.call(n,n);xe(le)&&(t.data=Cn(le))}if(sl=!0,s)for(const le in s){const ue=s[le],U=re(ue)?ue.bind(n,n):re(ue.get)?ue.get.bind(n,n):xt,me=!re(ue)&&re(ue.set)?ue.set.bind(n):xt,Re=ye({get:U,set:me});Object.defineProperty(i,le,{enumerable:!0,configurable:!0,get:()=>Re.value,set:it=>Re.value=it})}if(a)for(const le in a)Vd(a[le],i,n,le);if(l){const le=re(l)?l.call(n):l;Reflect.ownKeys(le).forEach(ue=>{Vi(ue,le[ue])})}u&&Ud(u,t,"c");function he(le,ue){ne(ue)?ue.forEach(U=>le(U.bind(n))):ue&&le(ue.bind(n))}if(he(Fv,d),he(io,h),he(Uv,p),he(Vv,g),he(Mv,R),he(Lv,I),he($v,te),he(jv,X),he(Bv,q),he(Or,T),he(Fd,D),he(Wv,j),ne(ie))if(ie.length){const le=t.exposed||(t.exposed={});ie.forEach(ue=>{Object.defineProperty(le,ue,{get:()=>n[ue],set:U=>n[ue]=U})})}else t.exposed||(t.exposed={});B&&t.render===xt&&(t.render=B),ce!=null&&(t.inheritAttrs=ce),W&&(t.components=W),de&&(t.directives=de)}function zv(t,e,n=xt,i=!1){ne(t)&&(t=ol(t));for(const r in t){const s=t[r];let o;xe(s)?"default"in s?o=zt(s.from||r,s.default,!0):o=zt(s.from||r):o=zt(s),Me(o)&&i?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>o.value,set:a=>o.value=a}):e[r]=o}}function Ud(t,e,n){Tt(ne(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function Vd(t,e,n,i){const r=i.includes(".")?bh(n,i):()=>n[i];if(Fe(t)){const s=e[t];re(s)&&lt(r,s)}else if(re(t))lt(r,t.bind(n));else if(xe(t))if(ne(t))t.forEach(s=>Vd(s,e,n,i));else{const s=re(t.handler)?t.handler.bind(n):e[t.handler];re(s)&&lt(r,s,t)}}function Wd(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:r,optionsCache:s,config:{optionMergeStrategies:o}}=t.appContext,a=s.get(e);let l;return a?l=a:!r.length&&!n&&!i?l=e:(l={},r.length&&r.forEach(c=>ro(l,c,o,!0)),ro(l,e,o)),s.set(e,l),l}function ro(t,e,n,i=!1){const{mixins:r,extends:s}=e;s&&ro(t,s,n,!0),r&&r.forEach(o=>ro(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const a=qv[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const qv={data:Bd,props:Jn,emits:Jn,methods:Jn,computed:Jn,beforeCreate:rt,created:rt,beforeMount:rt,mounted:rt,beforeUpdate:rt,updated:rt,beforeDestroy:rt,beforeUnmount:rt,destroyed:rt,unmounted:rt,activated:rt,deactivated:rt,errorCaptured:rt,serverPrefetch:rt,components:Jn,directives:Jn,watch:Kv,provide:Bd,inject:Gv};function Bd(t,e){return e?t?function(){return Je(re(t)?t.call(this,this):t,re(e)?e.call(this,this):e)}:e:t}function Gv(t,e){return Jn(ol(t),ol(e))}function ol(t){if(ne(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function rt(t,e){return t?[...new Set([].concat(t,e))]:e}function Jn(t,e){return t?Je(Je(Object.create(null),t),e):e}function Kv(t,e){if(!t)return e;if(!e)return t;const n=Je(Object.create(null),t);for(const i in e)n[i]=rt(t[i],e[i]);return n}function Yv(t,e,n,i=!1){const r={},s={};Hs(s,oo,1),t.propsDefaults=Object.create(null),jd(t,e,r,s);for(const o in t.propsOptions[0])o in r||(r[o]=void 0);n?t.props=i?r:vv(r):t.type.props?t.props=r:t.props=s,t.attrs=s}function Qv(t,e,n,i){const{props:r,attrs:s,vnode:{patchFlag:o}}=t,a=pe(r),[l]=t.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let d=0;d<u.length;d++){let h=u[d];const p=e[h];if(l)if(ge(s,h))p!==s[h]&&(s[h]=p,c=!0);else{const g=Ht(h);r[g]=al(l,a,g,p,t,!1)}else p!==s[h]&&(s[h]=p,c=!0)}}}else{jd(t,e,r,s)&&(c=!0);let u;for(const d in a)(!e||!ge(e,d)&&((u=qn(d))===d||!ge(e,u)))&&(l?n&&(n[d]!==void 0||n[u]!==void 0)&&(r[d]=al(l,a,d,void 0,t,!0)):delete r[d]);if(s!==a)for(const d in s)(!e||!ge(e,d))&&(delete s[d],c=!0)}c&&cn(t,"set","$attrs")}function jd(t,e,n,i){const[r,s]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Ws(l))continue;const c=e[l];let u;r&&ge(r,u=Ht(l))?!s||!s.includes(u)?n[u]=c:(a||(a={}))[u]=c:Za(t.emitsOptions,l)||c!==i[l]&&(i[l]=c,o=!0)}if(s){const l=pe(n),c=a||Ie;for(let u=0;u<s.length;u++){const d=s[u];n[d]=al(r,l,d,c[d],t,!ge(c,d))}}return o}function al(t,e,n,i,r,s){const o=t[n];if(o!=null){const a=ge(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&re(l)){const{propsDefaults:c}=r;n in c?i=c[n]:(ji(r),i=c[n]=l.call(null,e),ti())}else i=l}o[0]&&(s&&!a?i=!1:o[1]&&(i===""||i===qn(n))&&(i=!0))}return i}function $d(t,e,n=!1){const i=e.propsCache,r=i.get(t);if(r)return r;const s=t.props,o={},a=[];let l=!1;if(!re(t)){const u=d=>{l=!0;const[h,p]=$d(d,e,!0);Je(o,h),p&&a.push(...p)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!s&&!l)return i.set(t,Li),Li;if(ne(s))for(let u=0;u<s.length;u++){const d=Ht(s[u]);Hd(d)&&(o[d]=Ie)}else if(s)for(const u in s){const d=Ht(u);if(Hd(d)){const h=s[u],p=o[d]=ne(h)||re(h)?{type:h}:h;if(p){const g=Gd(Boolean,p.type),R=Gd(String,p.type);p[0]=g>-1,p[1]=R<0||g<R,(g>-1||ge(p,"default"))&&a.push(d)}}}const c=[o,a];return i.set(t,c),c}function Hd(t){return t[0]!=="$"}function zd(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function qd(t,e){return zd(t)===zd(e)}function Gd(t,e){return ne(e)?e.findIndex(n=>qd(n,t)):re(e)&&qd(e,t)?0:-1}const Kd=t=>t[0]==="_"||t==="$stable",ll=t=>ne(t)?t.map(Yt):[Yt(t)],Jv=(t,e,n)=>{const i=Tv((...r)=>ll(e(...r)),n);return i._c=!1,i},Yd=(t,e,n)=>{const i=t._ctx;for(const r in t){if(Kd(r))continue;const s=t[r];if(re(s))e[r]=Jv(r,s,i);else if(s!=null){const o=ll(s);e[r]=()=>o}}},Qd=(t,e)=>{const n=ll(e);t.slots.default=()=>n},Xv=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=pe(e),Hs(e,"_",n)):Yd(e,t.slots={})}else t.slots={},e&&Qd(t,e);Hs(t.slots,oo,1)},Zv=(t,e,n)=>{const{vnode:i,slots:r}=t;let s=!0,o=Ie;if(i.shapeFlag&32){const a=e._;a?n&&a===1?s=!1:(Je(r,e),!n&&a===1&&delete r._):(s=!e.$stable,Yd(e,r)),o=e}else e&&(Qd(t,e),o={default:1});if(s)for(const a in r)!Kd(a)&&!(a in o)&&delete r[a]};function SN(t,e){const n=bt;if(n===null)return t;const i=n.proxy,r=t.dirs||(t.dirs=[]);for(let s=0;s<e.length;s++){let[o,a,l,c=Ie]=e[s];re(o)&&(o={mounted:o,updated:o}),o.deep&&ni(a),r.push({dir:o,instance:i,value:a,oldValue:void 0,arg:l,modifiers:c})}return t}function Xn(t,e,n,i){const r=t.dirs,s=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];s&&(a.oldValue=s[o].value);let l=a.dir[i];l&&(Qn(),Tt(l,n,8,[t.el,a,t,e]),In())}}function Jd(){return{app:null,config:{isNativeTag:F_,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let ey=0;function ty(t,e){return function(i,r=null){r!=null&&!xe(r)&&(r=null);const s=Jd(),o=new Set;let a=!1;const l=s.app={_uid:ey++,_component:i,_props:r,_container:null,_context:s,_instance:null,version:My,get config(){return s.config},set config(c){},use(c,...u){return o.has(c)||(c&&re(c.install)?(o.add(c),c.install(l,...u)):re(c)&&(o.add(c),c(l,...u))),l},mixin(c){return s.mixins.includes(c)||s.mixins.push(c),l},component(c,u){return u?(s.components[c]=u,l):s.components[c]},directive(c,u){return u?(s.directives[c]=u,l):s.directives[c]},mount(c,u,d){if(!a){const h=_t(i,r);return h.appContext=s,u&&e?e(h,c):t(h,c,d),a=!0,l._container=c,c.__vue_app__=l,_l(h.component)||h.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return s.provides[c]=u,l}};return l}}const st=Pv;function ny(t){return iy(t)}function iy(t,e){const n=$_();n.__VUE__=!0;const{insert:i,remove:r,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:d,nextSibling:h,setScopeId:p=xt,cloneNode:g,insertStaticContent:R}=t,I=(f,m,_,w=null,b=null,P=null,V=!1,A=null,O=!!m.dynamicChildren)=>{if(f===m)return;f&&!ei(f,m)&&(w=G(f),De(f,b,P,!0),f=null),m.patchFlag===-2&&(O=!1,m.dynamicChildren=null);const{type:S,ref:K,shapeFlag:H}=m;switch(S){case hl:y(f,m,_,w);break;case Kt:T(f,m,_,w);break;case fl:f==null&&M(m,_,w,V);break;case Gt:de(f,m,_,w,b,P,V,A,O);break;default:H&1?X(f,m,_,w,b,P,V,A,O):H&6?ke(f,m,_,w,b,P,V,A,O):(H&64||H&128)&&S.process(f,m,_,w,b,P,V,A,O,C)}K!=null&&b&&cl(K,f&&f.ref,P,m||f,!m)},y=(f,m,_,w)=>{if(f==null)i(m.el=a(m.children),_,w);else{const b=m.el=f.el;m.children!==f.children&&c(b,m.children)}},T=(f,m,_,w)=>{f==null?i(m.el=l(m.children||""),_,w):m.el=f.el},M=(f,m,_,w)=>{[f.el,f.anchor]=R(f.children,m,_,w)},D=({el:f,anchor:m},_,w)=>{let b;for(;f&&f!==m;)b=h(f),i(f,_,w),f=b;i(m,_,w)},B=({el:f,anchor:m})=>{let _;for(;f&&f!==m;)_=h(f),r(f),f=_;r(m)},X=(f,m,_,w,b,P,V,A,O)=>{V=V||m.type==="svg",f==null?q(m,_,w,b,P,V,A,O):ie(f,m,b,P,V,A,O)},q=(f,m,_,w,b,P,V,A)=>{let O,S;const{type:K,props:H,shapeFlag:Y,transition:ee,patchFlag:fe,dirs:Ne}=f;if(f.el&&g!==void 0&&fe===-1)O=f.el=g(f.el);else{if(O=f.el=o(f.type,P,H&&H.is,H),Y&8?u(O,f.children):Y&16&&j(f.children,O,null,w,b,P&&K!=="foreignObject",V,A),Ne&&Xn(f,null,w,"created"),H){for(const Ae in H)Ae!=="value"&&!Ws(Ae)&&s(O,Ae,null,H[Ae],P,f.children,w,b,L);"value"in H&&s(O,"value",null,H.value),(S=H.onVnodeBeforeMount)&&qt(S,w,f)}te(O,f,f.scopeId,V,w)}Ne&&Xn(f,null,w,"beforeMount");const Ee=(!b||b&&!b.pendingBranch)&&ee&&!ee.persisted;Ee&&ee.beforeEnter(O),i(O,m,_),((S=H&&H.onVnodeMounted)||Ee||Ne)&&st(()=>{S&&qt(S,w,f),Ee&&ee.enter(O),Ne&&Xn(f,null,w,"mounted")},b)},te=(f,m,_,w,b)=>{if(_&&p(f,_),w)for(let P=0;P<w.length;P++)p(f,w[P]);if(b){let P=b.subTree;if(m===P){const V=b.vnode;te(f,V,V.scopeId,V.slotScopeIds,b.parent)}}},j=(f,m,_,w,b,P,V,A,O=0)=>{for(let S=O;S<f.length;S++){const K=f[S]=A?Sn(f[S]):Yt(f[S]);I(null,K,m,_,w,b,P,V,A)}},ie=(f,m,_,w,b,P,V)=>{const A=m.el=f.el;let{patchFlag:O,dynamicChildren:S,dirs:K}=m;O|=f.patchFlag&16;const H=f.props||Ie,Y=m.props||Ie;let ee;(ee=Y.onVnodeBeforeUpdate)&&qt(ee,_,m,f),K&&Xn(m,f,_,"beforeUpdate");const fe=b&&m.type!=="foreignObject";if(S?ce(f.dynamicChildren,S,A,_,w,fe,P):V||U(f,m,A,null,_,w,fe,P,!1),O>0){if(O&16)W(A,m,H,Y,_,w,b);else if(O&2&&H.class!==Y.class&&s(A,"class",null,Y.class,b),O&4&&s(A,"style",H.style,Y.style,b),O&8){const Ne=m.dynamicProps;for(let Ee=0;Ee<Ne.length;Ee++){const Ae=Ne[Ee],Ot=H[Ae],Mi=Y[Ae];(Mi!==Ot||Ae==="value")&&s(A,Ae,Ot,Mi,b,f.children,_,w,L)}}O&1&&f.children!==m.children&&u(A,m.children)}else!V&&S==null&&W(A,m,H,Y,_,w,b);((ee=Y.onVnodeUpdated)||K)&&st(()=>{ee&&qt(ee,_,m,f),K&&Xn(m,f,_,"updated")},w)},ce=(f,m,_,w,b,P,V)=>{for(let A=0;A<m.length;A++){const O=f[A],S=m[A],K=O.el&&(O.type===Gt||!ei(O,S)||O.shapeFlag&(6|64))?d(O.el):_;I(O,S,K,null,w,b,P,V,!0)}},W=(f,m,_,w,b,P,V)=>{if(_!==w){for(const A in w){if(Ws(A))continue;const O=w[A],S=_[A];O!==S&&A!=="value"&&s(f,A,S,O,V,m.children,b,P,L)}if(_!==Ie)for(const A in _)!Ws(A)&&!(A in w)&&s(f,A,_[A],null,V,m.children,b,P,L);"value"in w&&s(f,"value",_.value,w.value)}},de=(f,m,_,w,b,P,V,A,O)=>{const S=m.el=f?f.el:a(""),K=m.anchor=f?f.anchor:a("");let{patchFlag:H,dynamicChildren:Y,slotScopeIds:ee}=m;ee&&(A=A?A.concat(ee):ee),f==null?(i(S,_,w),i(K,_,w),j(m.children,_,K,b,P,V,A,O)):H>0&&H&64&&Y&&f.dynamicChildren?(ce(f.dynamicChildren,Y,_,b,P,V,A),(m.key!=null||b&&m===b.subTree)&&Xd(f,m,!0)):U(f,m,_,K,b,P,V,A,O)},ke=(f,m,_,w,b,P,V,A,O)=>{m.slotScopeIds=A,f==null?m.shapeFlag&512?b.ctx.activate(m,_,w,V,O):tt(m,_,w,b,P,V,O):he(f,m,O)},tt=(f,m,_,w,b,P,V)=>{const A=f.component=gy(f,w,b);if(to(f)&&(A.ctx.renderer=C),_y(A),A.asyncDep){if(b&&b.registerDep(A,le),!f.el){const O=A.subTree=_t(Kt);T(null,O,m,_)}return}le(A,f,m,_,b,P,V)},he=(f,m,_)=>{const w=m.component=f.component;if(Av(f,m,_))if(w.asyncDep&&!w.asyncResolved){ue(w,m,_);return}else w.next=m,Ny(w.update),w.update();else m.component=f.component,m.el=f.el,w.vnode=m},le=(f,m,_,w,b,P,V)=>{const A=()=>{if(f.isMounted){let{next:K,bu:H,u:Y,parent:ee,vnode:fe}=f,Ne=K,Ee;O.allowRecurse=!1,K?(K.el=fe.el,ue(f,K,V)):K=fe,H&&$s(H),(Ee=K.props&&K.props.onVnodeBeforeUpdate)&&qt(Ee,ee,K,fe),O.allowRecurse=!0;const Ae=el(f),Ot=f.subTree;f.subTree=Ae,I(Ot,Ae,d(Ot.el),G(Ot),f,b,P),K.el=Ae.el,Ne===null&&kv(f,Ae.el),Y&&st(Y,b),(Ee=K.props&&K.props.onVnodeUpdated)&&st(()=>qt(Ee,ee,K,fe),b)}else{let K;const{el:H,props:Y}=m,{bm:ee,m:fe,parent:Ne}=f,Ee=rl(m);if(O.allowRecurse=!1,ee&&$s(ee),!Ee&&(K=Y&&Y.onVnodeBeforeMount)&&qt(K,Ne,m),O.allowRecurse=!0,H&&x){const Ae=()=>{f.subTree=el(f),x(H,f.subTree,f,b,null)};Ee?m.type.__asyncLoader().then(()=>!f.isUnmounted&&Ae()):Ae()}else{const Ae=f.subTree=el(f);I(null,Ae,_,w,f,b,P),m.el=Ae.el}if(fe&&st(fe,b),!Ee&&(K=Y&&Y.onVnodeMounted)){const Ae=m;st(()=>qt(K,Ne,Ae),b)}m.shapeFlag&256&&f.a&&st(f.a,b),f.isMounted=!0,m=_=w=null}},O=new Ha(A,()=>gh(f.update),f.scope),S=f.update=O.run.bind(O);S.id=f.uid,O.allowRecurse=S.allowRecurse=!0,S()},ue=(f,m,_)=>{m.component=f;const w=f.vnode.props;f.vnode=m,f.next=null,Qv(f,m.props,w,_),Zv(f,m.children,_),Qn(),El(void 0,f.update),In()},U=(f,m,_,w,b,P,V,A,O=!1)=>{const S=f&&f.children,K=f?f.shapeFlag:0,H=m.children,{patchFlag:Y,shapeFlag:ee}=m;if(Y>0){if(Y&128){Re(S,H,_,w,b,P,V,A,O);return}else if(Y&256){me(S,H,_,w,b,P,V,A,O);return}}ee&8?(K&16&&L(S,b,P),H!==S&&u(_,H)):K&16?ee&16?Re(S,H,_,w,b,P,V,A,O):L(S,b,P,!0):(K&8&&u(_,""),ee&16&&j(H,_,w,b,P,V,A,O))},me=(f,m,_,w,b,P,V,A,O)=>{f=f||Li,m=m||Li;const S=f.length,K=m.length,H=Math.min(S,K);let Y;for(Y=0;Y<H;Y++){const ee=m[Y]=O?Sn(m[Y]):Yt(m[Y]);I(f[Y],ee,_,null,b,P,V,A,O)}S>K?L(f,b,P,!0,!1,H):j(m,_,w,b,P,V,A,O,H)},Re=(f,m,_,w,b,P,V,A,O)=>{let S=0;const K=m.length;let H=f.length-1,Y=K-1;for(;S<=H&&S<=Y;){const ee=f[S],fe=m[S]=O?Sn(m[S]):Yt(m[S]);if(ei(ee,fe))I(ee,fe,_,null,b,P,V,A,O);else break;S++}for(;S<=H&&S<=Y;){const ee=f[H],fe=m[Y]=O?Sn(m[Y]):Yt(m[Y]);if(ei(ee,fe))I(ee,fe,_,null,b,P,V,A,O);else break;H--,Y--}if(S>H){if(S<=Y){const ee=Y+1,fe=ee<K?m[ee].el:w;for(;S<=Y;)I(null,m[S]=O?Sn(m[S]):Yt(m[S]),_,fe,b,P,V,A,O),S++}}else if(S>Y)for(;S<=H;)De(f[S],b,P,!0),S++;else{const ee=S,fe=S,Ne=new Map;for(S=fe;S<=Y;S++){const mt=m[S]=O?Sn(m[S]):Yt(m[S]);mt.key!=null&&Ne.set(mt.key,S)}let Ee,Ae=0;const Ot=Y-fe+1;let Mi=!1,Gu=0;const Rr=new Array(Ot);for(S=0;S<Ot;S++)Rr[S]=0;for(S=ee;S<=H;S++){const mt=f[S];if(Ae>=Ot){De(mt,b,P,!0);continue}let $t;if(mt.key!=null)$t=Ne.get(mt.key);else for(Ee=fe;Ee<=Y;Ee++)if(Rr[Ee-fe]===0&&ei(mt,m[Ee])){$t=Ee;break}$t===void 0?De(mt,b,P,!0):(Rr[$t-fe]=S+1,$t>=Gu?Gu=$t:Mi=!0,I(mt,m[$t],_,null,b,P,V,A,O),Ae++)}const Ku=Mi?ry(Rr):Li;for(Ee=Ku.length-1,S=Ot-1;S>=0;S--){const mt=fe+S,$t=m[mt],Yu=mt+1<K?m[mt+1].el:w;Rr[S]===0?I(null,$t,_,Yu,b,P,V,A,O):Mi&&(Ee<0||S!==Ku[Ee]?it($t,_,Yu,2):Ee--)}}},it=(f,m,_,w,b=null)=>{const{el:P,type:V,transition:A,children:O,shapeFlag:S}=f;if(S&6){it(f.component.subTree,m,_,w);return}if(S&128){f.suspense.move(m,_,w);return}if(S&64){V.move(f,m,_,C);return}if(V===Gt){i(P,m,_);for(let H=0;H<O.length;H++)it(O[H],m,_,w);i(f.anchor,m,_);return}if(V===fl){D(f,m,_);return}if(w!==2&&S&1&&A)if(w===0)A.beforeEnter(P),i(P,m,_),st(()=>A.enter(P),b);else{const{leave:H,delayLeave:Y,afterLeave:ee}=A,fe=()=>i(P,m,_),Ne=()=>{H(P,()=>{fe(),ee&&ee()})};Y?Y(P,fe,Ne):Ne()}else i(P,m,_)},De=(f,m,_,w=!1,b=!1)=>{const{type:P,props:V,ref:A,children:O,dynamicChildren:S,shapeFlag:K,patchFlag:H,dirs:Y}=f;if(A!=null&&cl(A,null,_,f,!0),K&256){m.ctx.deactivate(f);return}const ee=K&1&&Y,fe=!rl(f);let Ne;if(fe&&(Ne=V&&V.onVnodeBeforeUnmount)&&qt(Ne,m,f),K&6)$(f.component,_,w);else{if(K&128){f.suspense.unmount(_,w);return}ee&&Xn(f,null,m,"beforeUnmount"),K&64?f.type.remove(f,m,_,b,C,w):S&&(P!==Gt||H>0&&H&64)?L(S,m,_,!1,!0):(P===Gt&&H&(128|256)||!b&&K&16)&&L(O,m,_),w&&ln(f)}(fe&&(Ne=V&&V.onVnodeUnmounted)||ee)&&st(()=>{Ne&&qt(Ne,m,f),ee&&Xn(f,null,m,"unmounted")},_)},ln=f=>{const{type:m,el:_,anchor:w,transition:b}=f;if(m===Gt){E(_,w);return}if(m===fl){B(f);return}const P=()=>{r(_),b&&!b.persisted&&b.afterLeave&&b.afterLeave()};if(f.shapeFlag&1&&b&&!b.persisted){const{leave:V,delayLeave:A}=b,O=()=>V(_,P);A?A(f.el,P,O):O()}else P()},E=(f,m)=>{let _;for(;f!==m;)_=h(f),r(f),f=_;r(m)},$=(f,m,_)=>{const{bum:w,scope:b,update:P,subTree:V,um:A}=f;w&&$s(w),b.stop(),P&&(P.active=!1,De(V,f,m,_)),A&&st(A,m),st(()=>{f.isUnmounted=!0},m),m&&m.pendingBranch&&!m.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===m.pendingId&&(m.deps--,m.deps===0&&m.resolve())},L=(f,m,_,w=!1,b=!1,P=0)=>{for(let V=P;V<f.length;V++)De(f[V],m,_,w,b)},G=f=>f.shapeFlag&6?G(f.component.subTree):f.shapeFlag&128?f.suspense.next():h(f.anchor||f.el),v=(f,m,_)=>{f==null?m._vnode&&De(m._vnode,null,null,!0):I(m._vnode||null,f,m,null,null,null,_),yh(),m._vnode=f},C={p:I,um:De,m:it,r:ln,mt:tt,mc:j,pc:U,pbc:ce,n:G,o:t};let F,x;return e&&([F,x]=e(C)),{render:v,hydrate:F,createApp:ty(v,F)}}function cl(t,e,n,i,r=!1){if(ne(t)){t.forEach((h,p)=>cl(h,e&&(ne(e)?e[p]:e),n,i,r));return}if(rl(i)&&!r)return;const s=i.shapeFlag&4?_l(i.component)||i.component.proxy:i.el,o=r?null:s,{i:a,r:l}=t,c=e&&e.r,u=a.refs===Ie?a.refs={}:a.refs,d=a.setupState;if(c!=null&&c!==l&&(Fe(c)?(u[c]=null,ge(d,c)&&(d[c]=null)):Me(c)&&(c.value=null)),Fe(l)){const h=()=>{u[l]=o,ge(d,l)&&(d[l]=o)};o?(h.id=-1,st(h,n)):h()}else if(Me(l)){const h=()=>{l.value=o};o?(h.id=-1,st(h,n)):h()}else re(l)&&dn(l,a,12,[o,u])}function qt(t,e,n,i=null){Tt(t,e,7,[n,i])}function Xd(t,e,n=!1){const i=t.children,r=e.children;if(ne(i)&&ne(r))for(let s=0;s<i.length;s++){const o=i[s];let a=r[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[s]=Sn(r[s]),a.el=o.el),n||Xd(o,a))}}function ry(t){const e=t.slice(),n=[0];let i,r,s,o,a;const l=t.length;for(i=0;i<l;i++){const c=t[i];if(c!==0){if(r=n[n.length-1],t[r]<c){e[i]=r,n.push(i);continue}for(s=0,o=n.length-1;s<o;)a=s+o>>1,t[n[a]]<c?s=a+1:o=a;c<t[n[s]]&&(s>0&&(e[i]=n[s-1]),n[s]=i)}}for(s=n.length,o=n[s-1];s-- >0;)n[s]=o,o=e[o];return n}const sy=t=>t.__isTeleport,ul="components";function RN(t,e){return eh(ul,t,!0,e)||t}const Zd=Symbol();function dl(t){return Fe(t)?eh(ul,t,!1)||t:t||Zd}function eh(t,e,n=!0,i=!1){const r=bt||je;if(r){const s=r.type;if(t===ul){const a=dh(s);if(a&&(a===e||a===Ht(e)||a===js(Ht(e))))return s}const o=th(r[t]||s[t],e)||th(r.appContext[t],e);return!o&&i?s:o}}function th(t,e){return t&&(t[e]||t[Ht(e)]||t[js(Ht(e))])}const Gt=Symbol(void 0),hl=Symbol(void 0),Kt=Symbol(void 0),fl=Symbol(void 0),xr=[];let Zn=null;function oy(t=!1){xr.push(Zn=t?null:[])}function ay(){xr.pop(),Zn=xr[xr.length-1]||null}let so=1;function nh(t){so+=t}function ih(t){return t.dynamicChildren=so>0?Zn||Li:null,ay(),so>0&&Zn&&Zn.push(t),t}function AN(t,e,n,i,r,s){return ih(sh(t,e,n,i,r,s,!0))}function ly(t,e,n,i,r){return ih(_t(t,e,n,i,r,!0))}function pl(t){return t?t.__v_isVNode===!0:!1}function ei(t,e){return t.type===e.type&&t.key===e.key}const oo="__vInternal",rh=({key:t})=>t!=null?t:null,ao=({ref:t})=>t!=null?Fe(t)||Me(t)||re(t)?{i:bt,r:t}:t:null;function sh(t,e=null,n=null,i=0,r=null,s=t===Gt?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&rh(e),ref:e&&ao(e),scopeId:Nd,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:r,dynamicChildren:null,appContext:null};return a?(ml(l,n),s&128&&t.normalize(l)):n&&(l.shapeFlag|=Fe(n)?8:16),so>0&&!o&&Zn&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&Zn.push(l),l}const _t=cy;function cy(t,e=null,n=null,i=0,r=null,s=!1){if((!t||t===Zd)&&(t=Kt),pl(t)){const a=Bi(t,e,!0);return n&&ml(a,n),a}if(by(t)&&(t=t.__vccOpts),e){e=uy(e);let{class:a,style:l}=e;a&&!Fe(a)&&(e.class=La(a)),xe(l)&&(Cd(l)&&!ne(l)&&(l=Je({},l)),e.style=Ma(l))}const o=Fe(t)?1:Nv(t)?128:sy(t)?64:xe(t)?4:re(t)?2:0;return sh(t,e,n,i,r,o,s,!0)}function uy(t){return t?Cd(t)||oo in t?Je({},t):t:null}function Bi(t,e,n=!1){const{props:i,ref:r,patchFlag:s,children:o}=t,a=e?hy(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&rh(a),ref:e&&e.ref?n&&r?ne(r)?r.concat(ao(e)):[r,ao(e)]:ao(e):r,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Gt?s===-1?16:s|16:s,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Bi(t.ssContent),ssFallback:t.ssFallback&&Bi(t.ssFallback),el:t.el,anchor:t.anchor}}function dy(t=" ",e=0){return _t(hl,null,t,e)}function kN(t="",e=!1){return e?(oy(),ly(Kt,null,t)):_t(Kt,null,t)}function Yt(t){return t==null||typeof t=="boolean"?_t(Kt):ne(t)?_t(Gt,null,t.slice()):typeof t=="object"?Sn(t):_t(hl,null,String(t))}function Sn(t){return t.el===null||t.memo?t:Bi(t)}function ml(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(ne(e))n=16;else if(typeof e=="object")if(i&(1|64)){const r=e.default;r&&(r._c&&(r._d=!1),ml(t,r()),r._c&&(r._d=!0));return}else{n=32;const r=e._;!r&&!(oo in e)?e._ctx=bt:r===3&&bt&&(bt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else re(e)?(e={default:e,_ctx:bt},n=32):(e=String(e),i&64?(n=16,e=[dy(e)]):n=8);t.children=e,t.shapeFlag|=n}function hy(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const r in i)if(r==="class")e.class!==i.class&&(e.class=La([e.class,i.class]));else if(r==="style")e.style=Ma([e.style,i.style]);else if(Us(r)){const s=e[r],o=i[r];s!==o&&(e[r]=s?[].concat(s,o):o)}else r!==""&&(e[r]=i[r])}return e}function NN(t,e,n,i){let r;const s=n&&n[i];if(ne(t)||Fe(t)){r=new Array(t.length);for(let o=0,a=t.length;o<a;o++)r[o]=e(t[o],o,void 0,s&&s[o])}else if(typeof t=="number"){r=new Array(t);for(let o=0;o<t;o++)r[o]=e(o+1,o,void 0,s&&s[o])}else if(xe(t))if(t[Symbol.iterator])r=Array.from(t,(o,a)=>e(o,a,void 0,s&&s[a]));else{const o=Object.keys(t);r=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];r[a]=e(t[c],c,a,s&&s[a])}}else r=[];return n&&(n[i]=r),r}const gl=t=>t?ah(t)?_l(t)||t.proxy:gl(t.parent):null,lo=Je(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>gl(t.parent),$root:t=>gl(t.root),$emit:t=>t.emit,$options:t=>Wd(t),$forceUpdate:t=>()=>gh(t.update),$nextTick:t=>zi.bind(t.proxy),$watch:t=>xy.bind(t)}),fy={get({_:t},e){const{ctx:n,setupState:i,data:r,props:s,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 0:return i[e];case 1:return r[e];case 3:return n[e];case 2:return s[e]}else{if(i!==Ie&&ge(i,e))return o[e]=0,i[e];if(r!==Ie&&ge(r,e))return o[e]=1,r[e];if((c=t.propsOptions[0])&&ge(c,e))return o[e]=2,s[e];if(n!==Ie&&ge(n,e))return o[e]=3,n[e];sl&&(o[e]=4)}}const u=lo[e];let d,h;if(u)return e==="$attrs"&&gt(t,"get",e),u(t);if((d=a.__cssModules)&&(d=d[e]))return d;if(n!==Ie&&ge(n,e))return o[e]=3,n[e];if(h=l.config.globalProperties,ge(h,e))return h[e]},set({_:t},e,n){const{data:i,setupState:r,ctx:s}=t;if(r!==Ie&&ge(r,e))r[e]=n;else if(i!==Ie&&ge(i,e))i[e]=n;else if(ge(t.props,e))return!1;return e[0]==="$"&&e.slice(1)in t?!1:(s[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:r,propsOptions:s}},o){let a;return n[o]!==void 0||t!==Ie&&ge(t,o)||e!==Ie&&ge(e,o)||(a=s[0])&&ge(a,o)||ge(i,o)||ge(lo,o)||ge(r.config.globalProperties,o)}},py=Jd();let my=0;function gy(t,e,n){const i=t.type,r=(e?e.appContext:t.appContext)||py,s={uid:my++,vnode:t,type:i,parent:e,appContext:r,root:null,next:null,subTree:null,update:null,scope:new H_(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:$d(i,r),emitsOptions:kd(i,r),emit:null,emitted:null,propsDefaults:Ie,inheritAttrs:i.inheritAttrs,ctx:Ie,data:Ie,props:Ie,attrs:Ie,slots:Ie,refs:Ie,setupState:Ie,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=Cv.bind(null,s),t.ce&&t.ce(s),s}let je=null;const oh=()=>je||bt,ji=t=>{je=t,t.scope.on()},ti=()=>{je&&je.scope.off(),je=null};function ah(t){return t.vnode.shapeFlag&4}let co=!1;function _y(t,e=!1){co=e;const{props:n,children:i}=t.vnode,r=ah(t);Yv(t,n,r,e),Xv(t,i);const s=r?vy(t,e):void 0;return co=!1,s}function vy(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=Ja(new Proxy(t.ctx,fy));const{setup:i}=n;if(i){const r=t.setupContext=i.length>1?wy(t):null;ji(t),Qn();const s=dn(i,t,0,[t.props,r]);if(In(),ti(),id(s)){if(s.then(ti,ti),e)return s.then(o=>{lh(t,o,e)}).catch(o=>{uo(o,t,0)});t.asyncDep=s}else lh(t,s,e)}else uh(t,e)}function lh(t,e,n){re(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:xe(e)&&(t.setupState=Ad(e)),uh(t,n)}let ch;function uh(t,e,n){const i=t.type;if(!t.render){if(!e&&ch&&!i.render){const r=i.template;if(r){const{isCustomElement:s,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=i,c=Je(Je({isCustomElement:s,delimiters:a},o),l);i.render=ch(r,c)}}t.render=i.render||xt}ji(t),Qn(),Hv(t),In(),ti()}function yy(t){return new Proxy(t.attrs,{get(e,n){return gt(t,"get","$attrs"),e[n]}})}function wy(t){const e=i=>{t.exposed=i||{}};let n;return{get attrs(){return n||(n=yy(t))},slots:t.slots,emit:t.emit,expose:e}}function _l(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Ad(Ja(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in lo)return lo[n](t)}}))}const Ey=/(?:^|[-_])(\w)/g,Iy=t=>t.replace(Ey,e=>e.toUpperCase()).replace(/[-_]/g,"");function dh(t){return re(t)&&t.displayName||t.name}function hh(t,e,n=!1){let i=dh(e);if(!i&&e.__file){const r=e.__file.match(/([^/\\]+)\.\w+$/);r&&(i=r[1])}if(!i&&t&&t.parent){const r=s=>{for(const o in s)if(s[o]===e)return o};i=r(t.components||t.parent.type.components)||r(t.appContext.components)}return i?Iy(i):n?"App":"Anonymous"}function by(t){return re(t)&&"__vccOpts"in t}const Mr=[];function fh(t,...e){Qn();const n=Mr.length?Mr[Mr.length-1].component:null,i=n&&n.appContext.config.warnHandler,r=Cy();if(i)dn(i,n,11,[t+e.join(""),n&&n.proxy,r.map(({vnode:s})=>`at <${hh(n,s.type)}>`).join(`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hf=function(t){let e={},n={},i={},r="";try{const s=t.split(".");e=Br(Ol(s[0])||""),n=Br(Ol(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch(s){}return{header:e,claims:n,data:i,signature:r}},Ww=function(t){const e=hf(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Bw=function(t){const e=hf(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zw=function(t){const e=[];let n=0;for(let i=0;i<t.length;i++){let r=t.charCodeAt(i);if(r>=55296&&r<=56319){const s=r-55296;i++,k(i<t.length,"Surrogate pair missing trail surrogate.");const o=t.charCodeAt(i)-56320;r=65536+(s<<10)+o}r<128?e[n++]=r:r<2048?(e[n++]=r>>6|192,e[n++]=r&63|128):r<65536?(e[n++]=r>>12|224,e[n++]=r>>6&63|128,e[n++]=r&63|128):(e[n++]=r>>18|240,e[n++]=r>>12&63|128,e[n++]=r>>6&63|128,e[n++]=r&63|128)}return e},yo=function(t){let e=0;for(let n=0;n<t.length;n++){const i=t.charCodeAt(n);i<128?e++:i<2048?e+=2:i>=55296&&i<=56319?(e+=4,n++):e+=3}return e};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var _f=function(){function t(e,n){this.name=e,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}return t.prototype.get=function(e){var n=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(n)){var i=new ut;if(this.instancesDeferred.set(n,i),this.isInitialized(n)||this.shouldAutoInitialize())try{var r=this.getOrInitializeService({instanceIdentifier:n});r&&i.resolve(r)}catch(s){}}return this.instancesDeferred.get(n).promise},t.prototype.getImmediate=function(e){var n,i=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),r=(n=e==null?void 0:e.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(i)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:i})}catch(s){if(r)return null;throw s}else{if(r)return null;throw Error("Service "+this.name+" is not available")}},t.prototype.getComponent=function(){return this.component},t.prototype.setComponent=function(e){var n,i;if(e.name!==this.name)throw Error("Mismatching Component "+e.name+" for Provider "+this.name+".");if(this.component)throw Error("Component for "+this.name+" has already been provided");if(this.component=e,!!this.shouldAutoInitialize()){if(Yw(e))try{this.getOrInitializeService({instanceIdentifier:ci})}catch(d){}try{for(var r=Ul(this.instancesDeferred.entries()),s=r.next();!s.done;s=r.next()){var o=wo(s.value,2),a=o[0],l=o[1],c=this.normalizeInstanceIdentifier(a);try{var u=this.getOrInitializeService({instanceIdentifier:c});l.resolve(u)}catch(d){}}}catch(d){n={error:d}}finally{try{s&&!s.done&&(i=r.return)&&i.call(r)}finally{if(n)throw n.error}}}},t.prototype.clearInstance=function(e){e===void 0&&(e=ci),this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)},t.prototype.delete=function(){return qw(this,void 0,void 0,function(){var e;return Gw(this,function(n){switch(n.label){case 0:return e=Array.from(this.instances.values()),[4,Promise.all(gf(gf([],wo(e.filter(function(i){return"INTERNAL"in i}).map(function(i){return i.INTERNAL.delete()}))),wo(e.filter(function(i){return"_delete"in i}).map(function(i){return i._delete()}))))];case 1:return n.sent(),[2]}})})},t.prototype.isComponentSet=function(){return this.component!=null},t.prototype.isInitialized=function(e){return e===void 0&&(e=ci),this.instances.has(e)},t.prototype.getOptions=function(e){return e===void 0&&(e=ci),this.instancesOptions.get(e)||{}},t.prototype.initialize=function(e){var n,i;e===void 0&&(e={});var r=e.options,s=r===void 0?{}:r,o=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(o))throw Error(this.name+"("+o+") has already been initialized");if(!this.isComponentSet())throw Error("Component "+this.name+" has not been registered yet");var a=this.getOrInitializeService({instanceIdentifier:o,options:s});try{for(var l=Ul(this.instancesDeferred.entries()),c=l.next();!c.done;c=l.next()){var u=wo(c.value,2),d=u[0],h=u[1],p=this.normalizeInstanceIdentifier(d);o===p&&h.resolve(a)}}catch(g){n={error:g}}finally{try{c&&!c.done&&(i=l.return)&&i.call(l)}finally{if(n)throw n.error}}return a},t.prototype.onInit=function(e,n){var i,r=this.normalizeInstanceIdentifier(n),s=(i=this.onInitCallbacks.get(r))!==null&&i!==void 0?i:new Set;s.add(e),this.onInitCallbacks.set(r,s);var o=this.instances.get(r);return o&&e(o,r),function(){s.delete(e)}},t.prototype.invokeOnInitCallbacks=function(e,n){var i,r,s=this.onInitCallbacks.get(n);if(!!s)try{for(var o=Ul(s),a=o.next();!a.done;a=o.next()){var l=a.value;try{l(e,n)}catch(c){}}}catch(c){i={error:c}}finally{try{a&&!a.done&&(r=o.return)&&r.call(o)}finally{if(i)throw i.error}}},t.prototype.getOrInitializeService=function(e){var n=e.instanceIdentifier,i=e.options,r=i===void 0?{}:i,s=this.instances.get(n);if(!s&&this.component&&(s=this.component.instanceFactory(this.container,{instanceIdentifier:Kw(n),options:r}),this.instances.set(n,s),this.instancesOptions.set(n,r),this.invokeOnInitCallbacks(s,n),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,n,s)}catch(o){}return s||null},t.prototype.normalizeInstanceIdentifier=function(e){return e===void 0&&(e=ci),this.component?this.component.multipleInstances?e:ci:e},t.prototype.shouldAutoInitialize=function(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"},t}();function Kw(t){return t===ci?void 0:t}function Yw(t){return t.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vl=[];var we;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(we||(we={}));const yf={debug:we.DEBUG,verbose:we.VERBOSE,info:we.INFO,warn:we.WARN,error:we.ERROR,silent:we.SILENT},Qw=we.INFO,Jw={[we.DEBUG]:"log",[we.VERBOSE]:"log",[we.INFO]:"info",[we.WARN]:"warn",[we.ERROR]:"error"},Xw=(t,e,...n)=>{if(e<t.logLevel)return;const i=new Date().toISOString(),r=Jw[e];if(r)console[r](`[${i}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class $r{constructor(e){this.name=e,this._logLevel=Qw,this._logHandler=Xw,this._userLogHandler=null,Vl.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in we))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?yf[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,we.DEBUG,...e),this._logHandler(this,we.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,we.VERBOSE,...e),this._logHandler(this,we.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,we.INFO,...e),this._logHandler(this,we.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,we.WARN,...e),this._logHandler(this,we.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,we.ERROR,...e),this._logHandler(this,we.ERROR,...e)}}function Zw(t){Vl.forEach(e=>{e.setLogLevel(t)})}function eE(t,e){for(const n of Vl){let i=null;e&&e.level&&(i=yf[e.level]),t===null?n.userLogHandler=null:n.userLogHandler=(r,s,...o)=>{const a=o.map(l=>{if(l==null)return null;if(typeof l=="string")return l;if(typeof l=="number"||typeof l=="boolean")return l.toString();if(l instanceof Error)return l.message;try{return JSON.stringify(l)}catch(c){return null}}).filter(l=>l).join(" ");s>=(i!=null?i:r.logLevel)&&t({level:we[s].toLowerCase(),message:a,args:o,type:r.name})}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wl=new $r("@firebase/app"),rE="@firebase/app-compat",sE="@firebase/analytics-compat",oE="@firebase/analytics",aE="@firebase/app-check-compat",lE="@firebase/app-check",cE="@firebase/auth",uE="@firebase/auth-compat",dE="@firebase/database",hE="@firebase/database-compat",fE="@firebase/functions",pE="@firebase/functions-compat",mE="@firebase/installations",gE="@firebase/installations-compat",_E="@firebase/messaging",vE="@firebase/messaging-compat",yE="@firebase/performance",wE="@firebase/performance-compat",EE="@firebase/remote-config",IE="@firebase/remote-config-compat",bE="@firebase/storage",CE="@firebase/storage-compat",TE="@firebase/firestore",SE="@firebase/firestore-compat",RE="firebase",AE="9.1.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nn=new Map,Hr=new Map;function Eo(t,e){try{t.container.addComponent(e)}catch(n){Wl.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Ef(t,e){t.container.addOrOverwriteComponent(e)}function di(t){const e=t.name;if(Hr.has(e))return Wl.debug(`There were multiple attempts to register component ${e}.`),!1;Hr.set(e,t);for(const n of Nn.values())Eo(n,t);return!0}function If(t,e){return t.container.getProvider(e)}function NE(t,e,n=ui){If(t,e).clearInstance(n)}function PE(){Hr.clear()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DE(t){di(new Qt("platform-logger",e=>new tE(e),"PRIVATE")),fi(wf,iE,t),fi("fire-js","")}DE();var FE=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",SDK_VERSION:hi,_DEFAULT_ENTRY_NAME:ui,_addComponent:Eo,_addOrOverwriteComponent:Ef,_apps:Nn,_clearComponents:PE,_components:Hr,_getProvider:If,_registerComponent:di,_removeServiceInstance:NE,deleteApp:Cf,getApp:ME,getApps:LE,initializeApp:bf,onLog:Tf,registerVersion:fi,setLogLevel:Sf,FirebaseError:St});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UE{constructor(e,n){this._delegate=e,this.firebase=n,Eo(e,new Qt("app-compat",()=>this,"PUBLIC")),this.container=e.container}get automaticDataCollectionEnabled(){return this._delegate.automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this._delegate.automaticDataCollectionEnabled=e}get name(){return this._delegate.name}get options(){return this._delegate.options}delete(){return new Promise(e=>{this._delegate.checkDestroyed(),e()}).then(()=>(this.firebase.INTERNAL.removeApp(this.name),Cf(this._delegate)))}_getService(e,n=ui){var i;this._delegate.checkDestroyed();const r=this._delegate.container.getProvider(e);return!r.isInitialized()&&((i=r.getComponent())===null||i===void 0?void 0:i.instantiationMode)==="EXPLICIT"&&r.initialize(),r.getImmediate({identifier:n})}_removeServiceInstance(e,n=ui){this._delegate.container.getProvider(e).clearInstance(n)}_addComponent(e){Eo(this._delegate,e)}_addOrOverwriteComponent(e){Ef(this._delegate,e)}toJSON(){return{name:this.name,automaticDataCollectionEnabled:this.automaticDataCollectionEnabled,options:this.options}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Of=function(t){try{if(typeof window!="undefined"&&typeof window[t]!="undefined"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new YE(e)}}catch(e){}return new QE},pi=Of("localStorage"),Bl=Of("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zi=new $r("@firebase/database"),xf=function(){let t=1;return function(){return t++}}(),Mf=function(t){const e=zw(t),n=new jw;n.update(e);const i=n.digest();return Pl.encodeByteArray(i)},Gr=function(...t){let e="";for(let n=0;n<t.length;n++){const i=t[n];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=Gr.apply(null,i):typeof i=="object"?e+=Ue(i):e+=i,e+=" "}return e};let mi=null,Lf=!0;const Df=function(t,e){k(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(Zi.logLevel=we.VERBOSE,mi=Zi.log.bind(Zi),e&&Bl.set("logging_enabled",!0)):typeof t=="function"?mi=t:(mi=null,Bl.remove("logging_enabled"))},He=function(...t){if(Lf===!0&&(Lf=!1,mi===null&&Bl.get("logging_enabled")===!0&&Df(!0)),mi){const e=Gr.apply(null,t);mi(e)}},Kr=function(t){return function(...e){He(t,...e)}},jl=function(...t){const e="FIREBASE INTERNAL ERROR: "+Gr(...t);Zi.error(e)},Jt=function(...t){const e=`FIREBASE FATAL ERROR: ${Gr(...t)}`;throw Zi.error(e),new Error(e)},ot=function(...t){const e="FIREBASE WARNING: "+Gr(...t);Zi.warn(e)},JE=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&ot("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Io=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},XE=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},fn="[MIN_NAME]",Xt="[MAX_NAME]",gi=function(t,e){if(t===e)return 0;if(t===fn||e===Xt)return-1;if(e===fn||t===Xt)return 1;{const n=bo(t),i=bo(e);return n!==null?i!==null?n-i==0?t.length-e.length:n-i:-1:i!==null?1:t<e?-1:1}},ZE=function(t,e){return t===e?0:t<e?-1:1},Yr=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+Ue(e))},$l=function(t){if(typeof t!="object"||t===null)return Ue(t);const e=[];for(const i in t)e.push(i);e.sort();let n="{";for(let i=0;i<e.length;i++)i!==0&&(n+=","),n+=Ue(e[i]),n+=":",n+=$l(t[e[i]]);return n+="}",n},Ff=function(t,e){const n=t.length;if(n<=e)return[t];const i=[];for(let r=0;r<n;r+=e)r+e>n?i.push(t.substring(r,n)):i.push(t.substring(r,r+e));return i};function ze(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const Uf=function(t){k(!Io(t),"Invalid JSON number");const e=11,n=52,i=(1<<e-1)-1;let r,s,o,a,l;t===0?(s=0,o=0,r=1/t==-1/0?1:0):(r=t<0,t=Math.abs(t),t>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),i),s=a+i,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(s=0,o=Math.round(t/Math.pow(2,1-i-n))));const c=[];for(l=n;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(s%2?1:0),s=Math.floor(s/2);c.push(r?1:0),c.reverse();const u=c.join("");let d="";for(l=0;l<64;l+=8){let h=parseInt(u.substr(l,8),2).toString(16);h.length===1&&(h="0"+h),d=d+h}return d.toLowerCase()},eI=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},tI=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function nI(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const i=new Error(t+" at "+e._path.toString()+": "+n);return i.code=t.toUpperCase(),i}const iI=new RegExp("^-?(0*)\\d{1,10}$"),Vf=-2147483648,Hl=2147483647,bo=function(t){if(iI.test(t)){const e=Number(t);if(e>=Vf&&e<=Hl)return e}return null},er=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw ot("Exception was thrown by user callback.",n),e},Math.floor(0))}},rI=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Qr=function(t,e){const n=setTimeout(t,e);return typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl="5",Wf="v",Bf="s",jf="r",$f="f",Hf=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,zf="ls",aI="p",ql="ac",qf="websocket",Gf="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gl={},Kl={};function Yl(t){const e=t.toString();return Gl[e]||(Gl[e]=new cI),Gl[e]}function uI(t,e){const n=t.toString();return Kl[n]||(Kl[n]=e()),Kl[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jl{constructor(e){this.initTransports_(e)}static get ALL_TRANSPORTS(){return[nr,Dt]}initTransports_(e){const n=Dt&&Dt.isAvailable();let i=n&&!Dt.previouslyFailed();if(e.webSocketOnly&&(n||ot("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),i=!0),i)this.transports_=[Dt];else{const r=this.transports_=[];for(const s of Jl.ALL_TRANSPORTS)s&&s.isAvailable()&&r.push(s)}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class To extends cp{constructor(){super(["online"]);this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!xl()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new To}getInitialEvent(e){return k(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const up=32,dp=768;class ve{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let i=0;for(let r=0;r<this.pieces_.length;r++)this.pieces_[r].length>0&&(this.pieces_[i]=this.pieces_[r],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function _e(){return new ve("")}function se(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function Pn(t){return t.pieces_.length-t.pieceNum_}function be(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new ve(t.pieces_,e)}function Zl(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function xI(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function Jr(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function hp(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new ve(e,0)}function Pe(t,e){const n=[];for(let i=t.pieceNum_;i<t.pieces_.length;i++)n.push(t.pieces_[i]);if(e instanceof ve)for(let i=e.pieceNum_;i<e.pieces_.length;i++)n.push(e.pieces_[i]);else{const i=e.split("/");for(let r=0;r<i.length;r++)i[r].length>0&&n.push(i[r])}return new ve(n,0)}function oe(t){return t.pieceNum_>=t.pieces_.length}function at(t,e){const n=se(t),i=se(e);if(n===null)return e;if(n===i)return at(be(t),be(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function MI(t,e){const n=Jr(t,0),i=Jr(e,0);for(let r=0;r<n.length&&r<i.length;r++){const s=gi(n[r],i[r]);if(s!==0)return s}return n.length===i.length?0:n.length<i.length?-1:1}function ec(t,e){if(Pn(t)!==Pn(e))return!1;for(let n=t.pieceNum_,i=e.pieceNum_;n<=t.pieces_.length;n++,i++)if(t.pieces_[n]!==e.pieces_[i])return!1;return!0}function Rt(t,e){let n=t.pieceNum_,i=e.pieceNum_;if(Pn(t)>Pn(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[i])return!1;++n,++i}return!0}class LI{constructor(e,n){this.errorPrefix_=n,this.parts_=Jr(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=yo(this.parts_[i]);fp(this)}}function DI(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=yo(e),fp(t)}function FI(t){const e=t.parts_.pop();t.byteLength_-=yo(e),t.parts_.length>0&&(t.byteLength_-=1)}function fp(t){if(t.byteLength_>dp)throw new Error(t.errorPrefix_+"has a key path longer than "+dp+" bytes ("+t.byteLength_+").");if(t.parts_.length>up)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+up+") or object contains a cycle "+_i(t))}function _i(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class So{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const i=new ae(fn,e),r=new ae(fn,n);return this.compare(i,r)!==0}minPost(){return ae.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ro;class gp extends So{static get __EMPTY_NODE(){return Ro}static set __EMPTY_NODE(e){Ro=e}compare(e,n){return gi(e.name,n.name)}isDefinedOn(e){throw Ji("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return ae.MIN}maxPost(){return new ae(Xt,Ro)}makePost(e,n){return k(typeof e=="string","KeyIndex indexValue must always be a string."),new ae(e,Ro)}toString(){return".key"}}const Zt=new gp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function HI(t,e){return gi(t.name,e.name)}function nc(t,e){return gi(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ic;function zI(t){ic=t}const _p=function(t){return typeof t=="number"?"number:"+Uf(t):"string:"+t},vp=function(t){if(t.isLeafNode()){const e=t.val();k(typeof e=="string"||typeof e=="number"||typeof e=="object"&&yt(e,".sv"),"Priority must be a string or number.")}else k(t===ic||t.isEmpty(),"priority of unexpected type.");k(t===ic||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rc;const ir={};class mn{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return k(ir&&Te,"ChildrenNode.ts has not been loaded"),rc=rc||new mn({".priority":ir},{".priority":Te}),rc}get(e){const n=ai(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof ht?n:null}hasIndex(e){return yt(this.indexSet_,e.toString())}addIndex(e,n){k(e!==Zt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let r=!1;const s=n.getIterator(ae.Wrap);let o=s.getNext();for(;o;)r=r||e.isDefinedOn(o.node),i.push(o),o=s.getNext();let a;r?a=ko(i,e.getCompare()):a=ir;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const u=Object.assign({},this.indexes_);return u[l]=a,new mn(u,c)}addToIndexes(e,n){const i=vo(this.indexes_,(r,s)=>{const o=ai(this.indexSet_,s);if(k(o,"Missing index implementation for "+s),r===ir)if(o.isDefinedOn(e.node)){const a=[],l=n.getIterator(ae.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),ko(a,o.getCompare())}else return ir;else{const a=n.get(e.name);let l=r;return a&&(l=l.remove(new ae(e.name,a))),l.insert(e,e.node)}});return new mn(i,this.indexSet_)}removeFromIndexes(e,n){const i=vo(this.indexes_,r=>{if(r===ir)return r;{const s=n.get(e.name);return s?r.remove(new ae(e.name,s)):r}});return new mn(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZI extends So{compare(e,n){const i=e.node.compareTo(n.node);return i===0?gi(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return ae.MIN}maxPost(){return ae.MAX}makePost(e,n){const i=Oe(e);return new ae(n,i)}toString(){return".value"}}const oc=new ZI;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",ac="-",Ip="z",bp=786,eb=function(){let t=0;const e=[];return function(n){const i=n===t;t=n;let r;const s=new Array(8);for(r=7;r>=0;r--)s[r]=rr.charAt(n%64),n=Math.floor(n/64);k(n===0,"Cannot push at time == 0");let o=s.join("");if(i){for(r=11;r>=0&&e[r]===63;r--)e[r]=0;e[r]++}else for(r=0;r<12;r++)e[r]=Math.floor(Math.random()*64);for(r=0;r<12;r++)o+=rr.charAt(e[r]);return k(o.length===20,"nextPushId: Length should be 20."),o}}(),Cp=function(t){if(t===""+Hl)return ac;const e=bo(t);if(e!=null)return""+(e+1);const n=new Array(t.length);for(let o=0;o<n.length;o++)n[o]=t.charAt(o);if(n.length<bp)return n.push(ac),n.join("");let i=n.length-1;for(;i>=0&&n[i]===Ip;)i--;if(i===-1)return Xt;const r=n[i],s=rr.charAt(rr.indexOf(r)+1);return n[i]=s,n.slice(0,i+1).join("")},Tp=function(t){if(t===""+Vf)return fn;const e=bo(t);if(e!=null)return""+(e-1);const n=new Array(t.length);for(let i=0;i<n.length;i++)n[i]=t.charAt(i);return n[n.length-1]===ac?n.length===1?""+Hl:(delete n[n.length-1],n.join("")):(n[n.length-1]=rr.charAt(rr.indexOf(n[n.length-1])-1),n.join("")+Ip.repeat(bp-n.length))};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oo extends lp{constructor(e,n,i,r){super();this.repoInfo_=e,this.onDataUpdate_=n,this.authTokenProvider_=i,this.appCheckTokenProvider_=r,this.log_=Kr("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,n){return n!==void 0?"tag$"+n:(k(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,n,i,r){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const o=Oo.getListenId_(e,i),a={};this.listens_[o]=a;const l=Rp(e._queryParams);this.restRequest_(s+".json",l,(c,u)=>{let d=u;if(c===404&&(d=null,c=null),c===null&&this.onDataUpdate_(s,d,!1,i),ai(this.listens_,o)===a){let h;c?c===401?h="permission_denied":h="rest_error:"+c:h="ok",r(h,null)}})}unlisten(e,n){const i=Oo.getListenId_(e,n);delete this.listens_[i]}get(e){const n=Rp(e._queryParams),i=e._path.toString(),r=new ut;return this.restRequest_(i+".json",n,(s,o)=>{let a=o;s===404&&(a=null,s=null),s===null?(this.onDataUpdate_(i,a,!1,null),r.resolve(a)):r.reject(new Error(a))}),r.promise}refreshAuthToken(e){}restRequest_(e,n={},i){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([r,s])=>{r&&r.accessToken&&(n.auth=r.accessToken),s&&s.token&&(n.ac=s.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+li(n);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Br(a.responseText)}catch(c){ot("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&ot("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xo(){return{value:null,children:new Map}}function or(t,e,n){if(oe(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const i=se(e);t.children.has(i)||t.children.set(i,xo());const r=t.children.get(i);e=be(e),or(r,e,n)}}function dc(t,e){if(oe(e))return t.value=null,t.children.clear(),!0;if(t.value!==null){if(t.value.isLeafNode())return!1;{const n=t.value;return t.value=null,n.forEachChild(Te,(i,r)=>{or(t,new ve(i),r)}),dc(t,e)}}else if(t.children.size>0){const n=se(e);return e=be(e),t.children.has(n)&&dc(t.children.get(n),e)&&t.children.delete(n),t.children.size===0}else return!0}function hc(t,e,n){t.value!==null?n(e,t.value):cb(t,(i,r)=>{const s=new ve(e.toString()+"/"+i);hc(r,s,n)})}function cb(t,e){t.children.forEach((n,i)=>{e(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ft;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Ft||(Ft={}));function fc(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function pc(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function mc(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mo{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=Ft.ACK_USER_WRITE,this.source=fc()}operationForChild(e){if(oe(this.path)){if(this.affectedTree.value!=null)return k(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new ve(e));return new Mo(_e(),n,this.revert)}}else return k(se(this.path)===e,"operationForChild called for unrelated child."),new Mo(be(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lo(t,e){return{eventCache:t,serverCache:e}}function os(t,e,n,i){return Lo(new On(e,n,i),t.serverCache)}function Np(t,e,n,i){return Lo(t.eventCache,new On(e,n,i))}function Do(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function yi(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fo(t,e){return Up(e,t)}function yb(t,e,n,i,r){k(i>t.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:r}),r&&(t.visibleWrites=as(t.visibleWrites,e,n)),t.lastWriteId=i}function wb(t,e,n,i){k(i>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:i,visible:!0}),t.visibleWrites=_c(t.visibleWrites,e,n),t.lastWriteId=i}function Eb(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function Ib(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);k(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let r=i.visible,s=!1,o=t.allWrites.length-1;for(;r&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&bb(a,i.path)?r=!1:Rt(i.path,a.path)&&(s=!0)),o--}if(r){if(s)return Cb(t),!0;if(i.snap)t.visibleWrites=Pp(t.visibleWrites,i.path);else{const a=i.children;ze(a,l=>{t.visibleWrites=Pp(t.visibleWrites,Pe(i.path,l))})}return!0}else return!1}function bb(t,e){if(t.snap)return Rt(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Rt(Pe(t.path,n),e))return!0;return!1}function Cb(t){t.visibleWrites=Mp(t.allWrites,Tb,_e()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function Tb(t){return t.visible}function Mp(t,e,n){let i=Ut.empty();for(let r=0;r<t.length;++r){const s=t[r];if(e(s)){const o=s.path;let a;if(s.snap)Rt(n,o)?(a=at(n,o),i=as(i,a,s.snap)):Rt(o,n)&&(a=at(o,n),i=as(i,_e(),s.snap.getChild(a)));else if(s.children){if(Rt(n,o))a=at(n,o),i=_c(i,a,s.children);else if(Rt(o,n))if(a=at(o,n),oe(a))i=_c(i,_e(),s.children);else{const l=ai(s.children,se(a));if(l){const c=l.getChild(be(a));i=as(i,_e(),c)}}}else throw Ji("WriteRecord should have .snap or .children")}}return i}function Lp(t,e,n,i,r){if(!i&&!r){const s=wi(t.visibleWrites,e);if(s!=null)return s;{const o=xn(t.visibleWrites,e);if(yc(o))return n;if(n==null&&!vc(o,_e()))return null;{const a=n||Q.EMPTY_NODE;return lr(o,a)}}}else{const s=xn(t.visibleWrites,e);if(!r&&yc(s))return n;if(!r&&n==null&&!vc(s,_e()))return null;{const o=function(c){return(c.visible||r)&&(!i||!~i.indexOf(c.writeId))&&(Rt(c.path,e)||Rt(e,c.path))},a=Mp(t.allWrites,o,e),l=n||Q.EMPTY_NODE;return lr(a,l)}}}function Sb(t,e,n){let i=Q.EMPTY_NODE;const r=wi(t.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(Te,(s,o)=>{i=i.updateImmediateChild(s,o)}),i;if(n){const s=xn(t.visibleWrites,e);return n.forEachChild(Te,(o,a)=>{const l=lr(xn(s,new ve(o)),a);i=i.updateImmediateChild(o,l)}),Op(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const s=xn(t.visibleWrites,e);return Op(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Rb(t,e,n,i,r){k(i||r,"Either existingEventSnap or existingServerSnap must exist");const s=Pe(e,n);if(vc(t.visibleWrites,s))return null;{const o=xn(t.visibleWrites,s);return yc(o)?r.getChild(n):lr(o,r.getChild(n))}}function Ab(t,e,n,i){const r=Pe(e,n),s=wi(t.visibleWrites,r);if(s!=null)return s;if(i.isCompleteForChild(n)){const o=xn(t.visibleWrites,r);return lr(o,i.getNode().getImmediateChild(n))}else return null}function kb(t,e){return wi(t.visibleWrites,e)}function Nb(t,e,n,i,r,s,o){let a;const l=xn(t.visibleWrites,e),c=wi(l,_e());if(c!=null)a=c;else if(n!=null)a=lr(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],d=o.getCompare(),h=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let p=h.getNext();for(;p&&u.length<r;)d(p,i)!==0&&u.push(p),p=h.getNext();return u}else return[]}function Pb(){return{visibleWrites:Ut.empty(),allWrites:[],lastWriteId:-1}}function Uo(t,e,n,i){return Lp(t.writeTree,t.treePath,e,n,i)}function wc(t,e){return Sb(t.writeTree,t.treePath,e)}function Dp(t,e,n,i){return Rb(t.writeTree,t.treePath,e,n,i)}function Vo(t,e){return kb(t.writeTree,Pe(t.treePath,e))}function Ob(t,e,n,i,r,s){return Nb(t.writeTree,t.treePath,e,n,i,r,s)}function Ec(t,e,n){return Ab(t.writeTree,t.treePath,e,n)}function Fp(t,e){return Up(Pe(t.treePath,e),t.writeTree)}function Up(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mb{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const Vp=new Mb;class Ic{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new On(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ec(this.writes_,e,i)}}getChildAfterChild(e,n,i){const r=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:yi(this.viewCache_),s=Ob(this.writes_,r,n,1,i,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lb(t){return{filter:t}}function Db(t,e){k(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),k(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function Fb(t,e,n,i,r){const s=new xb;let o,a;if(n.type===Ft.OVERWRITE){const c=n;c.source.fromUser?o=bc(t,e,c.path,c.snap,i,r,s):(k(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!oe(c.path),o=Wo(t,e,c.path,c.snap,i,r,a,s))}else if(n.type===Ft.MERGE){const c=n;c.source.fromUser?o=Vb(t,e,c.path,c.children,i,r,s):(k(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Cc(t,e,c.path,c.children,i,r,a,s))}else if(n.type===Ft.ACK_USER_WRITE){const c=n;c.revert?o=jb(t,e,c.path,i,r,s):o=Wb(t,e,c.path,c.affectedTree,i,r,s)}else if(n.type===Ft.LISTEN_COMPLETE)o=Bb(t,e,n.path,i,s);else throw Ji("Unknown operation type: "+n.type);const l=s.getChanges();return Ub(e,o,l),{viewCache:o,changes:l}}function Ub(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const r=i.getNode().isLeafNode()||i.getNode().isEmpty(),s=Do(t);(n.length>0||!t.eventCache.isFullyInitialized()||r&&!i.getNode().equals(s)||!i.getNode().getPriority().equals(s.getPriority()))&&n.push(Sp(Do(e)))}}function Wp(t,e,n,i,r,s){const o=e.eventCache;if(Vo(i,n)!=null)return e;{let a,l;if(oe(n))if(k(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=yi(e),u=c instanceof Q?c:Q.EMPTY_NODE,d=wc(i,u);a=t.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const c=Uo(i,yi(e));a=t.filter.updateFullNode(e.eventCache.getNode(),c,s)}else{const c=se(n);if(c===".priority"){k(Pn(n)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const d=Dp(i,n,u,l);d!=null?a=t.filter.updatePriority(u,d):a=o.getNode()}else{const u=be(n);let d;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const h=Dp(i,n,o.getNode(),l);h!=null?d=o.getNode().getImmediateChild(c).updateChild(u,h):d=o.getNode().getImmediateChild(c)}else d=Ec(i,c,e.serverCache);d!=null?a=t.filter.updateChild(o.getNode(),c,d,u,r,s):a=o.getNode()}}return os(e,a,o.isFullyInitialized()||oe(n),t.filter.filtersNodes())}}function Wo(t,e,n,i,r,s,o,a){const l=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(oe(n))c=u.updateFullNode(l.getNode(),i,null);else if(u.filtersNodes()&&!l.isFiltered()){const p=l.getNode().updateChild(n,i);c=u.updateFullNode(l.getNode(),p,null)}else{const p=se(n);if(!l.isCompleteForPath(n)&&Pn(n)>1)return e;const g=be(n),I=l.getNode().getImmediateChild(p).updateChild(g,i);p===".priority"?c=u.updatePriority(l.getNode(),I):c=u.updateChild(l.getNode(),p,I,g,Vp,null)}const d=Np(e,c,l.isFullyInitialized()||oe(n),u.filtersNodes()),h=new Ic(r,d,s);return Wp(t,d,n,r,h,a)}function bc(t,e,n,i,r,s,o){const a=e.eventCache;let l,c;const u=new Ic(r,e,s);if(oe(n))c=t.filter.updateFullNode(e.eventCache.getNode(),i,o),l=os(e,c,!0,t.filter.filtersNodes());else{const d=se(n);if(d===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),i),l=os(e,c,a.isFullyInitialized(),a.isFiltered());else{const h=be(n),p=a.getNode().getImmediateChild(d);let g;if(oe(h))g=i;else{const R=u.getCompleteChild(d);R!=null?Zl(h)===".priority"&&R.getChild(hp(h)).isEmpty()?g=R:g=R.updateChild(h,i):g=Q.EMPTY_NODE}if(p.equals(g))l=e;else{const R=t.filter.updateChild(a.getNode(),d,g,h,u,o);l=os(e,R,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function Bp(t,e){return t.eventCache.isCompleteForChild(e)}function Vb(t,e,n,i,r,s,o){let a=e;return i.foreach((l,c)=>{const u=Pe(n,l);Bp(e,se(u))&&(a=bc(t,a,u,c,r,s,o))}),i.foreach((l,c)=>{const u=Pe(n,l);Bp(e,se(u))||(a=bc(t,a,u,c,r,s,o))}),a}function jp(t,e,n){return n.foreach((i,r)=>{e=e.updateChild(i,r)}),e}function Cc(t,e,n,i,r,s,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;oe(n)?c=i:c=new Se(null).setTree(n,i);const u=e.serverCache.getNode();return c.children.inorderTraversal((d,h)=>{if(u.hasChild(d)){const p=e.serverCache.getNode().getImmediateChild(d),g=jp(t,p,h);l=Wo(t,l,new ve(d),g,r,s,o,a)}}),c.children.inorderTraversal((d,h)=>{const p=!e.serverCache.isCompleteForChild(d)&&h.value===void 0;if(!u.hasChild(d)&&!p){const g=e.serverCache.getNode().getImmediateChild(d),R=jp(t,g,h);l=Wo(t,l,new ve(d),R,r,s,o,a)}}),l}function Wb(t,e,n,i,r,s,o){if(Vo(r,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(oe(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Wo(t,e,n,l.getNode().getChild(n),r,s,a,o);if(oe(n)){let c=new Se(null);return l.getNode().forEachChild(Zt,(u,d)=>{c=c.set(new ve(u),d)}),Cc(t,e,n,c,r,s,a,o)}else return e}else{let c=new Se(null);return i.foreach((u,d)=>{const h=Pe(n,u);l.isCompleteForPath(h)&&(c=c.set(u,l.getNode().getChild(h)))}),Cc(t,e,n,c,r,s,a,o)}}function Bb(t,e,n,i,r){const s=e.serverCache,o=Np(e,s.getNode(),s.isFullyInitialized()||oe(n),s.isFiltered());return Wp(t,o,n,i,Vp,r)}function jb(t,e,n,i,r,s){let o;if(Vo(i,n)!=null)return e;{const a=new Ic(i,e,r),l=e.eventCache.getNode();let c;if(oe(n)||se(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Uo(i,yi(e));else{const d=e.serverCache.getNode();k(d instanceof Q,"serverChildren would be complete if leaf node"),u=wc(i,d)}u=u,c=t.filter.updateFullNode(l,u,s)}else{const u=se(n);let d=Ec(i,u,e.serverCache);d==null&&e.serverCache.isCompleteForChild(u)&&(d=l.getImmediateChild(u)),d!=null?c=t.filter.updateChild(l,u,d,be(n),a,s):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(l,u,Q.EMPTY_NODE,be(n),a,s):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Uo(i,yi(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,s)))}return o=e.serverCache.isFullyInitialized()||Vo(i,_e())!=null,os(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bo;class Gp{constructor(){this.views=new Map}}function Yb(t){k(!Bo,"__referenceConstructor has already been defined"),Bo=t}function Qb(){return k(Bo,"Reference.ts has not been loaded"),Bo}function Jb(t){return t.views.size===0}function Tc(t,e,n,i){const r=e.source.queryId;if(r!==null){const s=t.views.get(r);return k(s!=null,"SyncTree gave us an op for an invalid query."),zp(s,e,n,i)}else{let s=[];for(const o of t.views.values())s=s.concat(zp(o,e,n,i));return s}}function Kp(t,e,n,i,r){const s=e._queryIdentifier,o=t.views.get(s);if(!o){let a=Uo(n,r?i:null),l=!1;a?l=!0:i instanceof Q?(a=wc(n,i),l=!1):(a=Q.EMPTY_NODE,l=!1);const c=Lo(new On(a,l,!1),new On(i,r,!1));return new $b(e,c)}return o}function Xb(t,e,n,i,r,s){const o=Kp(t,e,i,r,s);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),Gb(o,n),Kb(o,n)}function Zb(t,e,n,i){const r=e._queryIdentifier,s=[];let o=[];const a=Ln(t);if(r==="default")for(const[l,c]of t.views.entries())o=o.concat(Hp(c,n,i)),$p(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||s.push(c.query));else{const l=t.views.get(r);l&&(o=o.concat(Hp(l,n,i)),$p(l)&&(t.views.delete(r),l.query._queryParams.loadsAllData()||s.push(l.query)))}return a&&!Ln(t)&&s.push(new(Qb())(e._repo,e._path)),{removed:s,events:o}}function Yp(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Mn(t,e){let n=null;for(const i of t.views.values())n=n||qb(i,e);return n}function Qp(t,e){if(e._queryParams.loadsAllData())return jo(t);{const i=e._queryIdentifier;return t.views.get(i)}}function Jp(t,e){return Qp(t,e)!=null}function Ln(t){return jo(t)!=null}function jo(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $o;function eC(t){k(!$o,"__referenceConstructor has already been defined"),$o=t}function tC(){return k($o,"Reference.ts has not been loaded"),$o}let nC=1;class Xp{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Se(null),this.pendingWriteTree_=Pb(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Sc(t,e,n,i,r){return yb(t.pendingWriteTree_,e,n,i,r),r?cr(t,new vi(fc(),e,n)):[]}function iC(t,e,n,i){wb(t.pendingWriteTree_,e,n,i);const r=Se.fromObject(n);return cr(t,new ar(fc(),e,r))}function Dn(t,e,n=!1){const i=Eb(t.pendingWriteTree_,e);if(Ib(t.pendingWriteTree_,e)){let s=new Se(null);return i.snap!=null?s=s.set(_e(),!0):ze(i.children,o=>{s=s.set(new ve(o),!0)}),cr(t,new Mo(i.path,s,n))}else return[]}function ls(t,e,n){return cr(t,new vi(pc(),e,n))}function rC(t,e,n){const i=Se.fromObject(n);return cr(t,new ar(pc(),e,i))}function sC(t,e){return cr(t,new rs(pc(),e))}function oC(t,e,n){const i=Ac(t,n);if(i){const r=kc(i),s=r.path,o=r.queryId,a=at(s,e),l=new rs(mc(o),a);return Nc(t,s,l)}else return[]}function Rc(t,e,n,i){const r=e._path,s=t.syncPointTree_.get(r);let o=[];if(s&&(e._queryIdentifier==="default"||Jp(s,e))){const a=Zb(s,e,n,i);Jb(s)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const l=a.removed;o=a.events;const c=l.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=t.syncPointTree_.findOnPath(r,(d,h)=>Ln(h));if(c&&!u){const d=t.syncPointTree_.subtree(r);if(!d.isEmpty()){const h=uC(d);for(let p=0;p<h.length;++p){const g=h[p],R=g.query,I=nm(t,g);t.listenProvider_.startListening(cs(R),zo(t,R),I.hashFn,I.onComplete)}}}if(!u&&l.length>0&&!i)if(c){const d=null;t.listenProvider_.stopListening(cs(e),d)}else l.forEach(d=>{const h=t.queryToTagMap.get(qo(d));t.listenProvider_.stopListening(cs(d),h)});dC(t,l)}return o}function aC(t,e,n,i){const r=Ac(t,i);if(r!=null){const s=kc(r),o=s.path,a=s.queryId,l=at(o,e),c=new vi(mc(a),l,n);return Nc(t,o,c)}else return[]}function lC(t,e,n,i){const r=Ac(t,i);if(r){const s=kc(r),o=s.path,a=s.queryId,l=at(o,e),c=Se.fromObject(n),u=new ar(mc(a),l,c);return Nc(t,o,u)}else return[]}function Zp(t,e,n){const i=e._path;let r=null,s=!1;t.syncPointTree_.foreachOnPath(i,(d,h)=>{const p=at(d,i);r=r||Mn(h,p),s=s||Ln(h)});let o=t.syncPointTree_.get(i);o?(s=s||Ln(o),r=r||Mn(o,_e())):(o=new Gp,t.syncPointTree_=t.syncPointTree_.set(i,o));let a;r!=null?a=!0:(a=!1,r=Q.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((h,p)=>{const g=Mn(p,_e());g&&(r=r.updateImmediateChild(h,g))}));const l=Jp(o,e);if(!l&&!e._queryParams.loadsAllData()){const d=qo(e);k(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const h=hC();t.queryToTagMap.set(d,h),t.tagToQueryMap.set(h,d)}const c=Fo(t.pendingWriteTree_,i);let u=Xb(o,e,n,c,r,a);if(!l&&!s){const d=Qp(o,e);u=u.concat(fC(t,e,d))}return u}function Ho(t,e,n){const i=!0,r=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=at(o,e),c=Mn(a,l);if(c)return c});return Lp(r,e,s,n,i)}function cC(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const d=at(c,n);i=i||Mn(u,d)});let r=t.syncPointTree_.get(n);r?i=i||Mn(r,_e()):(r=new Gp,t.syncPointTree_=t.syncPointTree_.set(n,r));const s=i!=null,o=s?new On(i,!0,!1):null,a=Fo(t.pendingWriteTree_,e._path),l=Kp(r,e,a,s?o.getNode():Q.EMPTY_NODE,s);return zb(l)}function cr(t,e){return em(e,t.syncPointTree_,null,Fo(t.pendingWriteTree_,_e()))}function em(t,e,n,i){if(oe(t.path))return tm(t,e,n,i);{const r=e.get(_e());n==null&&r!=null&&(n=Mn(r,_e()));let s=[];const o=se(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=Fp(i,o);s=s.concat(em(a,l,c,u))}return r&&(s=s.concat(Tc(r,t,i,n))),s}}function tm(t,e,n,i){const r=e.get(_e());n==null&&r!=null&&(n=Mn(r,_e()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=Fp(i,o),u=t.operationForChild(o);u&&(s=s.concat(tm(u,a,l,c)))}),r&&(s=s.concat(Tc(r,t,i,n))),s}function nm(t,e){const n=e.query,i=zo(t,n);return{hashFn:()=>(Hb(e)||Q.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return i?oC(t,n._path,i):sC(t,n._path);{const s=nI(r,n);return Rc(t,n,null,s)}}}}function zo(t,e){const n=qo(e);return t.queryToTagMap.get(n)}function qo(t){return t._path.toString()+"$"+t._queryIdentifier}function Ac(t,e){return t.tagToQueryMap.get(e)}function kc(t){const e=t.indexOf("$");return k(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new ve(t.substr(0,e))}}function Nc(t,e,n){const i=t.syncPointTree_.get(e);k(i,"Missing sync point for query tag that we're tracking");const r=Fo(t.pendingWriteTree_,e);return Tc(i,n,r,null)}function uC(t){return t.fold((e,n,i)=>{if(n&&Ln(n))return[jo(n)];{let r=[];return n&&(r=Yp(n)),ze(i,(s,o)=>{r=r.concat(o)}),r}})}function cs(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(tC())(t._repo,t._path):t}function dC(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const r=qo(i),s=t.queryToTagMap.get(r);t.queryToTagMap.delete(r),t.tagToQueryMap.delete(s)}}}function hC(){return nC++}function fC(t,e,n){const i=e._path,r=zo(t,e),s=nm(t,n),o=t.listenProvider_.startListening(cs(e),r,s.hashFn,s.onComplete),a=t.syncPointTree_.subtree(i);if(r)k(!Ln(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,d)=>{if(!oe(c)&&u&&Ln(u))return[jo(u).query];{let h=[];return u&&(h=h.concat(Yp(u).map(p=>p.query))),ze(d,(p,g)=>{h=h.concat(g)}),h}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(cs(u),zo(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function Go(t,e){let n=e instanceof ve?e:new ve(e),i=t,r=se(n);for(;r!==null;){const s=ai(i.node.children,r)||{children:{},childCount:0};i=new Lc(r,i,s),n=be(n),r=se(n)}return i}function Ei(t){return t.node.value}function Dc(t,e){t.node.value=e,Fc(t)}function sm(t){return t.node.childCount>0}function _C(t){return Ei(t)===void 0&&!sm(t)}function Ko(t,e){ze(t.node.children,(n,i)=>{e(new Lc(n,t,i))})}function om(t,e,n,i){n&&!i&&e(t),Ko(t,r=>{om(r,e,!0,i)}),n&&i&&e(t)}function vC(t,e,n){let i=n?t:t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function us(t){return new ve(t.parent===null?t.name:us(t.parent)+"/"+t.name)}function Fc(t){t.parent!==null&&yC(t.parent,t.name,t)}function yC(t,e,n){const i=_C(n),r=yt(t.node.children,e);i&&r?(delete t.node.children[e],t.node.childCount--,Fc(t)):!i&&!r&&(t.node.children[e]=n.node,t.node.childCount++,Fc(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wC=/[\[\].#$\/\u0000-\u001F\u007F]/,EC=/[\[\].#$\u0000-\u001F\u007F]/,Uc=10*1024*1024,Yo=function(t){return typeof t=="string"&&t.length!==0&&!wC.test(t)},am=function(t){return typeof t=="string"&&t.length!==0&&!EC.test(t)},IC=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),am(t)},ds=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!Io(t)||t&&typeof t=="object"&&yt(t,".sv")},en=function(t,e,n,i){i&&e===void 0||hs(dt(t,"value"),e,n)},hs=function(t,e,n){const i=n instanceof ve?new LI(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+_i(i));if(typeof e=="function")throw new Error(t+"contains a function "+_i(i)+" with contents = "+e.toString());if(Io(e))throw new Error(t+"contains "+e.toString()+" "+_i(i));if(typeof e=="string"&&e.length>Uc/3&&yo(e)>Uc)throw new Error(t+"contains a string greater than "+Uc+" utf8 bytes "+_i(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let r=!1,s=!1;if(ze(e,(o,a)=>{if(o===".value")r=!0;else if(o!==".priority"&&o!==".sv"&&(s=!0,!Yo(o)))throw new Error(t+" contains an invalid key ("+o+") "+_i(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);DI(i,o),hs(t,a,i),FI(i)}),r&&s)throw new Error(t+' contains ".value" child '+_i(i)+" in addition to actual children.")}},bC=function(t,e){let n,i;for(n=0;n<e.length;n++){i=e[n];const s=Jr(i);for(let o=0;o<s.length;o++)if(!(s[o]===".priority"&&o===s.length-1)){if(!Yo(s[o]))throw new Error(t+"contains an invalid key ("+s[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(MI);let r=null;for(n=0;n<e.length;n++){if(i=e[n],r!==null&&Rt(r,i))throw new Error(t+"contains a path "+r.toString()+" that is ancestor of another path "+i.toString());r=i}},lm=function(t,e,n,i){if(i&&e===void 0)return;const r=dt(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(r+" must be an object containing the children to replace.");const s=[];ze(e,(o,a)=>{const l=new ve(o);if(hs(r,a,Pe(n,l)),Zl(l)===".priority"&&!ds(a))throw new Error(r+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(l)}),bC(r,s)},Vc=function(t,e,n){if(!(n&&e===void 0)){if(Io(e))throw new Error(dt(t,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!ds(e))throw new Error(dt(t,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")}},fs=function(t,e,n,i){if(!(i&&n===void 0)&&!Yo(n))throw new Error(dt(t,e)+'was an invalid key = "'+n+`".  Firebase keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]").`)},ps=function(t,e,n,i){if(!(i&&n===void 0)&&!am(n))throw new Error(dt(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},CC=function(t,e,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),ps(t,e,n,i)},At=function(t,e){if(se(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},cm=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Yo(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!IC(n))throw new Error(dt(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class TC{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Qo(t,e){let n=null;for(let i=0;i<e.length;i++){const r=e[i],s=r.getPath();n!==null&&!ec(s,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:s}),n.events.push(r)}n&&t.eventLists_.push(n)}function Wc(t,e,n){Qo(t,n),um(t,i=>ec(i,e))}function kt(t,e,n){Qo(t,n),um(t,i=>Rt(i,e)||Rt(e,i))}function um(t,e){t.recursionDepth_++;let n=!0;for(let i=0;i<t.eventLists_.length;i++){const r=t.eventLists_[i];if(r){const s=r.path;e(s)?(SC(t.eventLists_[i]),t.eventLists_[i]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function SC(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const i=n.getEventRunner();mi&&He("event: "+n.toString()),er(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dm="repo_interrupt",RC=25;class AC{constructor(e,n,i,r){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new TC,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=xo(),this.transactionQueueTree_=new Lc,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function kC(t,e,n){if(t.stats_=Yl(t.repoInfo_),t.forceRestClient_||rI())t.server_=new Oo(t.repoInfo_,(i,r,s,o)=>{fm(t,i,r,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>pm(t,!0),0);else{if(typeof n!="undefined"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ue(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new pn(t.repoInfo_,e,(i,r,s,o)=>{fm(t,i,r,s,o)},i=>{pm(t,i)},i=>{NC(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=uI(t.repoInfo_,()=>new fb(t.stats_,t.server_)),t.infoData_=new lb,t.infoSyncTree_=new Xp({startListening:(i,r,s,o)=>{let a=[];const l=t.infoData_.getNode(i._path);return l.isEmpty()||(a=ls(t.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Bc(t,"connected",!1),t.serverSyncTree_=new Xp({startListening:(i,r,s,o)=>(t.server_.listen(i,s,r,(a,l)=>{const c=o(a,l);kt(t.eventQueue_,i._path,c)}),[]),stopListening:(i,r)=>{t.server_.unlisten(i,r)}})}function hm(t){const n=t.infoData_.getNode(new ve(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function ms(t){return pC({timestamp:hm(t)})}function fm(t,e,n,i,r){t.dataUpdateCount++;const s=new ve(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(r)if(i){const l=vo(n,c=>Oe(c));o=lC(t.serverSyncTree_,s,l,r)}else{const l=Oe(n);o=aC(t.serverSyncTree_,s,l,r)}else if(i){const l=vo(n,c=>Oe(c));o=rC(t.serverSyncTree_,s,l)}else{const l=Oe(n);o=ls(t.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=dr(t,s)),kt(t.eventQueue_,a,o)}function pm(t,e){Bc(t,"connected",e),e===!1&&xC(t)}function NC(t,e){ze(e,(n,i)=>{Bc(t,n,i)})}function Bc(t,e,n){const i=new ve("/.info/"+e),r=Oe(n);t.infoData_.updateSnapshot(i,r);const s=ls(t.infoSyncTree_,i,r);kt(t.eventQueue_,i,s)}function Jo(t){return t.nextWriteId_++}function PC(t,e){const n=cC(t.serverSyncTree_,e);return n!=null?Promise.resolve(n):t.server_.get(e).then(i=>{const r=Oe(i).withIndex(e._queryParams.getIndex()),s=ls(t.serverSyncTree_,e._path,r);return Wc(t.eventQueue_,e._path,s),Promise.resolve(r)},i=>(ur(t,"get for query "+Ue(e)+" failed: "+i),Promise.reject(new Error(i))))}function jc(t,e,n,i,r){ur(t,"set",{path:e.toString(),value:n,priority:i});const s=ms(t),o=Oe(n,i),a=Ho(t.serverSyncTree_,e),l=xc(o,a,s),c=Jo(t),u=Sc(t.serverSyncTree_,e,l,c,!0);Qo(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(h,p)=>{const g=h==="ok";g||ot("set at "+e+" failed: "+h);const R=Dn(t.serverSyncTree_,c,!g);kt(t.eventQueue_,e,R),Fn(t,r,h,p)});const d=zc(t,e);dr(t,d),kt(t.eventQueue_,d,[])}function OC(t,e,n,i){ur(t,"update",{path:e.toString(),value:n});let r=!0;const s=ms(t),o={};if(ze(n,(a,l)=>{r=!1,o[a]=rm(Pe(e,a),Oe(l),t.serverSyncTree_,s)}),r)He("update() called with empty data.  Don't do anything."),Fn(t,i,"ok",void 0);else{const a=Jo(t),l=iC(t.serverSyncTree_,e,o,a);Qo(t.eventQueue_,l),t.server_.merge(e.toString(),n,(c,u)=>{const d=c==="ok";d||ot("update at "+e+" failed: "+c);const h=Dn(t.serverSyncTree_,a,!d),p=h.length>0?dr(t,e):e;kt(t.eventQueue_,p,h),Fn(t,i,c,u)}),ze(n,c=>{const u=zc(t,Pe(e,c));dr(t,u)}),kt(t.eventQueue_,e,[])}}function xC(t){ur(t,"onDisconnectEvents");const e=ms(t),n=xo();hc(t.onDisconnect_,_e(),(r,s)=>{const o=rm(r,s,t.serverSyncTree_,e);or(n,r,o)});let i=[];hc(n,_e(),(r,s)=>{i=i.concat(ls(t.serverSyncTree_,r,s));const o=zc(t,r);dr(t,o)}),t.onDisconnect_=xo(),kt(t.eventQueue_,_e(),i)}function MC(t,e,n){t.server_.onDisconnectCancel(e.toString(),(i,r)=>{i==="ok"&&dc(t.onDisconnect_,e),Fn(t,n,i,r)})}function mm(t,e,n,i){const r=Oe(n);t.server_.onDisconnectPut(e.toString(),r.val(!0),(s,o)=>{s==="ok"&&or(t.onDisconnect_,e,r),Fn(t,i,s,o)})}function LC(t,e,n,i,r){const s=Oe(n,i);t.server_.onDisconnectPut(e.toString(),s.val(!0),(o,a)=>{o==="ok"&&or(t.onDisconnect_,e,s),Fn(t,r,o,a)})}function DC(t,e,n,i){if(_o(n)){He("onDisconnect().update() called with empty data.  Don't do anything."),Fn(t,i,"ok",void 0);return}t.server_.onDisconnectMerge(e.toString(),n,(r,s)=>{r==="ok"&&ze(n,(o,a)=>{const l=Oe(a);or(t.onDisconnect_,Pe(e,o),l)}),Fn(t,i,r,s)})}function FC(t,e,n){let i;se(e._path)===".info"?i=Zp(t.infoSyncTree_,e,n):i=Zp(t.serverSyncTree_,e,n),Wc(t.eventQueue_,e._path,i)}function $c(t,e,n){let i;se(e._path)===".info"?i=Rc(t.infoSyncTree_,e,n):i=Rc(t.serverSyncTree_,e,n),Wc(t.eventQueue_,e._path,i)}function gm(t){t.persistentConnection_&&t.persistentConnection_.interrupt(dm)}function UC(t){t.persistentConnection_&&t.persistentConnection_.resume(dm)}function ur(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),He(n,...e)}function Fn(t,e,n,i){e&&er(()=>{if(n==="ok")e(null);else{const r=(n||"error").toUpperCase();let s=r;i&&(s+=": "+i);const o=new Error(s);o.code=r,e(o)}})}function VC(t,e,n,i,r,s){ur(t,"transaction on "+e);const o={path:e,update:n,onComplete:i,status:null,order:xf(),applyLocally:s,retryCount:0,unwatcher:r,abortReason:null,currentWriteId:null,currentInputSnapshot:null,currentOutputSnapshotRaw:null,currentOutputSnapshotResolved:null},a=Hc(t,e,void 0);o.currentInputSnapshot=a;const l=o.update(a.val());if(l===void 0)o.unwatcher(),o.currentOutputSnapshotRaw=null,o.currentOutputSnapshotResolved=null,o.onComplete&&o.onComplete(null,!1,o.currentInputSnapshot);else{hs("transaction failed: Data returned ",l,o.path),o.status=0;const c=Go(t.transactionQueueTree_,e),u=Ei(c)||[];u.push(o),Dc(c,u);let d;typeof l=="object"&&l!==null&&yt(l,".priority")?(d=ai(l,".priority"),k(ds(d),"Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")):d=(Ho(t.serverSyncTree_,e)||Q.EMPTY_NODE).getPriority().val();const h=ms(t),p=Oe(l,d),g=xc(p,a,h);o.currentOutputSnapshotRaw=p,o.currentOutputSnapshotResolved=g,o.currentWriteId=Jo(t);const R=Sc(t.serverSyncTree_,e,g,o.currentWriteId,o.applyLocally);kt(t.eventQueue_,e,R),Xo(t,t.transactionQueueTree_)}}function Hc(t,e,n){return Ho(t.serverSyncTree_,e,n)||Q.EMPTY_NODE}function Xo(t,e=t.transactionQueueTree_){if(e||Zo(t,e),Ei(e)){const n=vm(t,e);k(n.length>0,"Sending zero length transaction queue"),n.every(r=>r.status===0)&&WC(t,us(e),n)}else sm(e)&&Ko(e,n=>{Xo(t,n)})}function WC(t,e,n){const i=n.map(c=>c.currentWriteId),r=Hc(t,e,i);let s=r;const o=r.hash();for(let c=0;c<n.length;c++){const u=n[c];k(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const d=at(e,u.path);s=s.updateChild(d,u.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;t.server_.put(l.toString(),a,c=>{ur(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(Dn(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();Zo(t,Go(t.transactionQueueTree_,e)),Xo(t,t.transactionQueueTree_),kt(t.eventQueue_,e,u);for(let h=0;h<d.length;h++)er(d[h])}else{if(c==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{ot("transaction at "+l.toString()+" failed: "+c);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=c}dr(t,e)}},o)}function dr(t,e){const n=_m(t,e),i=us(n),r=vm(t,n);return BC(t,r,i),i}function BC(t,e,n){if(e.length===0)return;const i=[];let r=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=at(n,l.path);let u=!1,d;if(k(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,d=l.abortReason,r=r.concat(Dn(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=RC)u=!0,d="maxretry",r=r.concat(Dn(t.serverSyncTree_,l.currentWriteId,!0));else{const h=Hc(t,l.path,o);l.currentInputSnapshot=h;const p=e[a].update(h.val());if(p!==void 0){hs("transaction failed: Data returned ",p,l.path);let g=Oe(p);typeof p=="object"&&p!=null&&yt(p,".priority")||(g=g.updatePriority(h.getPriority()));const I=l.currentWriteId,y=ms(t),T=xc(g,h,y);l.currentOutputSnapshotRaw=g,l.currentOutputSnapshotResolved=T,l.currentWriteId=Jo(t),o.splice(o.indexOf(I),1),r=r.concat(Sc(t.serverSyncTree_,l.path,T,l.currentWriteId,l.applyLocally)),r=r.concat(Dn(t.serverSyncTree_,I,!0))}else u=!0,d="nodata",r=r.concat(Dn(t.serverSyncTree_,l.currentWriteId,!0))}kt(t.eventQueue_,n,r),r=[],u&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(d),!1,null))))}Zo(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)er(i[a]);Xo(t,t.transactionQueueTree_)}function _m(t,e){let n,i=t.transactionQueueTree_;for(n=se(e);n!==null&&Ei(i)===void 0;)i=Go(i,n),e=be(e),n=se(e);return i}function vm(t,e){const n=[];return ym(t,e,n),n.sort((i,r)=>i.order-r.order),n}function ym(t,e,n){const i=Ei(e);if(i)for(let r=0;r<i.length;r++)n.push(i[r]);Ko(e,r=>{ym(t,r,n)})}function Zo(t,e){const n=Ei(e);if(n){let i=0;for(let r=0;r<n.length;r++)n[r].status!==2&&(n[i]=n[r],i++);n.length=i,Dc(e,n.length>0?n:void 0)}Ko(e,i=>{Zo(t,i)})}function zc(t,e){const n=us(_m(t,e)),i=Go(t.transactionQueueTree_,e);return vC(i,r=>{qc(t,r)}),qc(t,i),om(i,r=>{qc(t,r)}),n}function qc(t,e){const n=Ei(e);if(n){const i=[];let r=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(k(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(k(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),r=r.concat(Dn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?Dc(e,void 0):n.length=s+1,kt(t.eventQueue_,us(e),r);for(let o=0;o<i.length;o++)er(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ft{constructor(e,n,i,r){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=r}get key(){return oe(this._path)?null:Zl(this._path)}get ref(){return new Nt(this._repo,this._path)}get _queryIdentifier(){const e=Ap(this._queryParams),n=$l(e);return n==="{}"?"default":n}get _queryObject(){return Ap(this._queryParams)}isEqual(e){if(e=Z(e),!(e instanceof ft))return!1;const n=this._repo===e._repo,i=ec(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return n&&i&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+xI(this._path)}}function ea(t,e){if(t._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function Un(t){let e=null,n=null;if(t.hasStart()&&(e=t.getIndexStartValue()),t.hasEnd()&&(n=t.getIndexEndValue()),t.getIndex()===Zt){const i="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",r="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(t.hasStart()){if(t.getIndexStartName()!==fn)throw new Error(i);if(typeof e!="string")throw new Error(r)}if(t.hasEnd()){if(t.getIndexEndName()!==Xt)throw new Error(i);if(typeof n!="string")throw new Error(r)}}else if(t.getIndex()===Te){if(e!=null&&!ds(e)||n!=null&&!ds(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(k(t.getIndex()instanceof sc||t.getIndex()===oc,"unknown index type."),e!=null&&typeof e=="object"||n!=null&&typeof n=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function ta(t){if(t.hasStart()&&t.hasEnd()&&t.hasLimit()&&!t.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class Nt extends ft{constructor(e,n){super(e,n,new No,!1)}get parent(){const e=hp(this._path);return e===null?null:new Nt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ii{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new ve(e),i=bi(this.ref,e);return new Ii(this._node.getChild(n),i,Te)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,r)=>e(new Ii(r,bi(this.ref,i),Te)))}hasChild(e){const n=new ve(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function bm(t,e){return t=Z(t),t._checkNotDeleted("ref"),e!==void 0?bi(t._root,e):t._root}function Cm(t,e){t=Z(t),t._checkNotDeleted("refFromURL");const n=Gc(e,t._repo.repoInfo_.nodeAdmin);cm("refFromURL",n);const i=n.repoInfo;return!t._repo.repoInfo_.isCustomHost()&&i.host!==t._repo.repoInfo_.host&&Jt("refFromURL: Host name does not match the current database: (found "+i.host+" but expected "+t._repo.repoInfo_.host+")"),bm(t,n.path.toString())}function bi(t,e){return t=Z(t),se(t._path)===null?CC("child","path",e,!1):ps("child","path",e,!1),new Nt(t._repo,Pe(t._path,e))}function qC(t,e){t=Z(t),At("push",t._path),en("push",e,t._path,!0);const n=hm(t._repo),i=eb(n),r=bi(t,i),s=bi(t,i);let o;return e!=null?o=Kc(s,e).then(()=>s):o=Promise.resolve(s),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function GC(t){return At("remove",t._path),Kc(t,null)}function Kc(t,e){t=Z(t),At("set",t._path),en("set",e,t._path,!1);const n=new ut;return jc(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function KC(t,e){t=Z(t),At("setPriority",t._path),Vc("setPriority",e,!1);const n=new ut;return jc(t._repo,Pe(t._path,".priority"),e,null,n.wrapCallback(()=>{})),n.promise}function YC(t,e,n){if(At("setWithPriority",t._path),en("setWithPriority",e,t._path,!1),Vc("setWithPriority",n,!1),t.key===".length"||t.key===".keys")throw"setWithPriority failed: "+t.key+" is a read-only object.";const i=new ut;return jc(t._repo,t._path,e,n,i.wrapCallback(()=>{})),i.promise}function QC(t,e){lm("update",e,t._path,!1);const n=new ut;return OC(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function JC(t){return t=Z(t),PC(t._repo,t).then(e=>new Ii(e,new Nt(t._repo,t._path),t._queryParams.getIndex()))}class na{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new wm("value",this,new Ii(e.snapshotNode,new Nt(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Em(this,e,n):null}matches(e){return e instanceof na?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class ia{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Em(this,e,n):null}createEvent(e,n){k(e.childName!=null,"Child events should have a childName.");const i=bi(new Nt(n._repo,n._path),e.childName),r=n._queryParams.getIndex();return new wm(e.type,this,new Ii(e.snapshotNode,i,r),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof ia?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function gs(t,e,n,i,r){let s;if(typeof i=="object"&&(s=void 0,r=i),typeof i=="function"&&(s=i),r&&r.onlyOnce){const l=n,c=(u,d)=>{$c(t._repo,t,a),l(u,d)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new Im(n,s||void 0),a=e==="value"?new na(o):new ia(e,o);return FC(t._repo,t,a),()=>$c(t._repo,t,a)}function Yc(t,e,n,i){return gs(t,"value",e,n,i)}function Tm(t,e,n,i){return gs(t,"child_added",e,n,i)}function Sm(t,e,n,i){return gs(t,"child_changed",e,n,i)}function Rm(t,e,n,i){return gs(t,"child_moved",e,n,i)}function Am(t,e,n,i){return gs(t,"child_removed",e,n,i)}function km(t,e,n){let i=null;const r=n?new Im(n):null;e==="value"?i=new na(r):e&&(i=new ia(e,r)),$c(t._repo,t,i)}class Vt{}class Nm extends Vt{constructor(e,n){super();this._value=e,this._key=n}_apply(e){en("endAt",this._value,e._path,!0);const n=uc(e._queryParams,this._value,this._key);if(ta(n),Un(n),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new ft(e._repo,e._path,n,e._orderByCalled)}}function XC(t,e){return fs("endAt","key",e,!0),new Nm(t,e)}class ZC extends Vt{constructor(e,n){super();this._value=e,this._key=n}_apply(e){en("endBefore",this._value,e._path,!1);const n=ab(e._queryParams,this._value,this._key);if(ta(n),Un(n),e._queryParams.hasEnd())throw new Error("endBefore: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new ft(e._repo,e._path,n,e._orderByCalled)}}function eT(t,e){return fs("endBefore","key",e,!0),new ZC(t,e)}class Pm extends Vt{constructor(e,n){super();this._value=e,this._key=n}_apply(e){en("startAt",this._value,e._path,!0);const n=cc(e._queryParams,this._value,this._key);if(ta(n),Un(n),e._queryParams.hasStart())throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");return new ft(e._repo,e._path,n,e._orderByCalled)}}function tT(t=null,e){return fs("startAt","key",e,!0),new Pm(t,e)}class nT extends Vt{constructor(e,n){super();this._value=e,this._key=n}_apply(e){en("startAfter",this._value,e._path,!1);const n=ob(e._queryParams,this._value,this._key);if(ta(n),Un(n),e._queryParams.hasStart())throw new Error("startAfter: Starting point was already set (by another call to startAt, startAfter, or equalTo).");return new ft(e._repo,e._path,n,e._orderByCalled)}}function iT(t,e){return fs("startAfter","key",e,!0),new nT(t,e)}class rT extends Vt{constructor(e){super();this._limit=e}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToFirst: Limit was already set (by another call to limitToFirst or limitToLast).");return new ft(e._repo,e._path,rb(e._queryParams,this._limit),e._orderByCalled)}}function sT(t){if(typeof t!="number"||Math.floor(t)!==t||t<=0)throw new Error("limitToFirst: First argument must be a positive integer.");return new rT(t)}class oT extends Vt{constructor(e){super();this._limit=e}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new ft(e._repo,e._path,sb(e._queryParams,this._limit),e._orderByCalled)}}function aT(t){if(typeof t!="number"||Math.floor(t)!==t||t<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new oT(t)}class lT extends Vt{constructor(e){super();this._path=e}_apply(e){ea(e,"orderByChild");const n=new ve(this._path);if(oe(n))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const i=new sc(n),r=Po(e._queryParams,i);return Un(r),new ft(e._repo,e._path,r,!0)}}function cT(t){if(t==="$key")throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if(t==="$priority")throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if(t==="$value")throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return ps("orderByChild","path",t,!1),new lT(t)}class uT extends Vt{_apply(e){ea(e,"orderByKey");const n=Po(e._queryParams,Zt);return Un(n),new ft(e._repo,e._path,n,!0)}}function dT(){return new uT}class hT extends Vt{_apply(e){ea(e,"orderByPriority");const n=Po(e._queryParams,Te);return Un(n),new ft(e._repo,e._path,n,!0)}}function fT(){return new hT}class pT extends Vt{_apply(e){ea(e,"orderByValue");const n=Po(e._queryParams,oc);return Un(n),new ft(e._repo,e._path,n,!0)}}function mT(){return new pT}class gT extends Vt{constructor(e,n){super();this._value=e,this._key=n}_apply(e){if(en("equalTo",this._value,e._path,!1),e._queryParams.hasStart())throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");if(e._queryParams.hasEnd())throw new Error("equalTo: Ending point was already set (by another call to endAt/endBefore or equalTo).");return new Nm(this._value,this._key)._apply(new Pm(this._value,this._key)._apply(e))}}function _T(t,e){return fs("equalTo","key",e,!0),new gT(t,e)}function Wt(t,...e){let n=Z(t);for(const i of e)n=i._apply(n);return n}Yb(Nt);eC(Nt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dm=new $r("@firebase/auth");function ra(t,...e){Dm.logLevel<=we.ERROR&&Dm.error(`Auth (${hi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ze(t,...e){throw Jc(t,...e)}function et(t,...e){return Jc(t,...e)}function Fm(t,e,n){const i=Object.assign(Object.assign({},GT()),{[e]:n});return new oi("auth","Firebase",i).create(e,{appName:t.name})}function fr(t,e,n){const i=n;if(!(e instanceof i))throw i.name!==e.constructor.name&&Ze(t,"argument-error"),Fm(t,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Jc(t,...e){if(typeof t!="string"){const n=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=t.name),t._errorFactory.create(n,...i)}return Lm.create(t,...e)}function N(t,e,...n){if(!t)throw Jc(e,...n)}function tn(t){const e="INTERNAL ASSERTION FAILED: "+t;throw ra(e),new Error(e)}function Bt(t,e){t||tn(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ys(){var t;return typeof self!="undefined"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function Xc(){return Vm()==="http:"||Vm()==="https:"}function Vm(){var t;return typeof self!="undefined"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YT(){return typeof navigator!="undefined"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Xc()||cf()||"connection"in navigator)?navigator.onLine:!0}function QT(){if(typeof navigator=="undefined")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,n){this.shortDelay=e,this.longDelay=n,Bt(n>e,"Short delay should be less than long delay!"),this.isMobile=xl()||go()}get(){return YT()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Es(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch(e){}}async function iS(t,e=!1){const n=Z(t),i=await n.getIdToken(e),r=oa(i);N(r&&r.exp&&r.auth_time&&r.iat,n.auth,"internal-error");const s=typeof r.firebase=="object"?r.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:r,token:i,authTime:Es(tu(r.auth_time)),issuedAtTime:Es(tu(r.iat)),expirationTime:Es(tu(r.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function tu(t){return Number(t)*1e3}function oa(t){const[e,n,i]=t.split(".");if(e===void 0||n===void 0||i===void 0)return ra("JWT malformed, contained fewer than 3 sections"),null;try{const r=Ol(n);return r?JSON.parse(r):(ra("Failed to decode base64 JWT payload"),null)}catch(r){return ra("Caught error parsing JWT payload as JSON",r),null}}function rS(t){const e=oa(t);return N(e,"internal-error"),N(typeof e.exp!="undefined","internal-error"),N(typeof e.iat!="undefined","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hm(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Gm(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(zm(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Km(e))return"Blackberry";if(Ym(e))return"Webos";if(nu(e))return"Safari";if((e.includes("chrome/")||qm(e))&&!e.includes("edge/"))return"Chrome";if(Ts(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function zm(t=Le()){return/firefox\//i.test(t)}function nu(t=Le()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function qm(t=Le()){return/crios\//i.test(t)}function Gm(t=Le()){return/iemobile/i.test(t)}function Ts(t=Le()){return/android/i.test(t)}function Km(t=Le()){return/blackberry/i.test(t)}function Ym(t=Le()){return/webos/i.test(t)}function mr(t=Le()){return/iphone|ipad|ipod/i.test(t)}function dS(t=Le()){return/(iPad|iPhone|iPod).*OS 7_\d/i.test(t)||/(iPad|iPhone|iPod).*OS 8_\d/i.test(t)}function hS(t=Le()){var e;return mr(t)&&!!((e=window.navigator)===null||e===void 0?void 0:e.standalone)}function fS(){return uf()&&document.documentMode===10}function Qm(t=Le()){return mr(t)||Ts(t)||Ym(t)||Km(t)||/windows phone/i.test(t)||Gm(t)}function pS(){try{return!!(window&&window!==window.top)}catch(t){return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wS(t,e){return gn(t,"POST","/v1/accounts:signInWithPassword",Ve(t,e))}async function aa(t,e){return Ke(t,"POST","/v1/accounts:sendOobCode",Ve(t,e))}async function ES(t,e){return aa(t,e)}async function IS(t,e){return aa(t,e)}async function bS(t,e){return aa(t,e)}async function CS(t,e){return aa(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xS(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function MS(t){const e=Xi(jr(t)).link,n=e?Xi(jr(e)).deep_link_id:null,i=Xi(jr(t)).deep_link_id;return(i?Xi(jr(i)).link:null)||i||n||e||t}class la{constructor(e){var n,i,r,s,o,a;const l=Xi(jr(e)),c=(n=l.apiKey)!==null&&n!==void 0?n:null,u=(i=l.oobCode)!==null&&i!==void 0?i:null,d=xS((r=l.mode)!==null&&r!==void 0?r:null);N(c&&u&&d,"argument-error"),this.apiKey=c,this.operation=d,this.code=u,this.continueUrl=(s=l.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=l.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=MS(e);try{return new la(n)}catch(i){return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ua extends St{constructor(e,n,i,r){var s;super(n.code,n.message);this.operationType=i,this.user=r,this.name="FirebaseError",Object.setPrototypeOf(this,ua.prototype),this.appName=e.name,this.code=n.code,this.tenantId=(s=e.tenantId)!==null&&s!==void 0?s:void 0,this.serverResponse=n.customData.serverResponse}static _fromErrorAndOperation(e,n,i,r){return new ua(e,n,i,r)}}function sg(t,e,n,i){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(s=>{throw s.code==="auth/multi-factor-auth-required"?ua._fromErrorAndOperation(t,s,e,i):s})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function FS(t,e){const n=Z(t);await da(!0,n,e);const{providerUserInfo:i}=await tS(n.auth,{idToken:await n.getIdToken(),deleteProvider:[e]}),r=og(i||[]);return n.providerData=n.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(n.phoneNumber=null),await n.auth._persistUserIfCurrent(n),n}async function iu(t,e,n=!1){const i=await _n(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Pt._forOperation(t,"link",i)}async function da(t,e,n){await Is(e);const i=og(e.providerData),r=t===!1?"provider-already-linked":"no-such-provider";N(i.has(n)===t,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lg(t,e,n=!1){const i="signIn",r=await sg(t,i,e),s=await Pt._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(s.user),s}async function ha(t,e){return lg(Ye(t),e)}async function cg(t,e){const n=Z(t);return await da(!1,n,e.providerId),iu(n,e)}async function ug(t,e){return ag(Z(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fa{constructor(e,n){this.factorId=e,this.uid=n.mfaEnrollmentId,this.enrollmentTime=new Date(n.enrolledAt).toUTCString(),this.displayName=n.displayName}static _fromServerResponse(e,n){return"phoneInfo"in n?ru._fromServerResponse(e,n):Ze(e,"internal-error")}}class ru extends fa{constructor(e){super("phone",e);this.phoneNumber=e.phoneInfo}static _fromServerResponse(e,n){return new ru(n)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pa(t,e,n){var i;N(((i=n.url)===null||i===void 0?void 0:i.length)>0,t,"invalid-continue-uri"),N(typeof n.dynamicLinkDomain=="undefined"||n.dynamicLinkDomain.length>0,t,"invalid-dynamic-link-domain"),e.continueUrl=n.url,e.dynamicLinkDomain=n.dynamicLinkDomain,e.canHandleCodeInApp=n.handleCodeInApp,n.iOS&&(N(n.iOS.bundleId.length>0,t,"missing-ios-bundle-id"),e.iOSBundleId=n.iOS.bundleId),n.android&&(N(n.android.packageName.length>0,t,"missing-android-pkg-name"),e.androidInstallApp=n.android.installApp,e.androidMinimumVersionCode=n.android.minimumVersion,e.androidPackageName=n.android.packageName)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function WS(t,e,n){const i=Z(t),r={requestType:"PASSWORD_RESET",email:e};n&&pa(i,r,n),await IS(i,r)}async function BS(t,e,n){await tg(Z(t),{oobCode:e,newPassword:n})}async function jS(t,e){await yS(Z(t),{oobCode:e})}async function dg(t,e){const n=Z(t),i=await tg(n,{oobCode:e}),r=i.requestType;switch(N(r,n,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":N(i.newEmail,n,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":N(i.mfaInfo,n,"internal-error");default:N(i.email,n,"internal-error")}let s=null;return i.mfaInfo&&(s=fa._fromServerResponse(Ye(n),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function $S(t,e){const{data:n}=await dg(Z(t),e);return n.email}async function HS(t,e,n){const i=Ye(t),r=await ig(i,{returnSecureToken:!0,email:e,password:n}),s=await Pt._fromIdTokenResponse(i,"signIn",r);return await i._updateCurrentUser(s.user),s}function zS(t,e,n){return ha(Z(t),Bn.credential(e,n))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qS(t,e,n){const i=Z(t),r={requestType:"EMAIL_SIGNIN",email:e};N(n.handleCodeInApp,i,"argument-error"),n&&pa(i,r,n),await bS(i,r)}function GS(t,e){const n=la.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function KS(t,e,n){const i=Z(t),r=Bn.credentialWithLink(e,n||ys());return N(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),ha(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QS(t,e){const n=Xc()?ys():"http://localhost",i={identifier:e,continueUri:n},{signinMethods:r}=await YS(Z(t),i);return r||[]}async function JS(t,e){const n=Z(t),i=await t.getIdToken(),r={requestType:"VERIFY_EMAIL",idToken:i};e&&pa(n.auth,r,e);const{email:s}=await ES(n.auth,r);s!==t.email&&await t.reload()}async function XS(t,e,n){const i=Z(t),r=await t.getIdToken(),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:r,newEmail:e};n&&pa(i.auth,s,n);const{email:o}=await CS(i.auth,s);o!==t.email&&await t.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u0(t,e){return Ke(t,"POST","/v2/accounts/mfaEnrollment:start",Ve(t,e))}function d0(t,e){return Ke(t,"POST","/v2/accounts/mfaEnrollment:finalize",Ve(t,e))}function h0(t,e){return Ke(t,"POST","/v2/accounts/mfaEnrollment:withdraw",Ve(t,e))}class ou{constructor(e){this.user=e,this.enrolledFactors=[],e._onReload(n=>{n.mfaInfo&&(this.enrolledFactors=n.mfaInfo.map(i=>fa._fromServerResponse(e.auth,i)))})}static _fromUser(e){return new ou(e)}async getSession(){return Ri._fromIdtoken(await this.user.getIdToken())}async enroll(e,n){const i=e,r=await this.getSession(),s=await _n(this.user,i._process(this.user.auth,r,n));return await this.user._updateTokensIfNecessary(s),this.user.reload()}async unenroll(e){const n=typeof e=="string"?e:e.uid,i=await this.user.getIdToken(),r=await _n(this.user,h0(this.user.auth,{idToken:i,mfaEnrollmentId:n}));this.enrolledFactors=this.enrolledFactors.filter(({uid:s})=>s!==n),await this.user._updateTokensIfNecessary(r);try{await this.user.reload()}catch(s){if(s.code!=="auth/user-token-expired")throw s}}}const au=new WeakMap;function f0(t){const e=Z(t);return au.has(e)||au.set(e,ou._fromUser(e)),au.get(e)}const ma="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pg{constructor(e,n){this.storage=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(ma,"1"),this.storage.removeItem(ma),Promise.resolve(!0)):Promise.resolve(!1)}catch(e){return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ga{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const n=this.receivers.find(r=>r.isListeningto(e));if(n)return n;const i=new ga(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const n=e,{eventId:i,eventType:r,data:s}=n.data,o=this.handlersMap[r];if(!(o==null?void 0:o.size))return;n.ports[0].postMessage({status:"ack",eventId:i,eventType:r});const a=Array.from(o).map(async c=>c(n.origin,s)),l=await _0(a);n.ports[0].postMessage({status:"done",eventId:i,eventType:r,response:l})}_subscribe(e,n){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(n)}_unsubscribe(e,n){this.handlersMap[e]&&n&&this.handlersMap[e].delete(n),(!n||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}ga.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cu(){return typeof We().WorkerGlobalScope!="undefined"&&typeof We().importScripts=="function"}async function w0(){if(!(navigator==null?void 0:navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch(t){return null}}function E0(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function I0(){return cu()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _g="firebaseLocalStorageDb",b0=1,_a="firebaseLocalStorage",vg="fbase_key";class As{constructor(e){this.request=e}toPromise(){return new Promise((e,n)=>{this.request.addEventListener("success",()=>{e(this.request.result)}),this.request.addEventListener("error",()=>{n(this.request.error)})})}}function va(t,e){return t.transaction([_a],e?"readwrite":"readonly").objectStore(_a)}function C0(){const t=indexedDB.deleteDatabase(_g);return new As(t).toPromise()}function uu(){const t=indexedDB.open(_g,b0);return new Promise((e,n)=>{t.addEventListener("error",()=>{n(t.error)}),t.addEventListener("upgradeneeded",()=>{const i=t.result;try{i.createObjectStore(_a,{keyPath:vg})}catch(r){n(r)}}),t.addEventListener("success",async()=>{const i=t.result;i.objectStoreNames.contains(_a)?e(i):(i.close(),await C0(),e(await uu()))})})}async function yg(t,e,n){const i=va(t,!0).put({[vg]:e,value:n});return new As(i).toPromise()}async function T0(t,e){const n=va(t,!1).get(e),i=await new As(n).toPromise();return i===void 0?null:i.value}function wg(t,e){const n=va(t,!0).delete(e);return new As(n).toPromise()}const S0=800,R0=3;class Eg{constructor(){this.type="LOCAL",this._shouldAllowMigration=!0,this.listeners={},this.localCache={},this.pollTimer=null,this.pendingWrites=0,this.receiver=null,this.sender=null,this.serviceWorkerReceiverAvailable=!1,this.activeServiceWorker=null,this._workerInitializationPromise=this.initializeServiceWorkerMessaging().then(()=>{},()=>{})}async _openDb(){return this.db?this.db:(this.db=await uu(),this.db)}async _withRetries(e){let n=0;for(;;)try{const i=await this._openDb();return await e(i)}catch(i){if(n++>R0)throw i;this.db&&(this.db.close(),this.db=void 0)}}async initializeServiceWorkerMessaging(){return cu()?this.initializeReceiver():this.initializeSender()}async initializeReceiver(){this.receiver=ga._getInstance(I0()),this.receiver._subscribe("keyChanged",async(e,n)=>({keyProcessed:(await this._poll()).includes(n.key)})),this.receiver._subscribe("ping",async(e,n)=>["keyChanged"])}async initializeSender(){var e,n;if(this.activeServiceWorker=await w0(),!this.activeServiceWorker)return;this.sender=new v0(this.activeServiceWorker);const i=await this.sender._send("ping",{},800);!i||((e=i[0])===null||e===void 0?void 0:e.fulfilled)&&((n=i[0])===null||n===void 0?void 0:n.value.includes("keyChanged"))&&(this.serviceWorkerReceiverAvailable=!0)}async notifyServiceWorker(e){if(!(!this.sender||!this.activeServiceWorker||E0()!==this.activeServiceWorker))try{await this.sender._send("keyChanged",{key:e},this.serviceWorkerReceiverAvailable?800:50)}catch(n){}}async _isAvailable(){try{if(!indexedDB)return!1;const e=await uu();return await yg(e,ma,"1"),await wg(e,ma),!0}catch(e){}return!1}async _withPendingWrite(e){this.pendingWrites++;try{await e()}finally{this.pendingWrites--}}async _set(e,n){return this._withPendingWrite(async()=>(await this._withRetries(i=>yg(i,e,n)),this.localCache[e]=n,this.notifyServiceWorker(e)))}async _get(e){const n=await this._withRetries(i=>T0(i,e));return this.localCache[e]=n,n}async _remove(e){return this._withPendingWrite(async()=>(await this._withRetries(n=>wg(n,e)),delete this.localCache[e],this.notifyServiceWorker(e)))}async _poll(){const e=await this._withRetries(r=>{const s=va(r,!1).getAll();return new As(s).toPromise()});if(!e)return[];if(this.pendingWrites!==0)return[];const n=[],i=new Set;for(const{fbase_key:r,value:s}of e)i.add(r),JSON.stringify(this.localCache[r])!==JSON.stringify(s)&&(this.notifyListeners(r,s),n.push(r));for(const r of Object.keys(this.localCache))this.localCache[r]&&!i.has(r)&&(this.notifyListeners(r,null),n.push(r));return n}notifyListeners(e,n){this.localCache[e]=n;const i=this.listeners[e];if(i)for(const r of Array.from(i))r(n)}startPolling(){this.stopPolling(),this.pollTimer=setInterval(async()=>this._poll(),S0)}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}_addListener(e,n){Object.keys(this.listeners).length===0&&this.startPolling(),this.listeners[e]||(this.listeners[e]=new Set,this._get(e)),this.listeners[e].add(n)}_removeListener(e,n){this.listeners[e]&&(this.listeners[e].delete(n),this.listeners[e].size===0&&delete this.listeners[e]),Object.keys(this.listeners).length===0&&this.stopPolling()}}Eg.type="LOCAL";const ya=Eg;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const du=bg("rcb"),F0=new ws(3e4,6e4),U0="https://www.google.com/recaptcha/api.js?";class V0{constructor(){this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!We().grecaptcha}load(e,n=""){return N(W0(n),e,"argument-error"),this.shouldResolveImmediately(n)?Promise.resolve(We().grecaptcha):new Promise((i,r)=>{const s=We().setTimeout(()=>{r(et(e,"network-request-failed"))},F0.get());We()[du]=()=>{We().clearTimeout(s),delete We()[du];const a=We().grecaptcha;if(!a){r(et(e,"internal-error"));return}const l=a.render;a.render=(c,u)=>{const d=l(c,u);return this.counter++,d},this.hostLanguage=n,i(a)};const o=`${U0}?${li({onload:du,render:"explicit",hl:n})}`;Ig(o).catch(()=>{clearTimeout(s),r(et(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){return!!We().grecaptcha&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function W0(t){return t.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(t)}class B0{async load(e){return new M0(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fu extends gr{constructor(e){super("custom","custom");this.params=e}_getIdTokenResponse(e){return vn(e,this._buildIdpRequest())}_linkToIdToken(e,n){return vn(e,this._buildIdpRequest(n))}_getReauthenticationResolver(e){return vn(e,this._buildIdpRequest())}_buildIdpRequest(e){const n={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(n.idToken=e),n}}function Y0(t){return lg(t.auth,new fu(t),t.bypassAuthState)}function Q0(t){const{auth:e,user:n}=t;return N(n,e,"internal-error"),ag(n,new fu(t),t.bypassAuthState)}async function J0(t){const{auth:e,user:n}=t;return N(n,e,"internal-error"),iu(n,new fu(t),t.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nR="pendingRedirect",pu=new Map;class iR extends Tg{constructor(e,n,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i);this.eventId=null}async execute(){let e=pu.get(this.auth._key());if(!e){try{const i=await rR(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(n){e=()=>Promise.reject(n)}pu.set(this.auth._key(),e)}return e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function rR(t,e){const n=Sg(e),i=await gu(t)._get(n)==="true";return await gu(t)._remove(n),i}async function mu(t,e){return gu(t)._set(Sg(e),"true")}function sR(){pu.clear()}function gu(t){return Et(t._redirectPersistence)}function Sg(t){return Ti(nR,t.config.apiKey,t.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oR(t,e,n){return aR(t,e,n)}async function aR(t,e,n){const i=Ye(t);fr(t,e,jn);const r=ki(i,n);return await mu(r,i),r._openRedirect(i,e,"signInViaRedirect")}function lR(t,e,n){return cR(t,e,n)}async function cR(t,e,n){const i=Z(t);fr(i.auth,e,jn);const r=ki(i.auth,n);await mu(r,i.auth);const s=await Rg(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function uR(t,e,n){return dR(t,e,n)}async function dR(t,e,n){const i=Z(t);fr(i.auth,e,jn);const r=ki(i.auth,n);await da(!1,i,e.providerId),await mu(r,i.auth);const s=await Rg(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function hR(t,e){return await Ye(t)._initializationPromise,Ia(t,e,!1)}async function Ia(t,e,n=!1){const i=Ye(t),r=ki(i,e),o=await new iR(i,r,n).execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Rg(t){const e=Rs(`${t.uid}:::`);return t._redirectEventId=e,await t.auth._setRedirectUser(t),await t.auth._persistUserIfCurrent(t),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DR="__/auth/handler",FR="emulator/auth/handler";function _u(t,e,n,i,r,s){N(t.config.authDomain,t,"auth-domain-config-required"),N(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:i,v:hi,eventId:r};if(e instanceof jn){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",_o(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[l,c]of Object.entries(s||{}))o[l]=c}if(e instanceof _r){const l=e.getScopes().filter(c=>c!=="");l.length>0&&(o.scopes=l.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const l of Object.keys(a))a[l]===void 0&&delete a[l];return`${UR(t)}?${li(a).slice(1)}`}function UR({config:t}){return t.emulator?Zc(t,FR):`https://${t.authDomain}/${DR}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vu="webStorageSupport";class VR{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ai,this._completeRedirectFn=Ia}async _openPopup(e,n,i,r){var s;Bt((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=_u(e,n,i,ys(),r);return MR(e,o,Rs())}async _openRedirect(e,n,i,r){return await this._originValidation(e),y0(_u(e,n,i,ys(),r)),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:r,promise:s}=this.eventManagers[n];return r?Promise.resolve(r):(Bt(s,"If manager is not set, promise should be"),s)}const i=this.initAndGetManager(e);return this.eventManagers[n]={promise:i},i}async initAndGetManager(e){const n=await AR(e),i=new Ag(e);return n.register("authEvent",r=>(N(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:i.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=n,i}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(vu,{type:vu},r=>{var s;const o=(s=r==null?void 0:r[0])===null||s===void 0?void 0:s[vu];o!==void 0&&n(!!o),Ze(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=_R(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Qm()||nu()||mr()}}const WR=VR;class BR{constructor(e){this.factorId=e}_process(e,n,i){switch(n.type){case"enroll":return this._finalizeEnroll(e,n.credential,i);case"signin":return this._finalizeSignIn(e,n.credential);default:return tn("unexpected MultiFactorSessionType")}}}class yu extends BR{constructor(e){super("phone");this.credential=e}static _fromCredential(e){return new yu(e)}_finalizeEnroll(e,n,i){return d0(e,{idToken:n,displayName:i,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,n){return k0(e,{mfaPendingCredential:n,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}class Mg{constructor(){}static assertion(e){return yu._fromCredential(e)}}Mg.FACTOR_ID="phone";var jR="@firebase/auth",$R="0.18.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tA=20;class nA extends Ag{constructor(){super(...arguments);this.passiveListeners=new Set,this.initPromise=new Promise(e=>{this.resolveInialized=e})}addPassiveListener(e){this.passiveListeners.add(e)}removePassiveListener(e){this.passiveListeners.delete(e)}resetRedirect(){this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1}onEvent(e){return this.resolveInialized(),this.passiveListeners.forEach(n=>n(e)),super.onEvent(e)}async initialized(){await this.initPromise}}function iA(t,e,n=null){return{type:e,eventId:n,urlResponse:null,sessionId:oA(),postBody:null,tenantId:t.tenantId,error:et(t,"no-auth-event")}}function rA(t,e){return wu()._set(Eu(t),e)}async function Lg(t){const e=await wu()._get(Eu(t));return e&&await wu()._remove(Eu(t)),e}function sA(t,e){var n,i;const r=lA(e);if(r.includes("/__/auth/callback")){const s=Ca(r),o=s.firebaseError?aA(decodeURIComponent(s.firebaseError)):null,a=(i=(n=o==null?void 0:o.code)===null||n===void 0?void 0:n.split("auth/"))===null||i===void 0?void 0:i[1],l=a?et(a):null;return l?{type:t.type,eventId:t.eventId,tenantId:t.tenantId,error:l,urlResponse:null,sessionId:null,postBody:null}:{type:t.type,eventId:t.eventId,tenantId:t.tenantId,sessionId:t.sessionId,urlResponse:r,postBody:null}}return null}function oA(){const t=[],e="1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";for(let n=0;n<tA;n++){const i=Math.floor(Math.random()*e.length);t.push(e.charAt(i))}return t.join("")}function wu(){return Et(lu)}function Eu(t){return Ti("authEvent",t.config.apiKey,t.name)}function aA(t){try{return JSON.parse(t)}catch(e){return null}}function lA(t){const e=Ca(t),n=e.link?decodeURIComponent(e.link):void 0,i=Ca(n).link,r=e.deep_link_id?decodeURIComponent(e.deep_link_id):void 0;return Ca(r).link||r||i||n||t}function Ca(t){if(!(t==null?void 0:t.includes("?")))return{};const[e,...n]=t.split("?");return Xi(n.join("?"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mA=1e3;function Ta(){var t;return((t=self==null?void 0:self.location)===null||t===void 0?void 0:t.protocol)||null}function gA(){return Ta()==="http:"||Ta()==="https:"}function Fg(t=Le()){return!!((Ta()==="file:"||Ta()==="ionic:")&&t.toLowerCase().match(/iphone|ipad|ipod|android/))}function _A(){return go()||lf()}function vA(){return uf()&&(document==null?void 0:document.documentMode)===11}function yA(t=Le()){return/Edge\/\d+/.test(t)}function wA(t=Le()){return vA()||yA(t)}function Ug(){try{const t=self.localStorage,e=Rs();if(t)return t.setItem(e,"1"),t.removeItem(e),wA()?Ml():!0}catch(t){return Iu()&&Ml()}return!1}function Iu(){return typeof global!="undefined"&&"WorkerGlobalScope"in global&&"importScripts"in global}function bu(){return(gA()||cf()||Fg())&&!_A()&&Ug()&&!Iu()}function Vg(){return Fg()&&typeof document!="undefined"}async function EA(){return Vg()?new Promise(t=>{const e=setTimeout(()=>{t(!1)},mA);document.addEventListener("deviceready",()=>{clearTimeout(e),t(!0)})}):!1}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const It={LOCAL:"local",NONE:"none",SESSION:"session"},ks=N,Wg="persistence";function IA(t,e){if(ks(Object.values(It).includes(e),t,"invalid-persistence-type"),go()){ks(e!==It.SESSION,t,"unsupported-persistence-type");return}if(lf()){ks(e===It.NONE,t,"unsupported-persistence-type");return}if(Iu()){ks(e===It.NONE||e===It.LOCAL&&Ml(),t,"unsupported-persistence-type");return}ks(e===It.NONE||Ug(),t,"unsupported-persistence-type")}async function Cu(t){await t._initializationPromise;const e=Bg(),n=Ti(Wg,t.config.apiKey,t.name);(e==null?void 0:e.sessionStorage)&&e.sessionStorage.setItem(n,t._getPersistence())}function bA(t,e){const n=Bg();if(!(n==null?void 0:n.sessionStorage))return[];const i=Ti(Wg,t,e);switch(n.sessionStorage.getItem(i)){case It.NONE:return[Cs];case It.LOCAL:return[ya,Ai];case It.SESSION:return[Ai];default:return[]}}function Bg(){return typeof window!="undefined"?window:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wn{constructor(e){this._delegate=e,this.multiFactor=f0(e)}static getOrCreate(e){return wn.USER_MAP.has(e)||wn.USER_MAP.set(e,new wn(e)),wn.USER_MAP.get(e)}delete(){return this._delegate.delete()}reload(){return this._delegate.reload()}toJSON(){return this._delegate.toJSON()}getIdTokenResult(e){return this._delegate.getIdTokenResult(e)}getIdToken(e){return this._delegate.getIdToken(e)}linkAndRetrieveDataWithCredential(e){return this.linkWithCredential(e)}async linkWithCredential(e){return pt(this.auth,cg(this._delegate,e))}async linkWithPhoneNumber(e,n){return Tu(this.auth,q0(this._delegate,e,n))}async linkWithPopup(e){return pt(this.auth,tR(this._delegate,e,$n))}async linkWithRedirect(e){return await Cu(Ye(this.auth)),uR(this._delegate,e,$n)}reauthenticateAndRetrieveDataWithCredential(e){return this.reauthenticateWithCredential(e)}async reauthenticateWithCredential(e){return pt(this.auth,ug(this._delegate,e))}reauthenticateWithPhoneNumber(e,n){return Tu(this.auth,G0(this._delegate,e,n))}reauthenticateWithPopup(e){return pt(this.auth,eR(this._delegate,e,$n))}async reauthenticateWithRedirect(e){return await Cu(Ye(this.auth)),lR(this._delegate,e,$n)}sendEmailVerification(e){return JS(this._delegate,e)}async unlink(e){return await FS(this._delegate,e),this}updateEmail(e){return t0(this._delegate,e)}updatePassword(e){return n0(this._delegate,e)}updatePhoneNumber(e){return K0(this._delegate,e)}updateProfile(e){return e0(this._delegate,e)}verifyBeforeUpdateEmail(e,n){return XS(this._delegate,e,n)}get emailVerified(){return this._delegate.emailVerified}get isAnonymous(){return this._delegate.isAnonymous}get metadata(){return this._delegate.metadata}get phoneNumber(){return this._delegate.phoneNumber}get providerData(){return this._delegate.providerData}get refreshToken(){return this._delegate.refreshToken}get tenantId(){return this._delegate.tenantId}get displayName(){return this._delegate.displayName}get email(){return this._delegate.email}get photoURL(){return this._delegate.photoURL}get providerId(){return this._delegate.providerId}get uid(){return this._delegate.uid}get auth(){return this._delegate.auth}}wn.USER_MAP=new WeakMap;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ns=N;class Su{constructor(e,n){if(this.app=e,n.isInitialized()){this._delegate=n.getImmediate(),this.linkUnderlyingAuth();return}const{apiKey:i}=e.options;Ns(i,"invalid-api-key",{appName:e.name});let r=[Cs];if(typeof window!="undefined"){r=bA(i,e.name);for(const o of[ya,lu,Ai])r.includes(o)||r.push(o)}Ns(i,"invalid-api-key",{appName:e.name});const s=typeof window!="undefined"?$n:void 0;this._delegate=n.initialize({options:{persistence:r,popupRedirectResolver:s}}),this._delegate._updateErrorMap(qT),this.linkUnderlyingAuth()}get emulatorConfig(){return this._delegate.emulatorConfig}get currentUser(){return this._delegate.currentUser?wn.getOrCreate(this._delegate.currentUser):null}get languageCode(){return this._delegate.languageCode}set languageCode(e){this._delegate.languageCode=e}get settings(){return this._delegate.settings}get tenantId(){return this._delegate.tenantId}set tenantId(e){this._delegate.tenantId=e}useDeviceLanguage(){this._delegate.useDeviceLanguage()}signOut(){return this._delegate.signOut()}useEmulator(e,n){gS(this._delegate,e,n)}applyActionCode(e){return jS(this._delegate,e)}checkActionCode(e){return dg(this._delegate,e)}confirmPasswordReset(e,n){return BS(this._delegate,e,n)}async createUserWithEmailAndPassword(e,n){return pt(this._delegate,HS(this._delegate,e,n))}fetchProvidersForEmail(e){return this.fetchSignInMethodsForEmail(e)}fetchSignInMethodsForEmail(e){return QS(this._delegate,e)}isSignInWithEmailLink(e){return GS(this._delegate,e)}async getRedirectResult(){Ns(bu(),this._delegate,"operation-not-supported-in-this-environment");const e=await hR(this._delegate,$n);return e?pt(this._delegate,Promise.resolve(e)):{credential:null,user:null}}addFrameworkForLogging(e){hA(this._delegate,e)}onAuthStateChanged(e,n,i){const{next:r,error:s,complete:o}=Hg(e,n,i);return this._delegate.onAuthStateChanged(r,s,o)}onIdTokenChanged(e,n,i){const{next:r,error:s,complete:o}=Hg(e,n,i);return this._delegate.onIdTokenChanged(r,s,o)}sendSignInLinkToEmail(e,n){return qS(this._delegate,e,n)}sendPasswordResetEmail(e,n){return WS(this._delegate,e,n||void 0)}async setPersistence(e){IA(this._delegate,e);let n;switch(e){case It.SESSION:n=Ai;break;case It.LOCAL:n=await Et(ya)._isAvailable()?ya:lu;break;case It.NONE:n=Cs;break;default:return Ze("argument-error",{appName:this._delegate.name})}return this._delegate.setPersistence(n)}signInAndRetrieveDataWithCredential(e){return this.signInWithCredential(e)}signInAnonymously(){return pt(this._delegate,DS(this._delegate))}signInWithCredential(e){return pt(this._delegate,ha(this._delegate,e))}signInWithCustomToken(e){return pt(this._delegate,VS(this._delegate,e))}signInWithEmailAndPassword(e,n){return pt(this._delegate,zS(this._delegate,e,n))}signInWithEmailLink(e,n){return pt(this._delegate,KS(this._delegate,e,n))}signInWithPhoneNumber(e,n){return Tu(this._delegate,z0(this._delegate,e,n))}async signInWithPopup(e){return Ns(bu(),this._delegate,"operation-not-supported-in-this-environment"),pt(this._delegate,Z0(this._delegate,e,$n))}async signInWithRedirect(e){return Ns(bu(),this._delegate,"operation-not-supported-in-this-environment"),await Cu(this._delegate),oR(this._delegate,e,$n)}updateCurrentUser(e){return this._delegate.updateCurrentUser(e)}verifyPasswordResetCode(e){return $S(this._delegate,e)}unwrap(){return this._delegate}_delete(){return this._delegate._delete()}linkUnderlyingAuth(){this._delegate.wrapped=()=>this}}Su.Persistence=It;function Hg(t,e,n){let i=t;typeof t!="function"&&({next:i,error:e,complete:n}=t);const r=i;return{next:o=>r(o&&wn.getOrCreate(o)),error:e,complete:n}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ru{constructor(){this.providerId="phone",this._delegate=new jt(jg(qr.auth()))}static credential(e,n){return jt.credential(e,n)}verifyPhoneNumber(e,n){return this._delegate.verifyPhoneNumber(e,n)}unwrap(){return this._delegate}}Ru.PHONE_SIGN_IN_METHOD=jt.PHONE_SIGN_IN_METHOD;Ru.PROVIDER_ID=jt.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PA="auth-compat";function OA(t){t.INTERNAL.registerComponent(new Qt(PA,e=>{const n=e.getProvider("app-compat").getImmediate(),i=e.getProvider("auth");return new Su(n,i)},"PUBLIC").setServiceProps({ActionCodeInfo:{Operation:{EMAIL_SIGNIN:hr.EMAIL_SIGNIN,PASSWORD_RESET:hr.PASSWORD_RESET,RECOVER_EMAIL:hr.RECOVER_EMAIL,REVERT_SECOND_FACTOR_ADDITION:hr.REVERT_SECOND_FACTOR_ADDITION,VERIFY_AND_CHANGE_EMAIL:hr.VERIFY_AND_CHANGE_EMAIL,VERIFY_EMAIL:hr.VERIFY_EMAIL}},EmailAuthProvider:Bn,FacebookAuthProvider:rn,GithubAuthProvider:on,GoogleAuthProvider:sn,OAuthProvider:vr,PhoneAuthProvider:Ru,PhoneMultiFactorGenerator:Mg,RecaptchaVerifier:NA,TwitterAuthProvider:an,Auth:Su,AuthCredential:gr,Error:St}).setInstantiationMode("LAZY").setMultipleInstances(!1)),t.registerVersion(fA,pA)}OA(qr);/*!
  * vue-router v4.0.11
  * (c) 2021 Eduardo San Martin Morote
  * @license MIT
  */const zg=typeof Symbol=="function"&&typeof Symbol.toStringTag=="symbol",wr=t=>zg?Symbol(t):"_vr_"+t,xA=wr("rvlm"),qg=wr("rvd"),Au=wr("r"),Gg=wr("rl"),ku=wr("rvl"),Er=typeof window!="undefined";function MA(t){return t.__esModule||zg&&t[Symbol.toStringTag]==="Module"}const Ce=Object.assign;function Nu(t,e){const n={};for(const i in e){const r=e[i];n[i]=Array.isArray(r)?r.map(t):t(r)}return n}const Ps=()=>{},LA=/\/$/,DA=t=>t.replace(LA,"");function Pu(t,e,n="/"){let i,r={},s="",o="";const a=e.indexOf("?"),l=e.indexOf("#",a>-1?a:0);return a>-1&&(i=e.slice(0,a),s=e.slice(a+1,l>-1?l:e.length),r=t(s)),l>-1&&(i=i||e.slice(0,l),o=e.slice(l,e.length)),i=WA(i!=null?i:e,n),{fullPath:i+(s&&"?")+s+o,path:i,query:r,hash:o}}function FA(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Kg(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function UA(t,e,n){const i=e.matched.length-1,r=n.matched.length-1;return i>-1&&i===r&&Ir(e.matched[i],n.matched[r])&&Yg(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Ir(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Yg(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!VA(t[n],e[n]))return!1;return!0}function VA(t,e){return Array.isArray(t)?Qg(t,e):Array.isArray(e)?Qg(e,t):t===e}function Qg(t,e){return Array.isArray(e)?t.length===e.length&&t.every((n,i)=>n===e[i]):t.length===1&&t[0]===e}function WA(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),i=t.split("/");let r=n.length-1,s,o;for(s=0;s<i.length;s++)if(o=i[s],!(r===1||o==="."))if(o==="..")r--;else break;return n.slice(0,r).join("/")+"/"+i.slice(s-(s===i.length?1:0)).join("/")}var Os;(function(t){t.pop="pop",t.push="push"})(Os||(Os={}));var xs;(function(t){t.back="back",t.forward="forward",t.unknown=""})(xs||(xs={}));function BA(t){if(!t)if(Er){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),DA(t)}const jA=/^[^#]+#/;function $A(t,e){return t.replace(jA,"#")+e}function HA(t,e){const n=document.documentElement.getBoundingClientRect(),i=t.getBoundingClientRect();return{behavior:e.behavior,left:i.left-n.left-(e.left||0),top:i.top-n.top-(e.top||0)}}const Sa=()=>({left:window.pageXOffset,top:window.pageYOffset});function zA(t){let e;if("el"in t){const n=t.el,i=typeof n=="string"&&n.startsWith("#"),r=typeof n=="string"?i?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!r)return;e=HA(r,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Jg(t,e){return(history.state?history.state.position-e:-1)+t}const Ou=new Map;function qA(t,e){Ou.set(t,e)}function GA(t){const e=Ou.get(t);return Ou.delete(t),e}let KA=()=>location.protocol+"//"+location.host;function Xg(t,e){const{pathname:n,search:i,hash:r}=e,s=t.indexOf("#");if(s>-1){let a=r.includes(t.slice(s))?t.slice(s).length:1,l=r.slice(a);return l[0]!=="/"&&(l="/"+l),Kg(l,"")}return Kg(n,t)+i+r}function YA(t,e,n,i){let r=[],s=[],o=null;const a=({state:h})=>{const p=Xg(t,location),g=n.value,R=e.value;let I=0;if(h){if(n.value=p,e.value=h,o&&o===g){o=null;return}I=R?h.position-R.position:0}else i(p);r.forEach(y=>{y(n.value,g,{delta:I,type:Os.pop,direction:I?I>0?xs.forward:xs.back:xs.unknown})})};function l(){o=n.value}function c(h){r.push(h);const p=()=>{const g=r.indexOf(h);g>-1&&r.splice(g,1)};return s.push(p),p}function u(){const{history:h}=window;!h.state||h.replaceState(Ce({},h.state,{scroll:Sa()}),"")}function d(){for(const h of s)h();s=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",u),{pauseListeners:l,listen:c,destroy:d}}function Zg(t,e,n,i=!1,r=!1){return{back:t,current:e,forward:n,replaced:i,position:window.history.length,scroll:r?Sa():null}}function QA(t){const{history:e,location:n}=window,i={value:Xg(t,n)},r={value:e.state};r.value||s(i.value,{back:null,current:i.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function s(l,c,u){const d=t.indexOf("#"),h=d>-1?(n.host&&document.querySelector("base")?t:t.slice(d))+l:KA()+t+l;try{e[u?"replaceState":"pushState"](c,"",h),r.value=c}catch(p){console.error(p),n[u?"replace":"assign"](h)}}function o(l,c){const u=Ce({},e.state,Zg(r.value.back,l,r.value.forward,!0),c,{position:r.value.position});s(l,u,!0),i.value=l}function a(l,c){const u=Ce({},r.value,e.state,{forward:l,scroll:Sa()});s(u.current,u,!0);const d=Ce({},Zg(i.value,l,null),{position:u.position+1},c);s(l,d,!1),i.value=l}return{location:i,state:r,push:a,replace:o}}function FN(t){t=BA(t);const e=QA(t),n=YA(t,e.state,e.location,e.replace);function i(s,o=!0){o||n.pauseListeners(),history.go(s)}const r=Ce({location:"",base:t,go:i,createHref:$A.bind(null,t)},e,n);return Object.defineProperty(r,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(r,"state",{enumerable:!0,get:()=>e.state.value}),r}function JA(t){return typeof t=="string"||t&&typeof t=="object"}function e_(t){return typeof t=="string"||typeof t=="symbol"}const Hn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},t_=wr("nf");var n_;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(n_||(n_={}));function br(t,e){return Ce(new Error,{type:t,[t_]:!0},e)}function Pi(t,e){return t instanceof Error&&t_ in t&&(e==null||!!(t.type&e))}const i_="[^/]+?",XA={sensitive:!1,strict:!1,start:!0,end:!0},ZA=/[.+*?^${}()[\]/\\]/g;function ek(t,e){const n=Ce({},XA,e),i=[];let r=n.start?"^":"";const s=[];for(const c of t){const u=c.length?[]:[90];n.strict&&!c.length&&(r+="/");for(let d=0;d<c.length;d++){const h=c[d];let p=40+(n.sensitive?.25:0);if(h.type===0)d||(r+="/"),r+=h.value.replace(ZA,"\\$&"),p+=40;else if(h.type===1){const{value:g,repeatable:R,optional:I,regexp:y}=h;s.push({name:g,repeatable:R,optional:I});const T=y||i_;if(T!==i_){p+=10;try{new RegExp(`(${T})`)}catch(D){throw new Error(`Invalid custom RegExp for param "${g}" (${T}): `+D.message)}}let M=R?`((?:${T})(?:/(?:${T}))*)`:`(${T})`;d||(M=I&&c.length<2?`(?:/${M})`:"/"+M),I&&(M+="?"),r+=M,p+=20,I&&(p+=-8),R&&(p+=-20),T===".*"&&(p+=-50)}u.push(p)}i.push(u)}if(n.strict&&n.end){const c=i.length-1;i[c][i[c].length-1]+=.7000000000000001}n.strict||(r+="/?"),n.end?r+="$":n.strict&&(r+="(?:/|$)");const o=new RegExp(r,n.sensitive?"":"i");function a(c){const u=c.match(o),d={};if(!u)return null;for(let h=1;h<u.length;h++){const p=u[h]||"",g=s[h-1];d[g.name]=p&&g.repeatable?p.split("/"):p}return d}function l(c){let u="",d=!1;for(const h of t){(!d||!u.endsWith("/"))&&(u+="/"),d=!1;for(const p of h)if(p.type===0)u+=p.value;else if(p.type===1){const{value:g,repeatable:R,optional:I}=p,y=g in c?c[g]:"";if(Array.isArray(y)&&!R)throw new Error(`Provided param "${g}" is an array but it is not repeatable (* or + modifiers)`);const T=Array.isArray(y)?y.join("/"):y;if(!T)if(I)h.length<2&&(u.endsWith("/")?u=u.slice(0,-1):d=!0);else throw new Error(`Missing required param "${g}"`);u+=T}}return u}return{re:o,score:i,keys:s,parse:a,stringify:l}}function tk(t,e){let n=0;for(;n<t.length&&n<e.length;){const i=e[n]-t[n];if(i)return i;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function nk(t,e){let n=0;const i=t.score,r=e.score;for(;n<i.length&&n<r.length;){const s=tk(i[n],r[n]);if(s)return s;n++}return r.length-i.length}const ik={type:0,value:""},rk=/[a-zA-Z0-9_]/;function sk(t){if(!t)return[[]];if(t==="/")return[[ik]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(p){throw new Error(`ERR (${n})/"${c}": ${p}`)}let n=0,i=n;const r=[];let s;function o(){s&&r.push(s),s=[]}let a=0,l,c="",u="";function d(){!c||(n===0?s.push({type:0,value:c}):n===1||n===2||n===3?(s.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),s.push({type:1,value:c,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function h(){c+=l}for(;a<t.length;){if(l=t[a++],l==="\\"&&n!==2){i=n,n=4;continue}switch(n){case 0:l==="/"?(c&&d(),o()):l===":"?(d(),n=1):h();break;case 4:h(),n=i;break;case 1:l==="("?n=2:rk.test(l)?h():(d(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:n=3:u+=l;break;case 3:d(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,u="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${c}"`),d(),o(),r}function ok(t,e,n){const i=ek(sk(t.path),n),r=Ce(i,{record:t,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function ak(t,e){const n=[],i=new Map;e=s_({strict:!1,end:!0,sensitive:!1},e);function r(u){return i.get(u)}function s(u,d,h){const p=!h,g=ck(u);g.aliasOf=h&&h.record;const R=s_(e,u),I=[g];if("alias"in u){const M=typeof u.alias=="string"?[u.alias]:u.alias;for(const D of M)I.push(Ce({},g,{components:h?h.record.components:g.components,path:D,aliasOf:h?h.record:g}))}let y,T;for(const M of I){const{path:D}=M;if(d&&D[0]!=="/"){const B=d.record.path,X=B[B.length-1]==="/"?"":"/";M.path=d.record.path+(D&&X+D)}if(y=ok(M,d,R),h?h.alias.push(y):(T=T||y,T!==y&&T.alias.push(y),p&&u.name&&!r_(y)&&o(u.name)),"children"in g){const B=g.children;for(let X=0;X<B.length;X++)s(B[X],y,h&&h.children[X])}h=h||y,l(y)}return T?()=>{o(T)}:Ps}function o(u){if(e_(u)){const d=i.get(u);d&&(i.delete(u),n.splice(n.indexOf(d),1),d.children.forEach(o),d.alias.forEach(o))}else{const d=n.indexOf(u);d>-1&&(n.splice(d,1),u.record.name&&i.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return n}function l(u){let d=0;for(;d<n.length&&nk(u,n[d])>=0;)d++;n.splice(d,0,u),u.record.name&&!r_(u)&&i.set(u.record.name,u)}function c(u,d){let h,p={},g,R;if("name"in u&&u.name){if(h=i.get(u.name),!h)throw br(1,{location:u});R=h.record.name,p=Ce(lk(d.params,h.keys.filter(T=>!T.optional).map(T=>T.name)),u.params),g=h.stringify(p)}else if("path"in u)g=u.path,h=n.find(T=>T.re.test(g)),h&&(p=h.parse(g),R=h.record.name);else{if(h=d.name?i.get(d.name):n.find(T=>T.re.test(d.path)),!h)throw br(1,{location:u,currentLocation:d});R=h.record.name,p=Ce({},d.params,u.params),g=h.stringify(p)}const I=[];let y=h;for(;y;)I.unshift(y.record),y=y.parent;return{name:R,path:g,params:p,matched:I,meta:dk(I)}}return t.forEach(u=>s(u)),{addRoute:s,resolve:c,removeRoute:o,getRoutes:a,getRecordMatcher:r}}function lk(t,e){const n={};for(const i of e)i in t&&(n[i]=t[i]);return n}function ck(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:uk(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||{}:{default:t.component}}}function uk(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const i in t.components)e[i]=typeof n=="boolean"?n:n[i];return e}function r_(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function dk(t){return t.reduce((e,n)=>Ce(e,n.meta),{})}function s_(t,e){const n={};for(const i in t)n[i]=i in e?e[i]:t[i];return n}const o_=/#/g,hk=/&/g,fk=/\//g,pk=/=/g,mk=/\?/g,a_=/\+/g,gk=/%5B/g,_k=/%5D/g,l_=/%5E/g,vk=/%60/g,c_=/%7B/g,yk=/%7C/g,u_=/%7D/g,wk=/%20/g;function xu(t){return encodeURI(""+t).replace(yk,"|").replace(gk,"[").replace(_k,"]")}function Ek(t){return xu(t).replace(c_,"{").replace(u_,"}").replace(l_,"^")}function Mu(t){return xu(t).replace(a_,"%2B").replace(wk,"+").replace(o_,"%23").replace(hk,"%26").replace(vk,"`").replace(c_,"{").replace(u_,"}").replace(l_,"^")}function Ik(t){return Mu(t).replace(pk,"%3D")}function bk(t){return xu(t).replace(o_,"%23").replace(mk,"%3F")}function Ck(t){return t==null?"":bk(t).replace(fk,"%2F")}function Ra(t){try{return decodeURIComponent(""+t)}catch(e){}return""+t}function Tk(t){const e={};if(t===""||t==="?")return e;const i=(t[0]==="?"?t.slice(1):t).split("&");for(let r=0;r<i.length;++r){const s=i[r].replace(a_," "),o=s.indexOf("="),a=Ra(o<0?s:s.slice(0,o)),l=o<0?null:Ra(s.slice(o+1));if(a in e){let c=e[a];Array.isArray(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function d_(t){let e="";for(let n in t){const i=t[n];if(n=Ik(n),i==null){i!==void 0&&(e+=(e.length?"&":"")+n);continue}(Array.isArray(i)?i.map(s=>s&&Mu(s)):[i&&Mu(i)]).forEach(s=>{s!==void 0&&(e+=(e.length?"&":"")+n,s!=null&&(e+="="+s))})}return e}function Sk(t){const e={};for(const n in t){const i=t[n];i!==void 0&&(e[n]=Array.isArray(i)?i.map(r=>r==null?null:""+r):i==null?i:""+i)}return e}function Ms(){let t=[];function e(i){return t.push(i),()=>{const r=t.indexOf(i);r>-1&&t.splice(r,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function zn(t,e,n,i,r){const s=i&&(i.enterCallbacks[r]=i.enterCallbacks[r]||[]);return()=>new Promise((o,a)=>{const l=d=>{d===!1?a(br(4,{from:n,to:e})):d instanceof Error?a(d):JA(d)?a(br(2,{from:e,to:d})):(s&&i.enterCallbacks[r]===s&&typeof d=="function"&&s.push(d),o())},c=t.call(i&&i.instances[r],e,n,l);let u=Promise.resolve(c);t.length<3&&(u=u.then(l)),u.catch(d=>a(d))})}function Lu(t,e,n,i){const r=[];for(const s of t)for(const o in s.components){let a=s.components[o];if(!(e!=="beforeRouteEnter"&&!s.instances[o]))if(Rk(a)){const c=(a.__vccOpts||a)[e];c&&r.push(zn(c,n,i,s,o))}else{let l=a();r.push(()=>l.then(c=>{if(!c)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${s.path}"`));const u=MA(c)?c.default:c;s.components[o]=u;const h=(u.__vccOpts||u)[e];return h&&zn(h,n,i,s,o)()}))}}return r}function Rk(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function h_(t){const e=zt(Au),n=zt(Gg),i=ye(()=>e.resolve(z(t.to))),r=ye(()=>{const{matched:l}=i.value,{length:c}=l,u=l[c-1],d=n.matched;if(!u||!d.length)return-1;const h=d.findIndex(Ir.bind(null,u));if(h>-1)return h;const p=f_(l[c-2]);return c>1&&f_(u)===p&&d[d.length-1].path!==p?d.findIndex(Ir.bind(null,l[c-2])):h}),s=ye(()=>r.value>-1&&Pk(n.params,i.value.params)),o=ye(()=>r.value>-1&&r.value===n.matched.length-1&&Yg(n.params,i.value.params));function a(l={}){return Nk(l)?e[z(t.replace)?"replace":"push"](z(t.to)).catch(Ps):Promise.resolve()}return{route:i,href:ye(()=>i.value.href),isActive:s,isExactActive:o,navigate:a}}const Ak=Wi({name:"RouterLink",props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:h_,setup(t,{slots:e}){const n=Cn(h_(t)),{options:i}=zt(Au),r=ye(()=>({[p_(t.activeClass,i.linkActiveClass,"router-link-active")]:n.isActive,[p_(t.exactActiveClass,i.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const s=e.default&&e.default(n);return t.custom?s:ii("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:r.value},s)}}}),kk=Ak;function Nk(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function Pk(t,e){for(const n in e){const i=e[n],r=t[n];if(typeof i=="string"){if(i!==r)return!1}else if(!Array.isArray(r)||r.length!==i.length||i.some((s,o)=>s!==r[o]))return!1}return!0}function f_(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const p_=(t,e,n)=>t!=null?t:e!=null?e:n,Ok=Wi({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},setup(t,{attrs:e,slots:n}){const i=zt(ku),r=ye(()=>t.route||i.value),s=zt(qg,0),o=ye(()=>r.value.matched[s]);Vi(qg,s+1),Vi(xA,o),Vi(ku,r);const a=Mt();return lt(()=>[a.value,o.value,t.name],([l,c,u],[d,h,p])=>{c&&(c.instances[u]=l,h&&h!==c&&l&&l===d&&(c.leaveGuards.size||(c.leaveGuards=h.leaveGuards),c.updateGuards.size||(c.updateGuards=h.updateGuards))),l&&c&&(!h||!Ir(c,h)||!d)&&(c.enterCallbacks[u]||[]).forEach(g=>g(l))},{flush:"post"}),()=>{const l=r.value,c=o.value,u=c&&c.components[t.name],d=t.name;if(!u)return m_(n.default,{Component:u,route:l});const h=c.props[t.name],p=h?h===!0?l.params:typeof h=="function"?h(l):h:null,R=ii(u,Ce({},p,e,{onVnodeUnmounted:I=>{I.component.isUnmounted&&(c.instances[d]=null)},ref:a}));return m_(n.default,{Component:R,route:l})||R}}});function m_(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const xk=Ok;function UN(t){const e=ak(t.routes,t),n=t.parseQuery||Tk,i=t.stringifyQuery||d_,r=t.history,s=Ms(),o=Ms(),a=Ms(),l=yv(Hn);let c=Hn;Er&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Nu.bind(null,E=>""+E),d=Nu.bind(null,Ck),h=Nu.bind(null,Ra);function p(E,$){let L,G;return e_(E)?(L=e.getRecordMatcher(E),G=$):G=E,e.addRoute(G,L)}function g(E){const $=e.getRecordMatcher(E);$&&e.removeRoute($)}function R(){return e.getRoutes().map(E=>E.record)}function I(E){return!!e.getRecordMatcher(E)}function y(E,$){if($=Ce({},$||l.value),typeof E=="string"){const x=Pu(n,E,$.path),f=e.resolve({path:x.path},$),m=r.createHref(x.fullPath);return Ce(x,f,{params:h(f.params),hash:Ra(x.hash),redirectedFrom:void 0,href:m})}let L;if("path"in E)L=Ce({},E,{path:Pu(n,E.path,$.path).path});else{const x=Ce({},E.params);for(const f in x)x[f]==null&&delete x[f];L=Ce({},E,{params:d(E.params)}),$.params=d($.params)}const G=e.resolve(L,$),v=E.hash||"";G.params=u(h(G.params));const C=FA(i,Ce({},E,{hash:Ek(v),path:G.path})),F=r.createHref(C);return Ce({fullPath:C,hash:v,query:i===d_?Sk(E.query):E.query||{}},G,{redirectedFrom:void 0,href:F})}function T(E){return typeof E=="string"?Pu(n,E,l.value.path):Ce({},E)}function M(E,$){if(c!==E)return br(8,{from:$,to:E})}function D(E){return q(E)}function B(E){return D(Ce(T(E),{replace:!0}))}function X(E){const $=E.matched[E.matched.length-1];if($&&$.redirect){const{redirect:L}=$;let G=typeof L=="function"?L(E):L;return typeof G=="string"&&(G=G.includes("?")||G.includes("#")?G=T(G):{path:G},G.params={}),Ce({query:E.query,hash:E.hash,params:E.params},G)}}function q(E,$){const L=c=y(E),G=l.value,v=E.state,C=E.force,F=E.replace===!0,x=X(L);if(x)return q(Ce(T(x),{state:v,force:C,replace:F}),$||L);const f=L;f.redirectedFrom=$;let m;return!C&&UA(i,G,L)&&(m=br(16,{to:f,from:G}),me(G,G,!0,!1)),(m?Promise.resolve(m):j(f,G)).catch(_=>Pi(_)?_:le(_,f,G)).then(_=>{if(_){if(Pi(_,2))return q(Ce(T(_.to),{state:v,force:C,replace:F}),$||f)}else _=ce(f,G,!0,F,v);return ie(f,G,_),_})}function te(E,$){const L=M(E,$);return L?Promise.reject(L):Promise.resolve()}function j(E,$){let L;const[G,v,C]=Mk(E,$);L=Lu(G.reverse(),"beforeRouteLeave",E,$);for(const x of G)x.leaveGuards.forEach(f=>{L.push(zn(f,E,$))});const F=te.bind(null,E,$);return L.push(F),Cr(L).then(()=>{L=[];for(const x of s.list())L.push(zn(x,E,$));return L.push(F),Cr(L)}).then(()=>{L=Lu(v,"beforeRouteUpdate",E,$);for(const x of v)x.updateGuards.forEach(f=>{L.push(zn(f,E,$))});return L.push(F),Cr(L)}).then(()=>{L=[];for(const x of E.matched)if(x.beforeEnter&&!$.matched.includes(x))if(Array.isArray(x.beforeEnter))for(const f of x.beforeEnter)L.push(zn(f,E,$));else L.push(zn(x.beforeEnter,E,$));return L.push(F),Cr(L)}).then(()=>(E.matched.forEach(x=>x.enterCallbacks={}),L=Lu(C,"beforeRouteEnter",E,$),L.push(F),Cr(L))).then(()=>{L=[];for(const x of o.list())L.push(zn(x,E,$));return L.push(F),Cr(L)}).catch(x=>Pi(x,8)?x:Promise.reject(x))}function ie(E,$,L){for(const G of a.list())G(E,$,L)}function ce(E,$,L,G,v){const C=M(E,$);if(C)return C;const F=$===Hn,x=Er?history.state:{};L&&(G||F?r.replace(E.fullPath,Ce({scroll:F&&x&&x.scroll},v)):r.push(E.fullPath,v)),l.value=E,me(E,$,L,F),U()}let W;function de(){W=r.listen((E,$,L)=>{const G=y(E),v=X(G);if(v){q(Ce(v,{replace:!0}),G).catch(Ps);return}c=G;const C=l.value;Er&&qA(Jg(C.fullPath,L.delta),Sa()),j(G,C).catch(F=>Pi(F,4|8)?F:Pi(F,2)?(q(F.to,G).then(x=>{Pi(x,4|16)&&!L.delta&&L.type===Os.pop&&r.go(-1,!1)}).catch(Ps),Promise.reject()):(L.delta&&r.go(-L.delta,!1),le(F,G,C))).then(F=>{F=F||ce(G,C,!1),F&&(L.delta?r.go(-L.delta,!1):L.type===Os.pop&&Pi(F,4|16)&&r.go(-1,!1)),ie(G,C,F)}).catch(Ps)})}let ke=Ms(),tt=Ms(),he;function le(E,$,L){U(E);const G=tt.list();return G.length?G.forEach(v=>v(E,$,L)):console.error(E),Promise.reject(E)}function ue(){return he&&l.value!==Hn?Promise.resolve():new Promise((E,$)=>{ke.add([E,$])})}function U(E){he||(he=!0,de(),ke.list().forEach(([$,L])=>E?L(E):$()),ke.reset())}function me(E,$,L,G){const{scrollBehavior:v}=t;if(!Er||!v)return Promise.resolve();const C=!L&&GA(Jg(E.fullPath,0))||(G||!L)&&history.state&&history.state.scroll||null;return zi().then(()=>v(E,$,C)).then(F=>F&&zA(F)).catch(F=>le(F,E,$))}const Re=E=>r.go(E);let it;const De=new Set;return{currentRoute:l,addRoute:p,removeRoute:g,hasRoute:I,getRoutes:R,resolve:y,options:t,push:D,replace:B,go:Re,back:()=>Re(-1),forward:()=>Re(1),beforeEach:s.add,beforeResolve:o.add,afterEach:a.add,onError:tt.add,isReady:ue,install(E){const $=this;E.component("RouterLink",kk),E.component("RouterView",xk),E.config.globalProperties.$router=$,Object.defineProperty(E.config.globalProperties,"$route",{enumerable:!0,get:()=>z(l)}),Er&&!it&&l.value===Hn&&(it=!0,D(r.location).catch(v=>{}));const L={};for(const v in Hn)L[v]=ye(()=>l.value[v]);E.provide(Au,$),E.provide(Gg,Cn(L)),E.provide(ku,l);const G=E.unmount;De.add(E),E.unmount=function(){De.delete(E),De.size<1&&(c=Hn,W&&W(),l.value=Hn,it=!1,he=!1),G()}}}}function Cr(t){return t.reduce((e,n)=>e.then(()=>n()),Promise.resolve())}function Mk(t,e){const n=[],i=[],r=[],s=Math.max(e.matched.length,t.matched.length);for(let o=0;o<s;o++){const a=e.matched[o];a&&(t.matched.find(c=>Ir(c,a))?i.push(a):n.push(a));const l=t.matched[o];l&&(e.matched.find(c=>Ir(c,l))||r.push(l))}return[n,i,r]}/**
  * vee-validate v4.5.2
  * (c) 2021 Abdelrahman Awad
  * @license MIT
  */function Oi(t){return typeof t=="function"}function Aa(t){return t==null}const Tr=t=>t!==null&&!!t&&typeof t=="object"&&!Array.isArray(t);function g_(t){return Number(t)>=0}function Lk(t){const e=parseFloat(t);return isNaN(e)?t:e}const __={};function VN(t,e){Fk(t,e),__[t]=e}function Dk(t){return __[t]}function Fk(t,e){if(!Oi(e))throw new Error(`Extension Error: The validator '${t}' must be a function.`)}const xi=Symbol("vee-validate-form"),Uk=Symbol("vee-validate-field-instance"),ka=Symbol("Default empty value");function Du(t){return Oi(t)&&!!t.__locatorRef}function Vk(t){return["input","textarea","select"].includes(t)}function Wk(t,e){return Vk(t)&&e.type==="file"}function Ls(t){return!!t&&Oi(t.validate)}function Ds(t){return t==="checkbox"||t==="radio"}function Bk(t){return Tr(t)||Array.isArray(t)}function jk(t){return Array.isArray(t)?t.length===0:Tr(t)&&Object.keys(t).length===0}function Na(t){return/^\[.+\]$/i.test(t)}function $k(t){return v_(t)&&t.multiple}function v_(t){return t.tagName==="SELECT"}function Hk(t,e){const n=![!1,null,void 0,0].includes(e.multiple)&&!Number.isNaN(e.multiple);return t==="select"&&"multiple"in e&&n}function zk(t,e){return Hk(t,e)||Wk(t,e)}function qk(t){return Fu(t)&&t.target&&"submit"in t.target}function Fu(t){return t?!!(typeof Event!="undefined"&&Oi(Event)&&t instanceof Event||t&&t.srcElement):!1}function Uu(t,e){return e in t&&t[e]!==ka}function Vu(t){return Na(t)?t.replace(/\[|\]/gi,""):t}function Qe(t,e,n){return t?Na(e)?t[Vu(e)]:(e||"").split(/\.|\[(\d+)\]/).filter(Boolean).reduce((r,s)=>Bk(r)&&s in r?r[s]:n,t):n}function Sr(t,e,n){if(Na(e)){t[Vu(e)]=n;return}const i=e.split(/\.|\[(\d+)\]/).filter(Boolean);let r=t;for(let s=0;s<i.length;s++){if(s===i.length-1){r[i[s]]=n;return}(!(i[s]in r)||Aa(r[i[s]]))&&(r[i[s]]=g_(i[s+1])?[]:{}),r=r[i[s]]}}function Wu(t,e){if(Array.isArray(t)&&g_(e)){t.splice(Number(e),1);return}Tr(t)&&delete t[e]}function Bu(t,e){if(Na(e)){delete t[Vu(e)];return}const n=e.split(/\.|\[(\d+)\]/).filter(Boolean);let i=t;for(let s=0;s<n.length;s++){if(s===n.length-1){Wu(i,n[s]);break}if(!(n[s]in i)||Aa(i[n[s]]))break;i=i[n[s]]}const r=n.map((s,o)=>Qe(t,n.slice(0,o).join(".")));for(let s=r.length-1;s>=0;s--)if(!!jk(r[s])){if(s===0){Wu(t,n[0]);continue}Wu(r[s-1],n[s-1])}}function nt(t){return Object.keys(t)}function Fs(t,e=void 0){const n=oh();return(n==null?void 0:n.provides[t])||zt(t,e)}function y_(t){fh(`[vee-validate]: ${t}`)}function ju(t,e,n){if(Array.isArray(t)){const i=[...t],r=i.indexOf(e);return r>=0?i.splice(r,1):i.push(e),i}return t===e?n:e}function Gk(t,e=0){let n=null,i=[];return function(...r){return n&&window.clearTimeout(n),n=window.setTimeout(()=>{const s=t(...r);i.forEach(o=>o(s)),i=[]},e),new Promise(s=>i.push(s))}}const Pa=(t,e,n)=>e.slots.default?typeof t=="string"||!t?e.slots.default(n()):{default:()=>{var i,r;return(r=(i=e.slots).default)===null||r===void 0?void 0:r.call(i,n())}}:e.slots.default;function $u(t){if(w_(t))return t._value}function w_(t){return"_value"in t}function Hu(t){if(!Fu(t))return t;const e=t.target;if(Ds(e.type)&&w_(e))return $u(e);if(e.type==="file"&&e.files)return Array.from(e.files);if($k(e))return Array.from(e.options).filter(n=>n.selected&&!n.disabled).map($u);if(v_(e)){const n=Array.from(e.options).find(i=>i.selected);return n?$u(n):e.value}return e.value}function E_(t){const e={};return Object.defineProperty(e,"_$$isNormalized",{value:!0,writable:!1,enumerable:!1,configurable:!1}),t?Tr(t)&&t._$$isNormalized?t:Tr(t)?Object.keys(t).reduce((n,i)=>{const r=Kk(t[i]);return t[i]!==!1&&(n[i]=I_(r)),n},e):typeof t!="string"?e:t.split("|").reduce((n,i)=>{const r=Yk(i);return r.name&&(n[r.name]=I_(r.params)),n},e):e}function Kk(t){return t===!0?[]:Array.isArray(t)||Tr(t)?t:[t]}function I_(t){const e=n=>typeof n=="string"&&n[0]==="@"?Qk(n.slice(1)):n;return Array.isArray(t)?t.map(e):t instanceof RegExp?[t]:Object.keys(t).reduce((n,i)=>(n[i]=e(t[i]),n),{})}const Yk=t=>{let e=[];const n=t.split(":")[0];return t.includes(":")&&(e=t.split(":").slice(1).join(":").split(",")),{name:n,params:e}};function Qk(t){const e=n=>Qe(n,t)||n[t];return e.__locatorRef=t,e}function Jk(t){return Array.isArray(t)?t.filter(Du):nt(t).filter(e=>Du(t[e])).map(e=>t[e])}const Xk={generateMessage:({field:t})=>`${t} is not valid.`,bails:!0,validateOnBlur:!0,validateOnChange:!0,validateOnInput:!1,validateOnModelUpdate:!0};let zu=Object.assign({},Xk);const qu=()=>zu,Zk=t=>{zu=Object.assign(Object.assign({},zu),t)},WN=Zk;async function b_(t,e,n={}){const i=n==null?void 0:n.bails,r={name:(n==null?void 0:n.name)||"{field}",rules:e,bails:i!=null?i:!0,formData:(n==null?void 0:n.values)||{}},o=(await eN(r,t)).errors;return{errors:o,valid:!o.length}}async function eN(t,e){if(Ls(t.rules))return tN(e,t.rules,{bails:t.bails});if(Oi(t.rules)){const o={field:t.name,form:t.formData,value:e},a=await t.rules(e,o),l=typeof a!="string"&&a,c=typeof a=="string"?a:C_(o);return{errors:l?[]:[c]}}const n=Object.assign(Object.assign({},t),{rules:E_(t.rules)}),i=[],r=Object.keys(n.rules),s=r.length;for(let o=0;o<s;o++){const a=r[o],l=await nN(n,e,{name:a,params:n.rules[a]});if(l.error&&(i.push(l.error),t.bails))return{errors:i}}return{errors:i}}async function tN(t,e,n){var i;return{errors:await e.validate(t,{abortEarly:(i=n.bails)!==null&&i!==void 0?i:!0}).then(()=>[]).catch(s=>{if(s.name==="ValidationError")return s.errors;throw s})}}async function nN(t,e,n){const i=Dk(n.name);if(!i)throw new Error(`No such validator '${n.name}' exists.`);const r=iN(n.params,t.formData),s={field:t.name,value:e,form:t.formData,rule:Object.assign(Object.assign({},n),{params:r})},o=await i(e,r,s);return typeof o=="string"?{error:o}:{error:o?void 0:C_(s)}}function C_(t){const e=qu().generateMessage;return e?e(t):"Field is invalid"}function iN(t,e){const n=i=>Du(i)?i(e):i;return Array.isArray(t)?t.map(n):Object.keys(t).reduce((i,r)=>(i[r]=n(t[r]),i),{})}async function rN(t,e){const n=await t.validate(e,{abortEarly:!1}).then(()=>[]).catch(s=>{if(s.name!=="ValidationError")throw s;return s.inner||[]}),i={},r={};for(const s of n){const o=s.errors;i[s.path]={valid:!o.length,errors:o},o.length&&(r[s.path]=o[0])}return{valid:!n.length,results:i,errors:r}}async function sN(t,e,n){const r=nt(t).map(async c=>{var u,d,h;const p=await b_(Qe(e,c),t[c],{name:((u=n==null?void 0:n.names)===null||u===void 0?void 0:u[c])||c,values:e,bails:(h=(d=n==null?void 0:n.bailsMap)===null||d===void 0?void 0:d[c])!==null&&h!==void 0?h:!0});return Object.assign(Object.assign({},p),{path:c})});let s=!0;const o=await Promise.all(r),a={},l={};for(const c of o)a[c.path]={valid:c.valid,errors:c.errors},c.valid||(s=!1,l[c.path]=c.errors[0]);return{valid:s,results:a,errors:l}}function T_(t,e,n){typeof n.value=="object"&&(n.value=Be(n.value)),!n.enumerable||n.get||n.set||!n.configurable||!n.writable||e==="__proto__"?Object.defineProperty(t,e,n):t[e]=n.value}function Be(t){if(typeof t!="object")return t;var e=0,n,i,r,s=Object.prototype.toString.call(t);if(s==="[object Object]"?r=Object.create(t.__proto__||null):s==="[object Array]"?r=Array(t.length):s==="[object Set]"?(r=new Set,t.forEach(function(o){r.add(Be(o))})):s==="[object Map]"?(r=new Map,t.forEach(function(o,a){r.set(Be(a),Be(o))})):s==="[object Date]"?r=new Date(+t):s==="[object RegExp]"?r=new RegExp(t.source,t.flags):s==="[object DataView]"?r=new t.constructor(Be(t.buffer)):s==="[object ArrayBuffer]"?r=t.slice(0):s.slice(-6)==="Array]"&&(r=new t.constructor(t)),r){for(i=Object.getOwnPropertySymbols(t);e<i.length;e++)T_(r,i[e],Object.getOwnPropertyDescriptor(t,i[e]));for(e=0,i=Object.getOwnPropertyNames(t);e<i.length;e++)Object.hasOwnProperty.call(r,n=i[e])&&r[n]===t[n]||T_(r,n,Object.getOwnPropertyDescriptor(t,n))}return r||t}var Oa=function t(e,n){if(e===n)return!0;if(e&&n&&typeof e=="object"&&typeof n=="object"){if(e.constructor!==n.constructor)return!1;var i,r,s;if(Array.isArray(e)){if(i=e.length,i!=n.length)return!1;for(r=i;r--!=0;)if(!t(e[r],n[r]))return!1;return!0}if(e instanceof Map&&n instanceof Map){if(e.size!==n.size)return!1;for(r of e.entries())if(!n.has(r[0]))return!1;for(r of e.entries())if(!t(r[1],n.get(r[0])))return!1;return!0}if(e instanceof Set&&n instanceof Set){if(e.size!==n.size)return!1;for(r of e.entries())if(!n.has(r[0]))return!1;return!0}if(ArrayBuffer.isView(e)&&ArrayBuffer.isView(n)){if(i=e.length,i!=n.length)return!1;for(r=i;r--!=0;)if(e[r]!==n[r])return!1;return!0}if(e.constructor===RegExp)return e.source===n.source&&e.flags===n.flags;if(e.valueOf!==Object.prototype.valueOf)return e.valueOf()===n.valueOf();if(e.toString!==Object.prototype.toString)return e.toString()===n.toString();if(s=Object.keys(e),i=s.length,i!==Object.keys(n).length)return!1;for(r=i;r--!=0;)if(!Object.prototype.hasOwnProperty.call(n,s[r]))return!1;for(r=i;r--!=0;){var o=s[r];if(!t(e[o],n[o]))return!1}return!0}return e!==e&&n!==n};let S_=0;function oN(t,e){const{value:n,initialValue:i,setInitialValue:r}=aN(t,e.modelValue,!e.standalone),{errorMessage:s,errors:o,setErrors:a}=cN(t,!e.standalone),l=lN(n,i,o),c=S_>=Number.MAX_SAFE_INTEGER?0:++S_;function u(d){var h;"value"in d&&(n.value=d.value),"errors"in d&&a(d.errors),"touched"in d&&(l.touched=(h=d.touched)!==null&&h!==void 0?h:l.touched),"initialValue"in d&&r(d.initialValue)}return{id:c,path:t,value:n,initialValue:i,meta:l,errors:o,errorMessage:s,setState:u}}function aN(t,e,n){const i=n?Fs(xi,void 0):void 0,r=Mt(z(e));function s(){return i?Qe(i.meta.value.initialValues,z(t),z(r)):z(r)}function o(u){if(!i){r.value=u;return}i.setFieldInitialValue(z(t),u)}const a=ye(s);if(!i)return{value:Mt(s()),initialValue:a,setInitialValue:o};const l=e?z(e):Qe(i.values,z(t),z(a));return i.stageInitialValue(z(t),l),{value:ye({get(){return Qe(i.values,z(t))},set(u){i.setFieldValue(z(t),u)}}),initialValue:a,setInitialValue:o}}function lN(t,e,n){const i=Cn({touched:!1,pending:!1,valid:!0,validated:!!z(n).length,initialValue:ye(()=>z(e)),dirty:ye(()=>!Oa(z(t),z(e)))});return lt(n,r=>{i.valid=!r.length},{immediate:!0,flush:"sync"}),i}function cN(t,e){const n=e?Fs(xi,void 0):void 0;function i(s){return s?Array.isArray(s)?s:[s]:[]}if(!n){const s=Mt([]);return{errors:s,errorMessage:ye(()=>s.value[0]),setErrors:o=>{s.value=i(o)}}}const r=ye(()=>n.errorBag.value[z(t)]||[]);return{errors:r,errorMessage:ye(()=>r.value[0]),setErrors:s=>{n.setFieldErrorBag(z(t),i(s))}}}function uN(t,e,n){return Ds(n==null?void 0:n.type)?fN(t,e,n):R_(t,e,n)}function R_(t,e,n){const{initialValue:i,validateOnMount:r,bails:s,type:o,checkedValue:a,label:l,validateOnValueUpdate:c,uncheckedValue:u,standalone:d}=dN(z(t),n),h=d?void 0:Fs(xi),{id:p,value:g,initialValue:R,meta:I,setState:y,errors:T,errorMessage:M}=oN(t,{modelValue:i,standalone:d}),D=()=>{I.touched=!0},B=ye(()=>{let U=z(e);const me=z(h==null?void 0:h.schema);return me&&!Ls(me)&&(U=hN(me,z(t))||U),Ls(U)||Oi(U)?U:E_(U)});async function X(U){var me,Re;return(h==null?void 0:h.validateSchema)?(me=(await h.validateSchema(U)).results[z(t)])!==null&&me!==void 0?me:{valid:!0,errors:[]}:b_(g.value,B.value,{name:z(l)||z(t),values:(Re=h==null?void 0:h.values)!==null&&Re!==void 0?Re:{},bails:s})}async function q(){I.pending=!0,I.validated=!0;const U=await X("validated-only");return y({errors:U.errors}),I.pending=!1,U}async function te(){const U=await X("silent");return I.valid=U.valid,U}function j(U){return!(U==null?void 0:U.mode)||(U==null?void 0:U.mode)==="force"||(U==null?void 0:U.mode)==="validated-only"?q():te()}const ie=(U,me=!0)=>{const Re=Hu(U);g.value=Re,!c&&me&&q()};io(()=>{if(r)return q();(!h||!h.validateSchema)&&te()});function ce(U){I.touched=U}let W;function de(){W=lt(g,c?q:te,{deep:!0})}de();function ke(U){var me;W==null||W();const Re=U&&"value"in U?U.value:R.value;y({value:Be(Re),initialValue:Be(Re),touched:(me=U==null?void 0:U.touched)!==null&&me!==void 0?me:!1,errors:(U==null?void 0:U.errors)||[]}),I.pending=!1,I.validated=!1,te(),zi(()=>{de()})}function tt(U){g.value=U}function he(U){y({errors:Array.isArray(U)?U:[U]})}const le={id:p,name:t,label:l,value:g,meta:I,errors:T,errorMessage:M,type:o,checkedValue:a,uncheckedValue:u,bails:s,resetField:ke,handleReset:()=>ke(),validate:j,handleChange:ie,handleBlur:D,setState:y,setTouched:ce,setErrors:he,setValue:tt};if(Vi(Uk,le),Me(e)&&typeof z(e)!="function"&&lt(e,(U,me)=>{Oa(U,me)||(I.validated?q():te())},{deep:!0}),!h)return le;h.register(le),Or(()=>{h.unregister(le)});const ue=ye(()=>{const U=B.value;return!U||Oi(U)||Ls(U)?{}:Object.keys(U).reduce((me,Re)=>{const it=Jk(U[Re]).map(De=>De.__locatorRef).reduce((De,ln)=>{const E=Qe(h.values,ln)||h.values[ln];return E!==void 0&&(De[ln]=E),De},{});return Object.assign(me,it),me},{})});return lt(ue,(U,me)=>{if(!Object.keys(U).length)return;!Oa(U,me)&&(I.validated?q():te())}),le}function dN(t,e){const n=()=>({initialValue:void 0,validateOnMount:!1,bails:!0,rules:"",label:t,validateOnValueUpdate:!0,standalone:!1});if(!e)return n();const i="valueProp"in e?e.valueProp:e.checkedValue;return Object.assign(Object.assign(Object.assign({},n()),e||{}),{checkedValue:i})}function hN(t,e){if(!!t)return t[e]}function fN(t,e,n){const i=(n==null?void 0:n.standalone)?void 0:Fs(xi),r=n==null?void 0:n.checkedValue,s=n==null?void 0:n.uncheckedValue;function o(a){const l=a.handleChange,c=ye(()=>{const d=z(a.value),h=z(r);return Array.isArray(d)?d.includes(h):h===d});function u(d,h=!0){var p,g;if(c.value===((g=(p=d)===null||p===void 0?void 0:p.target)===null||g===void 0?void 0:g.checked))return;let R=Hu(d);i||(R=ju(z(a.value),z(r),z(s))),l(R,h)}return Or(()=>{c.value&&u(z(r),!1)}),Object.assign(Object.assign({},a),{checked:c,checkedValue:r,uncheckedValue:s,handleChange:u})}return o(R_(t,e,n))}const BN=Wi({name:"Field",inheritAttrs:!1,props:{as:{type:[String,Object],default:void 0},name:{type:String,required:!0},rules:{type:[Object,String,Function],default:void 0},validateOnMount:{type:Boolean,default:!1},validateOnBlur:{type:Boolean,default:void 0},validateOnChange:{type:Boolean,default:void 0},validateOnInput:{type:Boolean,default:void 0},validateOnModelUpdate:{type:Boolean,default:void 0},bails:{type:Boolean,default:()=>qu().bails},label:{type:String,default:void 0},uncheckedValue:{type:null,default:void 0},modelValue:{type:null,default:ka},modelModifiers:{type:null,default:()=>({})},"onUpdate:modelValue":{type:null,default:void 0},standalone:{type:Boolean,default:!1}},setup(t,e){const n=Tn(t,"rules"),i=Tn(t,"name"),r=Tn(t,"label"),s=Tn(t,"uncheckedValue"),o=Uu(t,"onUpdate:modelValue"),{errors:a,value:l,errorMessage:c,validate:u,handleChange:d,handleBlur:h,setTouched:p,resetField:g,handleReset:R,meta:I,checked:y,setErrors:T}=uN(i,n,{validateOnMount:t.validateOnMount,bails:t.bails,standalone:t.standalone,type:e.attrs.type,initialValue:gN(t,e),checkedValue:e.attrs.value,uncheckedValue:s,label:r,validateOnValueUpdate:!1}),M=o?function(ie,ce=!0){d(ie,ce),e.emit("update:modelValue",l.value)}:d,D=j=>{Ds(e.attrs.type)||(l.value=Hu(j))},B=o?function(ie){D(ie),e.emit("update:modelValue",l.value)}:D,X=ye(()=>{const{validateOnInput:j,validateOnChange:ie,validateOnBlur:ce,validateOnModelUpdate:W}=pN(t),de=[h,e.attrs.onBlur,ce?u:void 0].filter(Boolean),ke=[ue=>M(ue,j),e.attrs.onInput].filter(Boolean),tt=[ue=>M(ue,ie),e.attrs.onChange].filter(Boolean),he={name:t.name,onBlur:de,onInput:ke,onChange:tt};W&&(he["onUpdate:modelValue"]=[M]),Ds(e.attrs.type)&&y?he.checked=y.value:he.value=l.value;const le=A_(t,e);return zk(le,e.attrs)&&delete he.value,he}),q=Tn(t,"modelValue");lt(q,j=>{j===ka&&l.value===void 0||j!==mN(l.value,t.modelModifiers)&&(l.value=j===ka?void 0:j,u())});function te(){return{field:X.value,value:l.value,meta:I,errors:a.value,errorMessage:c.value,validate:u,resetField:g,handleChange:M,handleInput:B,handleReset:R,handleBlur:h,setTouched:p,setErrors:T}}return e.expose({setErrors:T,setTouched:p,reset:g,validate:u,handleChange:d}),()=>{const j=dl(A_(t,e)),ie=Pa(j,e,te);return j?ii(j,Object.assign(Object.assign({},e.attrs),X.value),ie):ie}}});function A_(t,e){let n=t.as||"";return!t.as&&!e.slots.default&&(n="input"),n}function pN(t){var e,n,i,r;const{validateOnInput:s,validateOnChange:o,validateOnBlur:a,validateOnModelUpdate:l}=qu();return{validateOnInput:(e=t.validateOnInput)!==null&&e!==void 0?e:s,validateOnChange:(n=t.validateOnChange)!==null&&n!==void 0?n:o,validateOnBlur:(i=t.validateOnBlur)!==null&&i!==void 0?i:a,validateOnModelUpdate:(r=t.validateOnModelUpdate)!==null&&r!==void 0?r:l}}function mN(t,e){return e.number?Lk(t):t}function gN(t,e){return Ds(e.attrs.type)?Uu(t,"modelValue")?t.modelValue:void 0:Uu(t,"modelValue")?t.modelValue:e.attrs.value}let _N=0;function vN(t){const e=_N++,n=Mt({}),i=Mt(!1),r=Mt(0),s={},o=Cn(Be(z(t==null?void 0:t.initialValues)||{})),{errorBag:a,setErrorBag:l,setFieldErrorBag:c}=EN(t==null?void 0:t.initialErrors),u=ye(()=>nt(a.value).reduce((v,C)=>{const F=a.value[C];return F&&F.length&&(v[C]=F[0]),v},{}));function d(v){const C=n.value[v];return Array.isArray(C)?C[0]:C}function h(v){return!!n.value[v]}const p=ye(()=>nt(n.value).reduce((v,C)=>{const F=d(C);return F&&(v[C]=z(F.label||F.name)||""),v},{})),g=ye(()=>nt(n.value).reduce((v,C)=>{var F;const x=d(C);return x&&(v[C]=(F=x.bails)!==null&&F!==void 0?F:!0),v},{})),R=Object.assign({},(t==null?void 0:t.initialErrors)||{}),{initialValues:I,originalInitialValues:y,setInitialValues:T}=wN(n,o,t==null?void 0:t.initialValues),M=yN(n,o,I,u),D=t==null?void 0:t.validationSchema,B={formId:e,fieldsByPath:n,values:o,errorBag:a,errors:u,schema:D,submitCount:r,meta:M,isSubmitting:i,fieldArraysLookup:s,validateSchema:z(D)?L:void 0,validate:U,register:le,unregister:ue,setFieldErrorBag:c,validateField:me,setFieldValue:ie,setValues:ce,setErrors:j,setFieldError:te,setFieldTouched:W,setTouched:de,resetForm:ke,handleSubmit:Re,stageInitialValue:ln,unsetInitialValue:De,setFieldInitialValue:it};function X(v){return Array.isArray(v)}function q(v,C){return Array.isArray(v)?v.forEach(C):C(v)}function te(v,C){c(v,C)}function j(v){l(v)}function ie(v,C,{force:F}={force:!1}){var x;const f=n.value[v],m=Be(C);if(!f){Sr(o,v,m);return}if(X(f)&&((x=f[0])===null||x===void 0?void 0:x.type)==="checkbox"&&!Array.isArray(C)){const w=Be(ju(Qe(o,v)||[],C,void 0));Sr(o,v,w);return}let _=C;!X(f)&&f.type==="checkbox"&&!F&&(_=Be(ju(Qe(o,v),C,z(f.uncheckedValue)))),Sr(o,v,_)}function ce(v){nt(o).forEach(C=>{delete o[C]}),nt(v).forEach(C=>{ie(C,v[C])}),Object.values(s).forEach(C=>C&&C.reset())}function W(v,C){const F=n.value[v];F&&q(F,x=>x.setTouched(C))}function de(v){nt(v).forEach(C=>{W(C,!!v[C])})}function ke(v){(v==null?void 0:v.values)?(T(v.values),ce(v==null?void 0:v.values)):(T(y.value),ce(y.value)),Object.values(n.value).forEach(C=>{!C||q(C,F=>F.resetField())}),(v==null?void 0:v.touched)&&de(v.touched),j((v==null?void 0:v.errors)||{}),r.value=(v==null?void 0:v.submitCount)||0}function tt(v,C){const F=Ja(v),x=C;if(!n.value[x]){n.value[x]=F;return}const f=n.value[x];f&&!Array.isArray(f)&&(n.value[x]=[f]),n.value[x]=[...n.value[x],F]}function he(v,C){const F=C,x=n.value[F];if(!!x){if(!X(x)&&v.id===x.id){delete n.value[F];return}if(X(x)){const f=x.findIndex(m=>m.id===v.id);if(f===-1)return;if(x.splice(f,1),x.length===1){n.value[F]=x[0];return}x.length||delete n.value[F]}}}function le(v){const C=z(v.name);tt(v,C),Me(v.name)&&lt(v.name,async(x,f)=>{await zi(),he(v,f),tt(v,x),(u.value[f]||u.value[x])&&me(x),await zi(),h(f)||Bu(o,f)});const F=z(v.errorMessage);F&&(R==null?void 0:R[C])!==F&&me(C),delete R[C]}function ue(v){const C=z(v.name);he(v,C),zi(()=>{h(C)||(te(C,void 0),Bu(o,C))})}async function U(v){if(B.validateSchema)return B.validateSchema((v==null?void 0:v.mode)||"force");const C=await Promise.all(Object.values(n.value).map(f=>{const m=Array.isArray(f)?f[0]:f;return m?m.validate(v).then(_=>({key:z(m.name),valid:_.valid,errors:_.errors})):Promise.resolve({key:"",valid:!0,errors:[]})})),F={},x={};for(const f of C)F[f.key]={valid:f.valid,errors:f.errors},f.errors.length&&(x[f.key]=f.errors[0]);return{valid:C.every(f=>f.valid),results:F,errors:x}}async function me(v){const C=n.value[v];return C?Array.isArray(C)?C.map(F=>F.validate())[0]:C.validate():(fh(`field with name ${v} was not found`),Promise.resolve({errors:[],valid:!0}))}function Re(v,C){return function(x){return x instanceof Event&&(x.preventDefault(),x.stopPropagation()),de(nt(n.value).reduce((f,m)=>(f[m]=!0,f),{})),i.value=!0,r.value++,U().then(f=>{if(f.valid&&typeof v=="function")return v(Be(o),{evt:x,setErrors:j,setFieldError:te,setTouched:de,setFieldTouched:W,setValues:ce,setFieldValue:ie,resetForm:ke});!f.valid&&typeof C=="function"&&C({values:Be(o),evt:x,errors:f.errors,results:f.results})}).then(f=>(i.value=!1,f),f=>{throw i.value=!1,f})}}function it(v,C){Sr(I.value,v,Be(C))}function De(v){Bu(I.value,v)}function ln(v,C){Sr(o,v,C),it(v,C)}async function E(){const v=z(D);return v?Ls(v)?await rN(v,o):await sN(v,o,{names:p.value,bailsMap:g.value}):{valid:!0,results:{},errors:{}}}const $=Gk(E,5);async function L(v){const C=await $(),F=B.fieldsByPath.value||{},x=nt(B.errorBag.value);return[...new Set([...nt(C.results),...nt(F),...x])].reduce((m,_)=>{const w=F[_],b=(C.results[_]||{errors:[]}).errors,P={errors:b,valid:!b.length};if(m.results[_]=P,P.valid||(m.errors[_]=P.errors[0]),!w)return te(_,b),m;if(q(w,A=>A.meta.valid=P.valid),v==="silent")return m;const V=Array.isArray(w)?w.some(A=>A.meta.validated):w.meta.validated;return v==="validated-only"&&!V||q(w,A=>A.setState({errors:P.errors})),m},{valid:C.valid,results:{},errors:{}})}const G=Re((v,{evt:C})=>{qk(C)&&C.target.submit()});return io(()=>{if((t==null?void 0:t.initialErrors)&&j(t.initialErrors),(t==null?void 0:t.initialTouched)&&de(t.initialTouched),t==null?void 0:t.validateOnMount){U();return}B.validateSchema&&B.validateSchema("silent")}),Me(D)&&lt(D,()=>{var v;(v=B.validateSchema)===null||v===void 0||v.call(B,"validated-only")}),Vi(xi,B),{errors:u,meta:M,values:o,isSubmitting:i,submitCount:r,validate:U,validateField:me,handleReset:()=>ke(),resetForm:ke,handleSubmit:Re,submitForm:G,setFieldError:te,setErrors:j,setFieldValue:ie,setValues:ce,setFieldTouched:W,setTouched:de}}function yN(t,e,n,i){const r={touched:"some",pending:"some",valid:"every"},s=ye(()=>!Oa(e,z(n))),o=ye(()=>{const a=Object.values(t.value).flat(1).filter(Boolean);return nt(r).reduce((l,c)=>{const u=r[c];return l[c]=a[u](d=>d.meta[c]),l},{})});return ye(()=>Object.assign(Object.assign({initialValues:z(n)},o.value),{valid:o.value.valid&&!nt(i.value).length,dirty:s.value}))}function wN(t,e,n){const i=Mt(Be(z(n))||{}),r=Mt(Be(z(n))||{});function s(o,a=!1){i.value=Be(o),r.value=Be(o),!!a&&nt(t.value).forEach(l=>{const c=t.value[l],u=Array.isArray(c)?c.some(h=>h.meta.touched):c==null?void 0:c.meta.touched;if(!c||u)return;const d=Qe(i.value,l);Sr(e,l,Be(d))})}return Me(n)&&lt(n,o=>{s(o,!0)},{deep:!0}),{initialValues:i,originalInitialValues:r,setInitialValues:s}}function EN(t){const e=Mt({});function n(s){return Array.isArray(s)?s:s?[s]:[]}function i(s,o){if(!o){delete e.value[s];return}e.value[s]=n(o)}function r(s){e.value=nt(s).reduce((o,a)=>{const l=s[a];return l&&(o[a]=n(l)),o},{})}return t&&r(t),{errorBag:e,setErrorBag:r,setFieldErrorBag:i}}const jN=Wi({name:"Form",inheritAttrs:!1,props:{as:{type:String,default:"form"},validationSchema:{type:Object,default:void 0},initialValues:{type:Object,default:void 0},initialErrors:{type:Object,default:void 0},initialTouched:{type:Object,default:void 0},validateOnMount:{type:Boolean,default:!1},onSubmit:{type:Function,default:void 0},onInvalidSubmit:{type:Function,default:void 0}},setup(t,e){const n=Tn(t,"initialValues"),i=Tn(t,"validationSchema"),{errors:r,values:s,meta:o,isSubmitting:a,submitCount:l,validate:c,validateField:u,handleReset:d,resetForm:h,handleSubmit:p,submitForm:g,setErrors:R,setFieldError:I,setFieldValue:y,setValues:T,setFieldTouched:M,setTouched:D}=vN({validationSchema:i.value?i:void 0,initialValues:n,initialErrors:t.initialErrors,initialTouched:t.initialTouched,validateOnMount:t.validateOnMount}),B=t.onSubmit?p(t.onSubmit,t.onInvalidSubmit):g;function X(j){Fu(j)&&j.preventDefault(),d(),typeof e.attrs.onReset=="function"&&e.attrs.onReset()}function q(j,ie){return p(typeof j=="function"&&!ie?j:ie,t.onInvalidSubmit)(j)}function te(){return{meta:o.value,errors:r.value,values:s,isSubmitting:a.value,submitCount:l.value,validate:c,validateField:u,handleSubmit:q,handleReset:d,submitForm:g,setErrors:R,setFieldError:I,setFieldValue:y,setValues:T,setFieldTouched:M,setTouched:D,resetForm:h}}return e.expose({setFieldError:I,setErrors:R,setFieldValue:y,setValues:T,setFieldTouched:M,setTouched:D,resetForm:h,validate:c,validateField:u}),function(){const ie=t.as==="form"?t.as:dl(t.as),ce=Pa(ie,e,te);if(!t.as)return ce;const W=t.as==="form"?{novalidate:!0}:{};return ii(ie,Object.assign(Object.assign(Object.assign({},W),e.attrs),{onSubmit:B,onReset:X}),ce)}}});let IN=0;function bN(t){const e=IN++,n=Fs(xi,void 0),i=Mt([]),r=()=>{},s={fields:Zs(i),remove:r,push:r,swap:r,insert:r,update:r,replace:r,prepend:r};if(!n)return y_("FieldArray requires being a child of `<Form/>` or `useForm` being called before it. Array fields may not work correctly"),s;if(!z(t))return y_("FieldArray requires a field path to be provided, did you forget to pass the `name` prop?"),s;let o=0;function a(){const y=Qe(n==null?void 0:n.values,z(t),[]);i.value=y.map(c),l()}a();function l(){const y=i.value.length;for(let T=0;T<y;T++){const M=i.value[T];M.isFirst=T===0,M.isLast=T===y-1}}function c(y){const T=o++;return{key:T,value:ye(()=>{const D=Qe(n==null?void 0:n.values,z(t),[]),B=i.value.findIndex(X=>X.key===T);return B===-1?y:D[B]}),isFirst:!1,isLast:!1}}function u(y){const T=z(t),M=Qe(n==null?void 0:n.values,T);if(!M||!Array.isArray(M))return;const D=[...M];D.splice(y,1),n==null||n.unsetInitialValue(T+`[${y}]`),n==null||n.setFieldValue(T,D),i.value.splice(y,1),l()}function d(y){const T=z(t),M=Qe(n==null?void 0:n.values,T),D=Aa(M)?[]:M;if(!Array.isArray(D))return;const B=[...D];B.push(y),n==null||n.stageInitialValue(T+`[${B.length-1}]`,y),n==null||n.setFieldValue(T,B),i.value.push(c(y)),l()}function h(y,T){const M=z(t),D=Qe(n==null?void 0:n.values,M);if(!Array.isArray(D)||!D[y]||!D[T])return;const B=[...D],X=[...i.value],q=B[y];B[y]=B[T],B[T]=q;const te=X[y];X[y]=X[T],X[T]=te,n==null||n.setFieldValue(M,B),i.value=X,l()}function p(y,T){const M=z(t),D=Qe(n==null?void 0:n.values,M);if(!Array.isArray(D)||D.length<y)return;const B=[...D],X=[...i.value];B.splice(y,0,T),X.splice(y,0,c(T)),n==null||n.setFieldValue(M,B),i.value=X,l()}function g(y){const T=z(t);n==null||n.setFieldValue(T,y),a()}function R(y,T){const M=z(t),D=Qe(n==null?void 0:n.values,M);!Array.isArray(D)||D.length-1<y||n==null||n.setFieldValue(`${M}[${y}]`,T)}function I(y){const T=z(t),M=Qe(n==null?void 0:n.values,T),D=Aa(M)?[]:M;if(!Array.isArray(D))return;const B=[y,...D];n==null||n.stageInitialValue(T+`[${B.length-1}]`,y),n==null||n.setFieldValue(T,B),i.value.unshift(c(y)),l()}return n.fieldArraysLookup[e]={reset:a},Or(()=>{delete n.fieldArraysLookup[e]}),{fields:Zs(i),remove:u,push:d,swap:h,insert:p,update:R,replace:g,prepend:I}}Wi({name:"FieldArray",inheritAttrs:!1,props:{name:{type:String,required:!0}},setup(t,e){const{push:n,remove:i,swap:r,insert:s,replace:o,update:a,prepend:l,fields:c}=bN(Tn(t,"name"));function u(){return{fields:c.value,push:n,remove:i,swap:r,insert:s,update:a,replace:o,prepend:l}}return e.expose({push:n,remove:i,swap:r,insert:s,update:a,replace:o,prepend:l}),()=>Pa(void 0,e,u)}});const $N=Wi({name:"ErrorMessage",props:{as:{type:String,default:void 0},name:{type:String,required:!0}},setup(t,e){const n=zt(xi,void 0),i=ye(()=>n==null?void 0:n.errors.value[t.name]);function r(){return{message:i.value}}return()=>{if(!i.value)return;const s=t.as?dl(t.as):t.as,o=Pa(s,e,r),a=Object.assign({role:"alert"},e.attrs);return!s&&(Array.isArray(o)||!o)&&(o==null?void 0:o.length)?o:(Array.isArray(o)||!o)&&!(o==null?void 0:o.length)?ii(s||"span",a,i.value):ii(s,a,o)}}});export{$N as E,jN as F,Ph as T,sh as a,_t as b,AN as c,kN as d,dy as e,ly as f,qr as g,DN as h,UN as i,FN as j,WN as k,VN as l,LN as m,MN as n,oy as o,xN as p,BN as q,RN as r,SN as s,TN as t,ON as u,PN as v,Tv as w,Gt as x,NN as y,La as z};
